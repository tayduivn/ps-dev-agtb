-- MSSQL upgrade script for Sugar 5.5.1 CE to 5.5.1 Pro
 ...
 ALTER TABLE contacts ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ;
 ...
 ALTER TABLE cases ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ,system_id int  NULL ;
...
ALTER TABLE cases ADD CONSTRAINT case_number UNIQUE (case_number, system_id);
 ...
 ALTER TABLE email_templates ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ,base_module nvarchar(50)  NULL ,from_name nvarchar(255)  NULL ,from_address nvarchar(255)  NULL ;
...
CREATE TABLE tracker_queries (id int  NOT NULL identity(1,1),query_id nvarchar(36)  NOT NULL ,text ntext  NULL ,query_hash nvarchar(36)  NULL ,sec_total float  NULL ,sec_avg float  NULL ,run_count int  NULL ,deleted bit  DEFAULT '0' NULL ,date_modified datetime  NULL  ) ALTER TABLE tracker_queries ADD CONSTRAINT pk_tracker_queries PRIMARY KEY (id) create index idx_tracker_queries_query_hash on tracker_queries ( query_hash ) create index idx_tracker_queries_query_id on tracker_queries ( query_id );
 ...
 ALTER TABLE bugs ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ,system_id int  NULL ;

DROP INDEX bug_number on bugs;
ALTER TABLE bugs ADD CONSTRAINT bug_number UNIQUE (bug_number, system_id);

 ALTER TABLE project ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ,is_template bit  DEFAULT '0' NULL ;

 ALTER TABLE project_task ADD team_id nvarchar(36)  NULL ,team_set_id nvarchar(36)  NULL ,resource_id ntext  NULL ;
