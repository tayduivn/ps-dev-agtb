...
CREATE TABLE tracker_sessions (id int  NOT NULL identity(1,1),session_id varchar(36)  NULL ,date_start datetime  NULL ,date_end datetime  NULL ,seconds int  DEFAULT '0' NULL ,client_ip nvarchar(20)  NULL ,user_id varchar(36)  NULL ,active bit  DEFAULT '1' NULL ,round_trips int  NULL ,deleted bit  DEFAULT '0' NULL  ) ALTER TABLE tracker_sessions ADD CONSTRAINT pk_tracker_sessions PRIMARY KEY (id) create index idx_tracker_sessions_s_id on tracker_sessions ( session_id ) create index idx_tracker_sessions_uas_id on tracker_sessions ( user_id, active, session_id );

CREATE TABLE tracker_queries (id int  NOT NULL identity(1,1),query_id varchar(36)  NOT NULL ,text text  NULL ,query_hash nvarchar(36)  NULL ,sec_total float  NULL ,sec_avg float  NULL ,run_count int  NULL ,deleted bit  DEFAULT '0' NULL ,date_modified datetime  NULL  ) ALTER TABLE tracker_queries ADD CONSTRAINT pk_tracker_queries PRIMARY KEY (id) create index idx_tracker_queries_query_hash on tracker_queries ( query_hash ) create index idx_tracker_queries_query_id on tracker_queries ( query_id );
...
CREATE TABLE acl_fields (id varchar(36)  NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NOT NULL ,created_by varchar(36)  NULL ,name nvarchar(150)  NULL ,category nvarchar(100)  NULL ,aclaccess int  NULL ,deleted bit  DEFAULT 0  NULL ,role_id varchar(36)  NOT NULL  ) ALTER TABLE acl_fields ADD CONSTRAINT pk_acl_fields PRIMARY KEY (id) create index idx_aclfield_role_del on acl_fields ( role_id, category, deleted );


CREATE TABLE contracts (id varchar(36)  NOT NULL ,name nvarchar(255)  NOT NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,description text  NULL ,deleted bit  DEFAULT '0' NULL ,assigned_user_id varchar(36)  NULL ,team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,reference_code nvarchar(255)  NULL ,account_id varchar(36)  NULL ,start_date datetime  NULL ,end_date datetime  NULL ,currency_id varchar(36)  NULL ,total_contract_value decimal(26,6)  NULL ,total_contract_value_usdollar decimal(26,6)  NULL ,status nvarchar(25)  NOT NULL ,customer_signed_date datetime  NULL ,company_signed_date datetime  NULL ,expiration_notice datetime  NULL ,type nvarchar(255)  NULL  ) ALTER TABLE contracts ADD CONSTRAINT pk_contracts PRIMARY KEY (id);
...
CREATE TABLE saved_reports (team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,id varchar(36)  NOT NULL ,name nvarchar(255)  NOT NULL ,module varchar(36)  NOT NULL ,report_type varchar(36)  NOT NULL ,content text  NULL ,deleted bit  DEFAULT 0  NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,assigned_user_id varchar(36)  NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,is_published bit  DEFAULT '0' NOT NULL ,chart_type varchar(36)  DEFAULT 'none' NOT NULL ,schedule_type nvarchar(3)  DEFAULT 'pro' NULL ,favorite bit  DEFAULT 0  NULL  ) ALTER TABLE saved_reports ADD CONSTRAINT pk_saved_reports PRIMARY KEY (id) create index idx_rep_owner_module_name on saved_reports ( assigned_user_id, name, deleted );


CREATE TABLE teams (id varchar(36)  NOT NULL ,name nvarchar(128)  NULL ,name_2 nvarchar(128)  NULL ,associated_user_id varchar(36)  NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,private bit  DEFAULT 0  NULL ,description text  NULL ,deleted bit  DEFAULT 0  NOT NULL  ) ALTER TABLE teams ADD CONSTRAINT pk_teams PRIMARY KEY (id) create index idx_team_del on teams ( name ) create index idx_team_del_name on teams ( deleted, name );
...
CREATE TABLE forecasts (id varchar(36)  NOT NULL ,timeperiod_id varchar(36)  NULL ,forecast_type nvarchar(25)  NULL ,opp_count int  NULL ,opp_weigh_value int  NULL ,best_case int  NULL ,likely_case int  NULL ,worst_case int  NULL ,user_id varchar(36)  NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,deleted bit  DEFAULT 0  NOT NULL  ) ALTER TABLE forecasts ADD CONSTRAINT pk_forecasts PRIMARY KEY (id);


CREATE TABLE forecast_schedule (id varchar(36)  NOT NULL ,timeperiod_id varchar(36)  NULL ,user_id varchar(36)  NULL ,cascade_hierarchy bit  DEFAULT 0  NULL ,forecast_start_date datetime  NULL ,status nvarchar(25)  NULL ,created_by varchar(36)  NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT 0  NULL  ) ALTER TABLE forecast_schedule ADD CONSTRAINT pk_forecast_schedule PRIMARY KEY (id);


CREATE TABLE quotas (id varchar(36)  NOT NULL ,user_id varchar(36)  NOT NULL ,timeperiod_id varchar(36)  NOT NULL ,quota_type nvarchar(25)  NULL ,amount int  NOT NULL ,amount_base_currency int  NOT NULL ,currency_id varchar(36)  NOT NULL ,committed bit  DEFAULT '0' NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT 0  NULL  ) ALTER TABLE quotas ADD CONSTRAINT pk_quotas PRIMARY KEY (id);


CREATE TABLE worksheet (id varchar(36)  NOT NULL ,user_id varchar(36)  NULL ,timeperiod_id varchar(36)  NULL ,forecast_type nvarchar(25)  NULL ,related_id varchar(36)  NULL ,related_forecast_type nvarchar(25)  NULL ,best_case int  NULL ,likely_case int  NULL ,worst_case int  NULL ,date_modified datetime  NULL ,modified_user_id varchar(36)  NULL  ) ALTER TABLE worksheet ADD CONSTRAINT pk_worksheet PRIMARY KEY (id);


CREATE TABLE workflow (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,name nvarchar(50)  NULL ,base_module nvarchar(50)  NULL ,status bit  DEFAULT '0' NULL ,description text  NULL ,type nvarchar(25)  NOT NULL ,fire_order nvarchar(25)  NOT NULL ,parent_id varchar(36)  NULL ,record_type nvarchar(25)  NOT NULL ,list_order_y int  DEFAULT '0' NULL  ) ALTER TABLE workflow ADD CONSTRAINT pk_workflow PRIMARY KEY (id) create index idx_workflow on workflow ( name, deleted );


CREATE TABLE workflow_triggershells (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,field nvarchar(50)  NULL ,type nvarchar(25)  NOT NULL ,frame_type nvarchar(15)  NOT NULL ,eval text  NULL ,parent_id varchar(36)  NOT NULL ,show_past bit  DEFAULT '0' NULL ,rel_module nvarchar(50)  NULL ,rel_module_type nvarchar(10)  NULL ,parameters nvarchar(255)  NULL  ) ALTER TABLE workflow_triggershells ADD CONSTRAINT pk_workflow_triggershells PRIMARY KEY (id);


CREATE TABLE workflow_alertshells (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,name nvarchar(50)  NULL ,alert_text text  NULL ,alert_type nvarchar(25)  NOT NULL ,source_type nvarchar(25)  NOT NULL ,parent_id varchar(36)  NOT NULL ,custom_template_id varchar(36)  NULL  ) ALTER TABLE workflow_alertshells ADD CONSTRAINT pk_workflow_alertshells PRIMARY KEY (id) create index idx_workflowalertshell on workflow_alertshells ( name, deleted );


CREATE TABLE workflow_alerts (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,field_value nvarchar(50)  NULL ,rel_email_value nvarchar(50)  NULL ,rel_module1 nvarchar(50)  NULL ,rel_module2 nvarchar(50)  NULL ,rel_module1_type nvarchar(10)  NULL ,rel_module2_type nvarchar(10)  NULL ,where_filter bit  DEFAULT '0' NULL ,user_type nvarchar(25)  NOT NULL ,array_type nvarchar(25)  NULL ,relate_type nvarchar(25)  NULL ,address_type nvarchar(25)  NULL ,parent_id varchar(36)  NOT NULL ,user_display_type nvarchar(25)  NULL  ) ALTER TABLE workflow_alerts ADD CONSTRAINT pk_workflow_alerts PRIMARY KEY (id) create index idx_workflowalerts on workflow_alerts ( deleted );


CREATE TABLE workflow_actionshells (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,action_type nvarchar(25)  NOT NULL ,parent_id varchar(36)  NOT NULL ,parameters nvarchar(255)  NULL ,rel_module nvarchar(50)  NULL ,rel_module_type nvarchar(10)  NULL ,action_module nvarchar(50)  NULL  ) ALTER TABLE workflow_actionshells ADD CONSTRAINT pk_workflow_actionshells PRIMARY KEY (id) create index idx_actionshell on workflow_actionshells ( deleted );


CREATE TABLE workflow_actions (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,field nvarchar(50)  NULL ,value text  NULL ,set_type nvarchar(10)  NOT NULL ,adv_type nvarchar(10)  NULL ,parent_id varchar(36)  NOT NULL ,ext1 nvarchar(50)  NULL ,ext2 nvarchar(50)  NULL ,ext3 nvarchar(50)  NULL  ) ALTER TABLE workflow_actions ADD CONSTRAINT pk_workflow_actions PRIMARY KEY (id) create index idx_action on workflow_actions ( deleted );


CREATE TABLE expressions (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,lhs_type nvarchar(15)  NULL ,lhs_field nvarchar(50)  NULL ,lhs_module nvarchar(50)  NULL ,lhs_value nvarchar(100)  NULL ,lhs_group_type nvarchar(10)  NULL ,operator nvarchar(15)  NULL ,rhs_group_type nvarchar(10)  NULL ,rhs_type nvarchar(15)  NULL ,rhs_field nvarchar(50)  NULL ,rhs_module nvarchar(50)  NULL ,rhs_value nvarchar(255)  NULL ,parent_id varchar(36)  NOT NULL ,exp_type nvarchar(25)  NOT NULL ,exp_order int  NULL ,parent_type nvarchar(25)  NULL ,parent_exp_id varchar(36)  NULL ,parent_exp_side int  NULL ,ext1 nvarchar(50)  NULL ,ext2 nvarchar(50)  NULL ,ext3 nvarchar(50)  NULL  ) ALTER TABLE expressions ADD CONSTRAINT pk_expressions PRIMARY KEY (id) create index idx_exp on expressions ( parent_id, deleted );


CREATE TABLE systems (id varchar(36)  NOT NULL ,system_id int  NOT NULL identity(1,1),system_key varchar(36)  NULL ,user_id varchar(36)  NULL ,last_connect_date datetime  NULL ,status nvarchar(255)  DEFAULT 'Active' NULL ,num_syncs int  DEFAULT '0' NULL ,system_name nvarchar(100)  NULL ,install_method nvarchar(100)  NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT '0' NOT NULL  ) ALTER TABLE systems ADD CONSTRAINT pk_systems PRIMARY KEY (id) create index system_id on systems ( system_id );


CREATE TABLE session_active (id varchar(36)  NOT NULL ,session_id nvarchar(100)  NULL ,last_request_time datetime  NULL ,session_type nvarchar(100)  NULL ,is_violation bit  DEFAULT '0' NULL ,num_active_sessions int  DEFAULT '0' NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT '0' NOT NULL  ) ALTER TABLE session_active ADD CONSTRAINT pk_session_active PRIMARY KEY (id) ALTER TABLE session_active ADD CONSTRAINT idx_session_id UNIQUE (session_id);


CREATE TABLE kbdocuments (team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,id varchar(36)  NOT NULL ,kbdocument_name nvarchar(255)  NOT NULL ,active_date datetime  NULL ,exp_date datetime  NULL ,status_id nvarchar(25)  NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT '0' NULL ,is_external_article bit  DEFAULT '0' NULL ,description text  NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,kbdocument_revision_id varchar(36)  NULL ,kbdocument_revision_number nvarchar(25)  NULL ,mail_merge_document nvarchar(3)  DEFAULT 'off' NULL ,related_doc_id varchar(36)  NULL ,related_doc_rev_id varchar(36)  NULL ,is_template bit  DEFAULT '0' NULL ,template_type nvarchar(25)  NULL ,kbdoc_approver_id varchar(36)  NULL ,assigned_user_id varchar(36)  NULL ,parent_id varchar(36)  NULL ,parent_type nvarchar(25)  NULL  ) ALTER TABLE kbdocuments ADD CONSTRAINT pk_kbdocuments PRIMARY KEY (id);


CREATE TABLE kbdocument_revisions (id varchar(36)  NOT NULL ,change_log nvarchar(255)  NULL ,kbdocument_id varchar(36)  NULL ,date_entered datetime  NULL ,created_by varchar(36)  NULL ,filename nvarchar(255)  NULL ,file_ext nvarchar(25)  NULL ,file_mime_type nvarchar(100)  NULL ,revision nvarchar(25)  NULL ,deleted bit  DEFAULT '0' NULL ,latest bit  DEFAULT '0' NULL ,kbcontent_id varchar(36)  NULL ,document_revision_id varchar(36)  NULL ,date_modified datetime  NULL  )  
...
CREATE TABLE kbtags (team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,id varchar(36)  NOT NULL ,parent_tag_id varchar(36)  NULL ,tag_name nvarchar(255)  NOT NULL ,root_tag bit  DEFAULT '0' NULL ,date_entered datetime  NULL ,created_by varchar(36)  NULL ,revision nvarchar(25)  NULL ,deleted bit  DEFAULT '0' NULL ,date_modified datetime  NULL  ) ALTER TABLE kbtags ADD CONSTRAINT pk_kbtags PRIMARY KEY (id);


CREATE TABLE kbdocuments_kbtags (team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,id varchar(36)  NOT NULL ,kbdocument_id varchar(36)  NULL ,kbtag_id varchar(36)  NULL ,date_entered datetime  NULL ,created_by varchar(36)  NULL ,revision nvarchar(25)  NULL ,deleted bit  DEFAULT '0' NULL ,date_modified datetime  NULL  )  
...
CREATE TABLE address_book_lists (id varchar(36)  NOT NULL ,assigned_user_id varchar(36)  NOT NULL ,list_name nvarchar(100)  NOT NULL  ) ALTER TABLE address_book_lists ADD CONSTRAINT pk_address_book_lists PRIMARY KEY (id) create index abml_user_bean_idx on address_book_lists ( assigned_user_id );
...
CREATE TABLE quotes_contacts (id varchar(36)  NOT NULL ,contact_id varchar(36)  NULL ,quote_id varchar(36)  NULL ,contact_role nvarchar(20)  NULL ,date_modified datetime  NULL ,deleted bit  DEFAULT '0' NOT NULL  ) ALTER TABLE quotes_contacts ADD CONSTRAINT pk_quotes_contacts PRIMARY KEY (id) create index idx_con_qte_con on quotes_contacts ( contact_id ) create index idx_con_qte_opp on quotes_contacts ( quote_id ) create index idx_quote_contact_role on quotes_contacts ( quote_id, contact_role );
...
CREATE TABLE report_schedules (id varchar(36)  NOT NULL ,user_id varchar(36)  NOT NULL ,report_id varchar(36)  NOT NULL ,next_run datetime  NOT NULL ,active bit  DEFAULT '0' NOT NULL ,time_interval int  NULL ,date_modified datetime  NULL ,schedule_type nvarchar(3)  NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_start datetime  NULL) ALTER TABLE report_schedules ADD CONSTRAINT pk_report_schedules PRIMARY KEY (id);
...
CREATE TABLE workflow_schedules (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,date_expired datetime  NOT NULL ,workflow_id varchar(36)  NULL ,target_module nvarchar(50)  NULL ,bean_id varchar(36)  NULL ,parameters nvarchar(255)  NULL  ) ALTER TABLE workflow_schedules ADD CONSTRAINT pk_workflow_schedules PRIMARY KEY (id) create index idx_wkfl_schedule on workflow_schedules ( workflow_id, deleted );
...
CREATE TABLE report_cache (id varchar(36)  NOT NULL ,assigned_user_id varchar(36)  NOT NULL ,contents text  NULL ,report_options text  NULL ,deleted nvarchar(1)  DEFAULT '0' NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL  ) ALTER TABLE report_cache ADD CONSTRAINT pk_report_cache PRIMARY KEY (id, assigned_user_id);


CREATE TABLE dataset_layouts (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,parent_value nvarchar(50)  NULL ,layout_type nvarchar(25)  NOT NULL ,parent_id varchar(36)  NULL ,list_order_x int  NULL ,list_order_z int  NULL ,row_header_id varchar(36)  NULL ,hide_column nvarchar(3)  NULL  ) ALTER TABLE dataset_layouts ADD CONSTRAINT pk_dataset_layouts PRIMARY KEY (id) create index idx_datasetlayout on dataset_layouts ( parent_value, deleted );


CREATE TABLE dataset_attributes (id varchar(36)  NOT NULL ,deleted bit  DEFAULT '0' NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NULL ,created_by varchar(36)  NULL ,display_type nvarchar(25)  NOT NULL ,display_name nvarchar(50)  NULL ,attribute_type nvarchar(8)  NOT NULL ,parent_id varchar(36)  NULL ,font_size nvarchar(8)  DEFAULT '0' NULL ,cell_size nvarchar(3)  NULL ,size_type nvarchar(3)  NULL ,bg_color nvarchar(25)  NULL ,font_color nvarchar(25)  NULL ,wrap nvarchar(3)  NULL ,style nvarchar(25)  NULL ,format_type nvarchar(25)  NOT NULL  ) ALTER TABLE dataset_attributes ADD CONSTRAINT pk_dataset_attributes PRIMARY KEY (id) create index idx_datasetatt on dataset_attributes ( parent_id, deleted );


CREATE TABLE session_history (id varchar(36)  NOT NULL ,session_id nvarchar(100)  NULL ,date_entered datetime  NULL ,date_modified datetime  NULL ,last_request_time datetime  NULL ,session_type nvarchar(100)  NULL ,is_violation bit  DEFAULT '0' NULL ,num_active_sessions int  DEFAULT '0' NULL ,deleted bit  DEFAULT '0' NOT NULL  ) ALTER TABLE session_history ADD CONSTRAINT pk_session_history PRIMARY KEY (id);
