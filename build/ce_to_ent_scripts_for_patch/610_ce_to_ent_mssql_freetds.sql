...
CREATE TABLE report_cache (id nvarchar(36)  NOT NULL ,assigned_user_id nvarchar(36)  NOT NULL ,contents ntext  NULL ,report_options ntext  NULL ,deleted nvarchar(1)  NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL  ) ALTER TABLE report_cache ADD CONSTRAINT pk_report_cache PRIMARY KEY (id, assigned_user_id, deleted);
