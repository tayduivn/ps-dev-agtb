-- MSSQL upgrade script for Sugar 5.5.1 CE to 5.5.1 Pro

 ALTER TABLE users ADD default_team varchar(36)  NULL , team_set_id varchar(36) NULL;

 ALTER TABLE leads ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE contacts ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE accounts ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;


 ALTER TABLE opportunities ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;
...
ALTER TABLE cases ADD CONSTRAINT case_number UNIQUE (case_number, system_id);
 ...
 ALTER TABLE notes ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;
 ...
 ALTER TABLE calls ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE emails ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE meetings ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE tasks ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;
...
CREATE TABLE tracker_queries (id int  NOT NULL identity(1,1),query_id varchar(36)  NOT NULL ,text text  NULL ,query_hash varchar(36)  NULL ,sec_total float  NULL ,sec_avg float  NULL ,run_count int  NULL ,deleted bit  DEFAULT '0' NULL ,date_modified datetime  NULL  ) ALTER TABLE tracker_queries ADD CONSTRAINT pk_tracker_queries PRIMARY KEY (id) create index idx_tracker_queries_query_hash on tracker_queries ( query_hash ) create index idx_tracker_queries_query_id on tracker_queries ( query_id );
 ...
 ALTER TABLE bugs ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,system_id int  NULL ; 

DROP INDEX bug_number on bugs;
ALTER TABLE bugs ADD CONSTRAINT bug_number UNIQUE (bug_number, system_id);

 ALTER TABLE project ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,is_template bit  DEFAULT '0' NULL ;

 ALTER TABLE project_task ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ,resource_id text  NULL ;

 ALTER TABLE campaigns ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE prospect_lists ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE prospects ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE documents ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE inbound_email ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;

 ALTER TABLE saved_search ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;
...
CREATE TABLE holidays (id varchar(36)  NOT NULL ,date_entered datetime  NOT NULL ,date_modified datetime  NOT NULL ,modified_user_id varchar(36)  NOT NULL ,created_by varchar(36)  NULL ,holiday_date datetime  NOT NULL ,description text  NULL ,deleted bit  DEFAULT 0  NULL ,person_id varchar(36)  NULL ,person_type varchar(255)  NULL ,related_module varchar(255)  NULL ,related_module_id varchar(36)  NULL ,resource_name varchar(255)  NULL  ) ALTER TABLE holidays ADD CONSTRAINT pk_holidays PRIMARY KEY (id) create index idx_holiday_id_del on holidays ( id, deleted );
 ...
 ALTER TABLE sugarfeed ADD team_id varchar(36)  NULL ,team_set_id varchar(36)  NULL ;


 ALTER TABLE folders ADD team_set_id varchar(36)  NOT NULL,team_id varchar(36)  NOT NULL ;
