 ...
 ********************************************************************************/
$config['builds']['corp']['flav'] = array('corp','pro');
$config['builds']['corp']['languages']= array('bg_BG','cs_CZ','da_DK', 'de_DE','es_ES', 'et_EE', 'fr_FR','he_IL', 'hu_HU', 'it_it', 'lt_LT','ja_JP','nb_NO', 'nl_NL','pl_PL', 'pt_PT','ro_RO','ru_RU','sv_SE','tr_TR',  'zh_CN' );
