 ...
 * was invoked.
 * 
 * @param config_location String option value to config.php file location
 ...
 */
function merge_config_si_settings($config_location='', $config_si_location='')
{	
global $path;
_logThis('Begin merge_config_si_settings', $path);
...
if($modified)
{
   ...
   _logThis('config.php values are in sync with config_si.php values.  Skip merging');
   return false;
}
