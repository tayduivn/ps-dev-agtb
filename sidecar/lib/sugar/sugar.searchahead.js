(function($) {
    var SearchAhead = function (element, options) {
        ...
        this.minChars = this.options.minChars || 3;
        this.patchIfZepto();
        this.listen();
    };
    ...
    SearchAhead.prototype = {
        ...
        compile: function(data) { 
            return (this.compiler({data:data, term: this.query}));
        },
        throttleMillis: 250,
        ...
        // TODO: The reqs say Enter will trigger dropdown menu .. 
        // but it would be nice to navigate to active item no???
        go: function () {
            var activeItem = null, href = null;
            if(this.shown) {
        ...
        provide: function (data) {
            var trimmed, markup = this.compile(data);
