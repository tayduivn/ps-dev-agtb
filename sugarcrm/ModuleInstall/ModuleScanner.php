 ...
 ********
/**
 * Scans a module package for disabled actions in its manifest as well as any blacklisted functions
 *
 *
 */
class ModuleScanner{
	...
	private $validExt = array('png', 'gif', 'jpg', 'css', 'js', 'php', 'txt', 'html', 'htm', 'tpl', 'pdf', 'md5', 'xml', 'hbs', 'less');
