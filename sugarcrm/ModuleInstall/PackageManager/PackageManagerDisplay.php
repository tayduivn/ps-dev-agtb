...
class PackageManagerDisplay{
   ...
   /**
    ...
    function buildPackageDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1', $install = false){
        ...
        $form2 .= "</td><td align='left'><div id='workingStatusDiv' style='display:none;'>".SugarThemeRegistry::current()->getImage/*ALTFIXED*/("sqsWait","border='0' align='bottom'",null,null,'.gif',"Loading")."</div></td><td align='right'>";
   ...
   $str = $ss->fetch('ModuleInstall/PackageManager/tpls/PackageForm.tpl');
    ...
    function buildPatchDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1'){
        ...
        $form2 .= "</td><td align='right'><div id='workingStatusDiv' style='display:none;'>".SugarThemeRegistry::current()->getImage/*ALTFIXED*/("sqsWait","border='0' align='bottom'",null,null,'.gif',"Loading")."</div></td></tr><tr><td colspan='2'>";
    ...
    function getDisplayScript($install = false, $type = 'module', $releases = null, $types = array(), $isAlive = true){
        ...
        $ss->assign('WAIT_IMAGE', SugarThemeRegistry::current()->getImage/*ALTFIXED*/("loading","border='0' align='bottom'",null,null,'.gif',"Loading"));
