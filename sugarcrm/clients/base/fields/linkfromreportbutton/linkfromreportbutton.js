...
({
    /**
     * LinkFromReportButton allows user to select a report and relate records to primary record
     *
     * @class View.Fields.LinkFromReportButtonField
     * @alias SUGAR.App.view.fields.LinkFromReportButtonField
