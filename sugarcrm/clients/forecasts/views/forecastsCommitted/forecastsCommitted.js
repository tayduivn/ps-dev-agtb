...
({
    ...
    initialize : function(options) {
        ...
        this.render();
        //Add listeners
        this.layout.context.on("change:selectedUser", function(context, user) {self.hideButton = (app.user.get('id') != user.id); self.userId = user.id; self.fullName = user.full_name; self.updateCommitted(); } );
