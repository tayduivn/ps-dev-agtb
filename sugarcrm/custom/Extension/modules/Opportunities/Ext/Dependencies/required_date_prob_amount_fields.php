...
$dependencies['Opportunities']['date_prob_amount_fields'] = array(
    ...
    'actions' => array(
        ...
        array(
            ...
            'params' => array(
                'target' => 'date_closed',
                'label' => 'date_closed_label', // id of the label to add the required symbol to
                'value' => 'true',
            ),
        ),
		*/
        array(
            ...
            'params' => array(
                'target' => 'amount',
                'label' => 'amount_label', // id of the label to add the required symbol to
                'value' => 'true',
            ),
        ),
    ),
