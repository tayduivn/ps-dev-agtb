...
//redeclaring array to preserve order
...
//declare links in desired order
$global_control_links['employees'] = array(
'linkinfo' => array($app_strings['LBL_EMPLOYEES']=> 'index.php?module=Employees&action=index'),
'submenu' => ''
);

$global_control_links['wiki'] = array(
'linkinfo' => array("Wiki" => 'http://internalwiki.sjc.sugarcrm.pvt'),
'submenu' => ''
);
$global_control_links['salesportal'] = array(
'linkinfo' => array("Sales Portal" => 'index.php?module=Home&action=SalesPortal'),
'submenu' => ''
 );
