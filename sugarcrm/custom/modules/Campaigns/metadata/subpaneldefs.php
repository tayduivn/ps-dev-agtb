...
/**
 * Set up the custom subpanels for the Campaigns Module
 * jwhitcraft 3.12.10
 */
$layout_defs['Campaigns'] = array(
	...
	'subpanel_setup' => array(
        ...
        'leadcontact' => array(
			...
			'module' => 'CampaignLog',
			'get_subpanel_data'=>"function:track_log_entries",
            'function_parameters'=>array(0=>'leadcontact','EMAIL_MARKETING_ID_VALUE'=>'',),
			'subpanel_name' => 'default',
			'title_key' => 'LBL_LOG_ENTRIES_LEAD_CONTACT_TITLE',
			'sort_order' => 'desc',
		),
        'contact' => array(
			'order' => 150,
        ...
        'leadcontacts' => array(
            ...
            'subpanel_name' => 'default',
            'title_key' => 'LBL_CAMPAIGN_LEAD_CONTACT_SUBPANEL_TITLE12354',
            'top_buttons' => array(),
        ),
        'opportunities' => array(
            'order' => 200,
