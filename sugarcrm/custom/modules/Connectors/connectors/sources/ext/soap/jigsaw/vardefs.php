...
$dictionary['ext_soap_jigsaw'] = array(
  ...
  'fields' => array (
   ...
   'revenue' => array(
        ...
        'function' => array('name'=>'get_jigsaw_revenue', 'include'=>'custom/modules/Connectors/connectors/sources/ext/soap/jigsaw/jigsaw_custom_functions.php'),
   ),  
   'revenueRange' => array(
        'name' => 'revenueRange',
   ...
   'employeeCount' => array(
        ...
        'type' => 'integer',
        'comment' => 'employee headcount estimate',
        'function' => array('name'=>'get_jigsaw_employeeCount', 'include'=>'custom/modules/Connectors/connectors/sources/ext/soap/jigsaw/jigsaw_custom_functions.php'),
   ), 
   'employeeRange' => array(
        'name' => 'employeeRange',
