...
<tr>
    <td valign='top' nowrap class='dataLabel'>{$userNameLbl}</td>
    <td valign='top' class='dataField'>
    	<input class="text" name="google_username" size='20' value='{$google_username}'>
    </td>
</tr>
<tr>
    <td valign='top' nowrap class='dataLabel'>{$numFeedsLbl}</td>
    <td valign='top' class='dataField'>
    	<input class="text" name="num_feeds" size='20' value='{$num_feeds}'>
    </td>
</tr>
<tr>
