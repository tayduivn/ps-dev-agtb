...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="tabForm">
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='monOpen' value='{$monOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='monClose' value='{$monClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='tueOpen' value='{$tueOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='tueClose' value='{$tueClose}'>
        </td>
        <td class='dataField'>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='wedOpen' value='{$wedOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='wedClose' value='{$wedClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='thuOpen' value='{$thuOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='thuClose' value='{$thuClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='friOpen' value='{$friOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='friClose' value='{$friClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='satOpen' value='{$satOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='satClose' value='{$satClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
        ...
        <td class='dataField'>
            <input size='7' type='text' name='sunOpen' value='{$sunOpen}'>
        </td>

	    <td class='dataLabel'>
            <input size='7' type='text' name='sunClose' value='{$sunClose}'>
        </td>
        <td class='dataField'>
    ...
    <tr>
    {foreach name=sla from=$sla key=name item=params}
    ...
    {/foreach}
        {foreach name=priority from=$priority key=name item=params}
        <td class='dataLabel' valign='top'>
            {$params.label}
        </td>
        <td class='dataField' valign='top' style='padding-bottom: 5px'>
