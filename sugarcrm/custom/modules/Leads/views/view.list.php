...
class LeadsViewList extends ViewList
{
 	...
 	function display()
    {
		...
		echo "\n<p>\n";
		echo get_module_title("Leads", $mod_strings['LBL_MODULE_TITLE'], true);
		echo "\n</p>\n";

		$mod_strings = return_module_language($current_language,'LeadAccounts');

		// Overload the export module since the user got here by clicking the "Leads" tab
		$export_module = "LeadAccounts";
		$_REQUEST['module'] = 'LeadAccounts';
		$controller = ControllerFactory::getController('LeadAccounts');
		$controller->loadBean();
