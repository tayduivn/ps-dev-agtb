...
function formSubmitCheck(){ldelim}if(check_form(\'EditView\') ){ldelim}document.forms[0].submit();{rdelim}{rdelim}</script>',
      'useTabs' => false,
    ),
    'panels' => 
    array (
