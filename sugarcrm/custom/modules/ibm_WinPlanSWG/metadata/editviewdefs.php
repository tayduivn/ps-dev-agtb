      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'customCode' => '<input name="opportunities_ibm_winplanswg_name" name="opportunities_ibm_winplanswg_name" type="hidden" value="{$fields.opportunities_ibm_winplanswg_name.value}" />
							<input name="opportunitb5cfunities_ida" id="opportunitb5cfunities_ida" type="hidden" value="{$fields.opportunitb5cfunities_ida.value}" />',
            'customLabel' => '',
          ),
        ),
      ),
