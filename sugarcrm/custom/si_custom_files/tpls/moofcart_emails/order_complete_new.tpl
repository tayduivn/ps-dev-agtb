...
<!-- BEGIN: renew -->
<!-- END: renew -->
<!-- BEGIN: upgrade_enterprise -->
<!-- END: upgrade_enterprise -->
<!-- BEGIN: add_support -->
<!-- END: add_support -->
    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" class="c21">
          <p>Thank you for your order with SugarCRM. Your order has been completed.</p>
          ...
          <table border="0" cellspacing="0" cellpadding="0" class="c6">
			...
			<!-- BEGIN: expiration -->
              <tr>
                ...
                <td valign="top" class="c4">{product.expiration_date}</td>
              </tr>
            <!-- END: expiration -->
            </tbody>
          </table>
          ...
          download the product onto your servers.</p>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="c6">
              <tbody>
                ...
                <tr>
                  ...
                  <td valign="top" class="c4">admin</td>
                </tr>
                ...
                <tr>
                  ...
                  <td valign="top" class="c9">{password}</td>
                </tr>
              </tbody>
            </table>

            <h2 class="c8">On-Site Deployment and Sugar Plug-Ins for Microsoft Office</h2>
            <p>You can download Sugar onto your servers and access purchased software through the SugarCRM <a href="http://www.sugarcrm.com/sugarshop/download" class="c1">Download Manager</a>. Click for instructions on installing <a href="http://kb.sugarcrm.com/?s=outlook+plugin+install" class="c1">Sugar Plug-Ins for Microsoft Office</a>.<br/><br/>During the installation process please enter the download key when prompted:<br/><strong>{download_key}</strong></p>
          ...
          <ul>
            <li class="c18">
            <a class="c1" href="http://support.sugarcrm.com">Support
            Portal</a> is where you can submit support cases. Please contact your companys Sugar Administrator to request access if you are unable to log in.
	   </li>
			<li class="c18">
			<a class="c1" href="http://kb.sugarcrm.com/">Sugar Knowledge Base</a> offers solutions to common issues.
			</li>
			<li class="c18">
			<a class="c1" href="http://www.sugarcrm.com/crm/support/documentation">Sugar Documentation</a> helps users and administrators get up to speed.
			</li>
			<li class="c18">
			<a class="c1" href="http://www.sugarcrm.com/university">Sugar University</a> provides online instruction for end users and administrators.
			</li>
			</li>
			<li class="c18">
			<a class="c1" href="http://developers.sugarcrm.com/index.php">Developer Zone</a> provides access to Sugar community blog, documentation, developer tools, tutorials, resources and more.
			</li>
          </ul>
