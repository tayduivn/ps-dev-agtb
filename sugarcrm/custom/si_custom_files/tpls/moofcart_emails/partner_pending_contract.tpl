...
<body>
	...
	<br />
	Your recent order is requiring your attention.  Please <a href="http://www.sugarcrm.com/crm/partners/partner_portal/sales?task=order&id={o.id}">click here</a> to upload a Contract for Order #{o.order_id}.
	<br />
	</p>
