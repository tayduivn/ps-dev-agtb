...
<body>
	...
	<br />
	Your recent order is requiring your attention.  Please  <a href="https://www.sugarcrm.com/sugarshop/account/order?id={o.id}">click here</a> to upload a Purchase Order for Order #{o.order_id}.
	<br />
	</p>
