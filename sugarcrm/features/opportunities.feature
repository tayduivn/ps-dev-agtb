...
Feature: Opportunities
  As a Sugar user, I need to be able to create and update and track Opportunities related to Accounts
  through the Opportunity itself and the use of Revenue Line Items
