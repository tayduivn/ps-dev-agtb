...
class DCMenu extends DashletContainer
{
	...
	public function getSearchIcon() {
		...
		$iconSearch = SugarThemeRegistry::current()->getLink($iconSearchUrl, '', 'class="searchIconLink"', "dcMenuSearchBtn.png", 'class="icon searchicon" align="top"',null,null,$GLOBALS['app_strings']['LBL_ALT_SPOT_SEARCH']);
		return $iconSearch;
	}
