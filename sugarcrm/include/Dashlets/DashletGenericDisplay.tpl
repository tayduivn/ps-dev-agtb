		...
		<tr height='20' class='{$_rowColor}S1'>
			...
			<td width='1%' class='{$_rowColor}S1' bgcolor='{$_bgColor}' nowrap>
				...
				{if $pageData.access.view}
					<a title='{$viewLinkString}' href='index.php?action=DetailView&module={$params.module|default:$pageData.bean.moduleDir}&record={$rowData[$params.parent_id]}&offset={$pageData.offsets.current+$smarty.foreach.rowIteration.iteration}&stamp={$pageData.stamp}&return_module=Home&return_action=index'><img border="0" src="{sugar_getimagepath file="view_inline.png"}"></a>
				{/if}
			</td>
			{/if}
	    	</tr>
