...
class DetailView
{
	...
	function processListNavigation( &$xtpl, $html_varName, $current_offset, $display_audit_link = false){
        ...
        if ($display_audit_link) {
            ...
            $audit_link = "<a href='javascript:void(0)' onclick='open_popup(\"Audit\", \"600\", \"400\", \"&record=".$_REQUEST['record']."&module_name=".$_REQUEST['module']."\", true, false, $encoded_popup_request_data);'>".$this->local_app_strings['LNK_VIEW_AUDIT_LOG']."</a>";
        }
