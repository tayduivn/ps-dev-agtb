...
class ReportListView  extends ListView {
	...
	function processDataSetNavigation(&$list, $xtemplateSection, $html_varName){
		...
		if(!empty($this->export_type) && $this->export_type=="Normal"){	
			$export_link = "<a target=\"_blank\" href=\"index.php?entryPoint=export&record=".$this->seed_object->id."&module=".$export_module."\" >".SugarThemeRegistry::current()->getImage("export","alt='".$this->local_app_strings['LBL_EXPORT']."'  border='0' align='absmiddle'")."&nbsp;".$this->local_app_strings['LBL_EXPORT']."</a>";
		} else {
//BEGIN SUGARCRM flav=ent ONLY
			...
			if(!empty($this->data_set_object->id)){	
				...
				$export_link = "<a target=\"_blank\" href=\"index.php?entryPoint=export_dataset&record=".$this->data_set_object->id."&module=".$export_module."\" >".SugarThemeRegistry::current()->getImage("export","alt='".$this->local_app_strings['LBL_EXPORT']."'  border='0' align='absmiddle'")."&nbsp;".$this->local_app_strings['LBL_EXPORT']."</a>";
			}
