...
SUGAR.mySugar = function() {
	...
	//			SUGAR.mySugar.togglePages(num_pages);
		...
		previewDashlet: function(id, description){
			ajaxStatus.showStatus('Previewing Dashlet');
			
			preview = document.getElementById('DashletPreview');
			
			preview.innerHTML = "<b>Dashlet Description: </b>" + description;
