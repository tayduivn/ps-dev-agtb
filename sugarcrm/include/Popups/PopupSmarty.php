 ...
 *
 * $Id: ListViewSmarty.php 18235 2006-12-02 01:25:49Z wayne $
...
class PopupSmarty extends ListViewSmarty{
	...
	function display($end = true) {
        ...
        $jsLang = getVersionedPath("cache/jsLanguage/{$GLOBALS['current_language']}.js",  $GLOBALS['sugar_config']['js_lang_version']);
