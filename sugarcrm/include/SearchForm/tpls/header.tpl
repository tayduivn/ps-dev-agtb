...
{/literal}
{{/if}}
<form name='search_form' id='search_form' class='search_form' method='post' action='index.php?module={$module}&action={$action}' onsubmit='return !SUGAR.ajaxSubmitForm(this.name);'>
