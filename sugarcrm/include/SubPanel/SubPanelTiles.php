...
<?php
        ...
        foreach ($tabs as $tab)
		{
			...
			if (empty($this->show_tabs))
			{
				$show_icon_html = SugarThemeRegistry::current()->getImage/*ALTFIXED*/( 'advanced_search', 'border="0 align="absmiddle""',null,null,'.gif',translate('LBL_SHOW'));
				$hide_icon_html = SugarThemeRegistry::current()->getImage/*ALTFIXED*/( 'basic_search', 'border="0" align="absmiddle"',null,null,'.gif',translate('LBL_HIDE'));
