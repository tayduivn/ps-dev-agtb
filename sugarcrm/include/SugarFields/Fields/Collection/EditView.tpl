...
<div id='{{sugarvar key='name'}}_div' name='{{sugarvar key='name'}}_div'><<!-ALTFIX!-->img src="{sugar_getimagepath file='sqsWait.gif'}" alt="loading..." id="{{sugarvar key="name"}}_loading_img" style="display:none"></div>
