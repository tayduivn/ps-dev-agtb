...
<<!--ALTFIXED-->img src='{$parentFieldArray.$col}' style='height: 64px;'>
{else}
...
<<!--ALTFIXED-->img src='index.php?entryPoint=download&id={$parentFieldArray.$col}&type=SugarFieldImage&isTempFile=1'
    style='height: 64px;'>
{/if}
