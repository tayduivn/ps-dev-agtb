...
class SugarForecasting_Hierarchy_User_RecursiveDBUserHierarchy implements SugarForecasting_Hierarchy_User_UserHierarchyInterface
{
    /**
     ...
     */
    protected function getChildren( $id, $users, $maxLevel ) {
        $retChildren = array();
