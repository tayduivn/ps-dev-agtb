...
$vardefs = array(
    'fields' => array(
        ...
        'emails_from' => array(
            'name' => 'emails_from',
            'relationship' => 'emails_' . strtolower($module) . '_from',
            'source' => 'non-db',
            'type' => 'link',
        ...
        'emails_to' => array(
            'name' => 'emails_to',
            'relationship' => 'emails_' . strtolower($module) . '_to',
            'source' => 'non-db',
            'type' => 'link',
        ...
        'emails_cc' => array(
            'name' => 'emails_cc',
            'relationship' => 'emails_' . strtolower($module) . '_cc',
            'source' => 'non-db',
            'type' => 'link',
            'vname' => 'LBL_EMAILS_RECEIVED',
        ),
        'emails_bcc' => array(
            'name' => 'emails_bcc',
            'relationship' => 'emails_' . strtolower($module) . '_bcc',
            'source' => 'non-db',
            'type' => 'link',
            'vname' => 'LBL_EMAILS_RECEIVED',
        ),
        'email_addresses_used' => array(
            ...
            'relationship' => strtolower($module) . '_email_addresses_used',
            'source' => 'non-db',
            'type' => 'link',
    ...
    'relationships' => array(
        ...
        strtolower($module) . '_email_addresses_used' => array(
            'lhs_module' => $module,
            'lhs_table' => strtolower($module),
            'lhs_key' => 'id',
            'rhs_module' => 'EmailAddresses',
        ...
        'emails_' . strtolower($module) . '_from' => array(
            'lhs_module' => 'Emails',
            'lhs_table' => 'emails',
            'lhs_key' => 'id',
            'rhs_module' => $module,
        ...
        'emails_' . strtolower($module) . '_to' => array(
            'lhs_module' => 'Emails',
            'lhs_table' => 'emails',
            'lhs_key' => 'id',
            'rhs_module' => $module,
        ...
        'emails_' . strtolower($module) . '_cc' => array(
            'lhs_module' => 'Emails',
            'lhs_table' => 'emails',
            'lhs_key' => 'id',
            'rhs_module' => $module,
        ...
        'emails_' . strtolower($module) . '_bcc' => array(
            'lhs_module' => 'Emails',
            'lhs_table' => 'emails',
            'lhs_key' => 'id',
            'rhs_module' => $module,
