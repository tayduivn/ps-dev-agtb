        ...
        switch (strtoupper($type)) {
          ...
          case "CANCEL":
			...
			case "AUDIT":
                ...
                $audit_link = '<a id="btn_view_change_log" title="{$APP.LNK_VIEW_AUDIT_LOG}" onclick=\'open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=' . $params['module'] . '", true, false, ' . $encoded_popup_request_data . '); return false;\'>{$APP.LNK_VIEW_AUDIT_LOG}</a>';
