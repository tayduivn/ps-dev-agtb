   ...
   if(!is_array($type)) {
   	  ...
   	  switch(strtoupper($type)) {
			...
			case "AUDIT":
                ...
                $audit_link = '<input id="btn_view_change_log" title="{$APP.LNK_VIEW_AUDIT_LOG}" class="button" onclick=\'open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=' . $params['module'] . '", true, false, ' . $encoded_popup_request_data . '); return false;\' type="button" value="{$APP.LNK_VIEW_AUDIT_LOG}">';
