...
class xml_domit_rss_document extends xml_domit_rss_base_document {
	...
	*/
	...
	function validateURL($url){
		if( (substr($url, 0,7) !== 'http://' && substr($url, 0,6) !== 'rss://' && substr($url, 0,8) !== 'https://' ) || substr_count($url, '(') > 0){
			$GLOBALS['log']->debug('RSS - ILLEGAL URL - ' . $url );
			return '';	
		}
		return $url;
	}
...
class xml_domit_rss_channel extends xml_domit_rss_elementindexer {
	...
	*/
	...
	/**
	* Returns the pubDate of the item
	...
	*/
	function getLink() {
		return xml_domit_rss_document::validateURL($this->getElementText(DOMIT_RSS_ELEMENT_LINK));
	} //getLink
	...
	*/
	...
	function &getImage($index) {
		return $this->domit_rss_image[$index];
	} //getItem
...
class xml_domit_rss_image extends xml_domit_rss_elementindexer {
	...
	*/
	function getUrl() {
		return xml_domit_rss_document::validateURL($this->getElementText(DOMIT_RSS_ELEMENT_URL));
	} //getUrl
