...
class ExternalAPIFactory
{
    ...
    public static function loadFullAPIList($forceRebuild=false, $ignoreDisabled = false) {
        ...
        $fullAPIList = sugar_cache_retrieve('external_api_list');
        if (!$forceRebuild && !empty($fullAPIList)) {
        ...
        sugar_cache_put('external_api_list', $apiFullList);
    ...
    public static function clearCache() {
        sugar_cache_clear('external_api_list');
