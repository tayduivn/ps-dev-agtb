...
class SugarWidgetDCESubPanelUserEditRoleButton extends SugarWidgetField
{
	...
	function displayList(&$layout_def)
	{
		...
		$href = 'index.php?module=' . $layout_def['module']
            . '&action=' . 'UserDCEInstanceRelationshipEdit'
            . '&record=' . $layout_def['fields']['DCEINSTANCE_ROLE_ID']
            . '&return_module=' . $_REQUEST['module']
            . '&return_action=' . 'DetailView'
            . '&return_id=' . $_REQUEST['record'];   
		$edit_icon_html = SugarThemeRegistry::current()->getImage/*ALTFIXED*/( 'edit_inline','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_EDIT']);
