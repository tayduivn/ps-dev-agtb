...
class SugarWidgetSubPanelDeleteButton extends SugarWidgetField
{
	function displayList($layout_def)
	{
		...
		$html = "<a onclick='return sp_del_conf();' href=\"javascript:sub_p_del('$subpanel', '$module_name', '$record_id', $refresh_page);\">".SugarThemeRegistry::current()->getImage("delete_inline","alt=".translate('LBL_DELETE_INLINE',$module_name)." border='0'").$app_strings['LNK_DELETE']."</a>";
		return $html;
