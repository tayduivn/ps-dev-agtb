...
class SugarWidgetSubPanelEditQuantityButton extends SugarWidgetField
{
    ...
    function displayList(&$layout_def)
    {
        ...
        $href = 'index.php?module=' . $layout_def['module']
            . '&action=' . 'SubscriptionDistGroupRelationshipEdit'
            . '&record=' . $layout_def['fields']['QUANTITY_FIELDS_ID']
