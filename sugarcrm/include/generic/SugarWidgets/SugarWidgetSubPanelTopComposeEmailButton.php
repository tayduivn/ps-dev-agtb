	...
	function display($defines)
	{
		...
		if($client != 'sugar') {
			...
			if (isset($bean->emailAddress)){
				...
				$button = "<input class='button' type='button'  value='$value'  id='".preg_replace('[ ]', '', $value)."_button'  name='".preg_replace('[ ]', '', $value)."_button'  accesskey='$accesskey' title='$title' onclick=\"location.href='mailto:$to_addrs';return false;\" />";
			}
			else{
				$button = "<input class='button' type='button'  value='$value'  id='".preg_replace('[ ]', '', $value)."_button'  name='".preg_replace('[ ]', '', $value)."_button'  accesskey='$accesskey' title='$title' onclick=\"location.href='mailto:';return false;\" />";
			}
		}else 
		{
            ...
            $button = "<input title='$title'  id='".preg_replace('[ ]', '', $value)."_button' accesskey='$accesskey' onclick='SUGAR.quickCompose.init($j_quickComposeOptions);' class='button' type='submit' name='".preg_replace('[ ]', '', $value)."_button' value='$value'";
		}
		return $button;	 
	}
}
