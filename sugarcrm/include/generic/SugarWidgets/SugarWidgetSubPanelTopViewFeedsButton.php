...
class SugarWidgetSubPanelTopViewFeedsButton extends SugarWidgetSubPanelTopButton
{
    ...
    function display ($widget_data) {
        ...
        $initial_filter = "&to_pdf=1&action=getFeeds&record=".$widget_data['focus']->id."&name=".$widget_data['focus']->name."&module_name=$currentModule";
