    ...
    /**
   	...
   	$.fn.dataTableExt.afnSortData['dom-number'] = function  ( oSettings, iColumn )
   	{
        ...
        $('td:eq('+iColumn+') span[sfuuid]', oSettings.oApi._fnGetTrNodes(oSettings) ).each( function () {
            aData.push(SUGAR.App.utils.unformatNumberString(this.textContent, SUGAR.App.user.get('number_grouping_separator'), SUGAR.App.user.get('decimal_separator'), false));
        });
   		return aData;
   	}
})(jQuery);