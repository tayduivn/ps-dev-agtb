...
(function(app) {
    app.events.on('app:init', function() {
        ...
        app.plugins.register('ResizableColumns', ['view'], {
             ...
             * @inheritDoc
             *
             * On render makes the list view columns resizable.
             */
            onAttach: function(component, plugin) {
                this.before('render', this._unbindResizableColumns, this);
                this.before('dispose', this._unbindResizableColumns, this);
                this.on('render', _.debounce(this._makeColumnResizable, 100), this);
            },
