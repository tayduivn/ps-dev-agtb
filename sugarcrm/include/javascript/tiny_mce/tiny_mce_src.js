...
(function() {
	...
	tinymce.create('static tinymce.dom.Event', {
		...
		_wait : function() {
			...
			//Sugar bug fix.  When using YUI Loader to pull in tinyMCE, IE crashes because of the document.write calls.
			var skipInitPhase =  (typeof (skipTinyMCEInitPhase) != 'undefined')  ? true : false;
			if (isIE && document.location.protocol != 'https:' && !skipInitPhase ) {
