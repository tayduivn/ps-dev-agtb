...
Sincerely, SugarCRM',
    ...
    'WARN_BROWSER_VERSION_WARNING' => "<b>Warning:</b> Your browser version is no longer supported or you are using an unsupported browser.<p></p>The following browser versions are recommended:<p></p><ul><li>Internet Explorer 9 (compatibility view not supported)<li>Firefox 35<li>Safari 7.1<li>Chrome 41</ul>",
    ...
    'ERROR_ACTIVE_DATE_LOW' => 'Error. The publish date can not be before the current date.',
