...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_TOUR_SCREEN_1_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Set up your forecasting parameters</li><li class="icon-ok">Keep track of your projected sales</li><li class="icon-ok">Forecast your sales teams projected sales</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen1-thumb.png" width="220" id="thumbnail_1" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_SCREEN_2_TITLE' => 'Setup your Forecasting Parameters',
    'LBL_TOUR_SCREEN_2_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Select your Fiscal Year</li><li class="icon-ok">Set up your Forecast Time Period by Year or Quarter</li><li class="icon-ok">Select number of Time Periods to Forecast over</li><li class="icon-ok">Select Categories to include in Forecast</li><li class="icon-ok">Select Range to Forecast, such as likely, best or worst</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen2-thumb.png" width="220" id="thumbnail_2" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_SCREEN_3_TITLE' => 'Manage your Sales Teams Projected Sales',
    'LBL_TOUR_SCREEN_3_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Select the Time Period for your Forecast</li><li class="icon-ok">View your sales teams worksheets, and adjust their forecast numbers</li><li class="icon-ok">Get Alerts when your sales team members commits new Forecasts</li><li class="icon-ok">Save Forecast Worksheet</li><li class="icon-ok">Commit Forecast to Manager, and view History of previous Commits</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen3-thumb.png" width="220" id="thumbnail_3" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_SCREEN_4_TITLE' => 'Manage your Sales Teams Projected Sales',
    'LBL_TOUR_SCREEN_4_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">You can view Charts or Tables with the projected sales numbers for the entire sales team or by individual team member</li><li class="icon-ok">You can change the Chart to visualize projected sales by Likely, Best or Worst values</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen4-thumb.png" width="220" id="thumbnail_4" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_SCREEN_5_TITLE' => 'Manage your Projected Sales',
    'LBL_TOUR_SCREEN_5_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">Select the Time Period for your Forecast</li><li class="icon-ok">Review and Edit Amounts and Probabilities for your Opportunities</li><li class="icon-ok">Save Forecast Worksheet</li><li class="icon-ok">Commit Forecast to Manager, and view History of previous Commits</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen5-thumb.png" width="220" id="thumbnail_5" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_SCREEN_6_TITLE' => 'Manage your Projected Sales',
    'LBL_TOUR_SCREEN_6_DESCRIPTION' => '<div style="float: left;"><div style="float: left; width: 300px;"><ul><li class="icon-ok">You can view Charts with your own Opportunities for a selected Time Period</li><li class="icon-ok">You can view Charts and Tables of the projected sales numbers for your own Opportunities</li><li class="icon-ok">You can change the setting to change the properties visualized the chart by Sales Stage and by Probabilities</li></ul></div><div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="themes/default/images/pt-screen6-thumb.png" width="220" id="thumbnail_6" class="thumb"></div></div><div class="clear"></div>',
    'LBL_TOUR_WELCOME' => 'What\'s New in Sugar',
    'LBL_TOUR_WATCH' => 'Watch What\'s New in Sugar',
    'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Forecasting re-tooled</li><li class="icon-ok">New Feature</li></ul>',
