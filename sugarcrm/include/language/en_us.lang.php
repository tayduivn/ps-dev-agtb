...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_VALUE_ERASED_TOOLTIP' => 'The value of the field has been erased per request',
    ...
    'LBL_ENABLE_TOUCHID' => 'Enable Touch ID',
    'LBL_SETUP_TOUCHID' => 'Setup Touch ID',
    'LBL_TOUCH_ID_AUTHENTICATE_SUBTITLE' => 'Sign in using your finger',
    'LBL_TOUCH_ID_NOT_ENROLLED_MSG' => 'Touch ID is not set up on your device. \n\nGo to your device settings to set up Touch ID. Once set up, enable Touch ID for {{{brandName}}} in Main Menu > Settings.',
    'LBL_TOUCH_ID_DISCLAIMER' => 'Using Touch ID with {{{brandName}}} will allow you to use your fingerprint instead of entering your password to access {{{brandName}}}.',
    'LBL_TOUCH_ID_ENABLE_CONFIRM_MSG' => ' Would you like to proceed with Touch ID?',
    'LBL_TOUCH_ID_ENTER_PASSWORD_TITLE' => 'Enter {{{brandName}}} Password to Enable Touch ID',
    ...
    'LBL_BULK_LOAD_COMPLETED_MESSAGE' => 'Your records have finished \n downloading. You can now access them in offline mode.',
