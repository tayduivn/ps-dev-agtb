...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_PORTAL_TOUR_SCREEN5_BODY' => '<p>From the profile page you will, for instance, be able to change password, update email address, and change preferred language. </p> <p>In the profile page you will be able to change password, update email address, change preferred language, etc.</p>',
