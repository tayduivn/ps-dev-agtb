...
$app_strings = array (
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'TPL_LISTVIEW_SELECTED_FIRST_OFFSET' => 'There are more than {{num}} records in the result set. You have selected the first {{num}} records. <a href="javascript:void(0);">Clear selections</a>.',
    'TPL_LISTVIEW_SELECTED_ALL' => 'You have selected all {{num}} records in the result set. <a href="javascript:void(0);">Clear selections</a>.',
