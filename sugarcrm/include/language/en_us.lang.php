...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_PORTAL_TOUR_SCREEN2_BODY' => '<p>The Dashboards represent your home page. It displays a quick synopsis of your company’s Cases, KB Articles, and Bugs. Click the Sugar cube icon on the top left corner of any Portal page to navigate back to the Dashboard. Each Dashboard show five last modified records per module. To view additional records click on the module link.</p>',
    'LBL_PORTAL_TOUR_SCREEN3_TITLE' => 'Footer',
    'LBL_PORTAL_TOUR_SCREEN3_BODY' => '<p>Your footer bar can be used for the following: <ul class="features"><li class="icon-ok">Language: Select your preferred language from this list (you can also choose your language in the profile page). Once the language changed all labels in the Portal web site will be translated.</li><li class="icon-ok">Tour: Familiarize yourself with the new Sugar Portal features</li><li class="icon-ok">Print: Create a print out of the Sugar Portal page for your personal records</li> <li class="icon-ok">Top: Navigate to the top of the Sugar Portal page you are in</li></ul></p>',
    'LBL_PORTAL_TOUR_SCREEN4_TITLE' => 'Search',
    'LBL_PORTAL_TOUR_SCREEN4_BODY' => '<p>There are two types of Search: Global Search – located in the top navigation bar, search for Cases, Bugs, and Knowledge Base Documents by their names and numbers.</p> <p>Specific module Search – located in the top of the list view in each module</p> <p><img src="../themes/default/images/ppt-search.png" height="200" width="530"></p><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 320px; top: -162px;"></i>',
    'LBL_PORTAL_TOUR_SCREEN5_TITLE' => 'Profile',
    'LBL_PORTAL_TOUR_SCREEN5_BODY' => '<p>View and edit your profile here (click your name on the right side of the navigation bar. Choose Profile on drop down panel). </p> <p>In the profile page you will be able to change password, update email address, change preferred language, etc.</p>',
