...
//END SUGARCRM flav=dce ONLY
    ...
    'WARN_BROWSER_VERSION_WARNING' => "<b>Warning:</b> Your browser version is no longer supported or you are using an unsupported browser.<p></p>The following browser versions are recommended:<ul><li>Internet Explorer 9 (compatibility view not supported)<li>Firefox 14<li>Safari 6<li>Chrome 22</ul>",
