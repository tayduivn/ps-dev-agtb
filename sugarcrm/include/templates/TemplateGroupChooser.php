...
EOQ;
        ...
        if(!isset($this->args['disable'])) { 
            $str .= "<a onclick=\"return SUGAR.tabChooser.up('{$this->args['left_name']}','{$this->args['left_name']}','{$this->args['right_name']}');\">" .  SugarThemeRegistry::current()->getImage/*ALTFIXED*/('uparrow_big','border="0" style="margin-bottom: 1px;"',null,null,'.gif',$alt_tip) . "</a><br>
                     <a onclick=\"return SUGAR.tabChooser.down('{$this->args['left_name']}','{$this->args['left_name']}','{$this->args['right_name']}');\">" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('downarrow_big','border="0" style="margin-top: 1px;"',null,null,'.gif',$alt_tip) . "</a>";
        }
...
EOQ;
        ...
        if ($this->display_hide_tabs == true) {
            ...
            if(!isset($this->args['disable'])) { 
                $str .= "<a onclick=\"return SUGAR.tabChooser.right_to_left('{$this->args['left_name']}','{$this->args['right_name']}', '{$left_size}', '{$right_size}', '{$max_left}');\">" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('leftarrow_big','border="0" style="margin-right: 1px;"',null,null,'.gif',$alt_tip) . "</a><a onclick=\"return SUGAR.tabChooser.left_to_right('{$this->args['left_name']}','{$this->args['right_name']}', '{$left_size}', '{$right_size}');\">" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('rightarrow_big','border="0" style="margin-left: 1px;"',null,null,'.gif',$alt_tip) . "</a>";
            }
            $str .= "</td>
         ...
         if ($this->display_third_tabs == true) {
            $str .= '<td valign="top" style="padding-right: 2px; padding-left: 2px;" align="center">';
            if(!isset($this->args['disable'])) { 
                $str .= "<a onclick=\"return SUGAR.tabChooser.right_to_left('{$this->args['right_name']}','{$this->args['third_name']}', '{$right_size}', '{$third_size}');\">" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('leftarrow_big','border="0" style="margin-right: 1px;"',null,null,'.gif',$alt_tip) . "</a><a onclick=\"return SUGAR.tabChooser.left_to_right('{$this->args['right_name']}','{$this->args['third_name']}', '{$right_size}', '{$third_size}');\">" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('rightarrow_big','border="0" style="margin-left: 1px;"',null,null,'.gif',$alt_tip) . "</a>";
            }
            $str .= "</td>
