...
$mod_strings = array(
	'LBL_SYSOPTS_1'						=> '请选择下面的系统配置选项。',
  'LBL_SYSOPTS_2'           => '何种数据库将被用来安装用于Sugar?',
	'LBL_SYSOPTS_CONFIG'				=> '系统配置',
	'LBL_SYSOPTS_DB_TYPE'				=> '',
	'LBL_SYSOPTS_DB'					=> '选择数据库',
  'LBL_SYSOPTS_DB_TITLE'              => '数据库类型',
	'LBL_SYSOPTS_ERRS_TITLE'			=> '在继续执行前，请修复下面的错误:',

	
	'LBL_SYSOPTS_DB_DIRECTIONS'			=> '如果您要选择Oracle，您必须要有安装和配置的Oracle客户端。',
	'ERR_DB_LOGIN_FAILURE_OCI8'			=> '不能连接SugarCRM数据库。错误:',
	'ERR_DB_OCI8_CONNECT'				=> '不能连接SugarCRM数据库。错误:',
	'ERR_DB_OCI8_VERSION'				=> '只支持Oracle9i和以上的版本。',
  'LBL_DBCONFIG_MSG1'                 => '请提供数据库名称.  这个将被用作默认的表空间分配给用户',
  // seed Ent Reports
	'LBL_Q'								=> '商业机会查询',
	'LBL_Q1_DESC'						=> '商业机会按类型',
	'LBL_Q2_DESC'						=> '商业机会按客户',
	'LBL_R1'							=> '6个月的销售数据报表',
	'LBL_R1_DESC'						=> '未来超过6个月的商业机会将会根据月份和类型分解',
	'LBL_OPP'							=> '商业机会数据设置',
	'LBL_OPP1_DESC'						=> '这儿就是您可以更改自定义查询的地方',
	'LBL_OPP2_DESC'						=> '这个查询会堆栈在报表中的第一个查询后',


	'ERR_OC_PASSWORD'					=> '必须要有密码。',
	'ERR_OC_SERVER_URL'					=> '必须要有Sugar服务器网址。',
	'ERR_OC_USERNAME'					=> '必须要有服务器用户的用户名。',
	'LBL_INSTALL_OC'					=> '安装离线客户端',
    'LBL_OC_ADMIN'                      => '请联系您的管理员来解决这个问题。',
    'LBL_OC_SUCCESS'                    => '离线客户端安装已完成。点击下面的按钮返回安装。',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> '管理员用户名',
	'LBL_OC_INSTAL_DIRECTIONS'			=> '请输入下面的细节，为了完全的安装和同步您的离线客户端。',
	'LBL_OC_INSTALL_SERVER_URL'			=> 'Sugar服务器的网址',
	'LBL_OC_INSTALL_PASS'				=> '服务器用户的密码',
	'LBL_OC_INSTALL_TITLE'				=> '离线客户端安装',
	'LBL_OC_INSTALL_USERNAME_DETAILS'	=> '这个是您连接Sugar服务器的用户名。',
	'LBL_OC_INSTALL_USERNAME'			=> '用户名',
	'LBL_PERFORM_OC_INSTALL'			=> '初始化离线客户端安装',
    'LBL_OC_INSTALL_DIRECTIONS'         => '请输入下面的细节，为了完全的安装和同步您的离线客户端。',
