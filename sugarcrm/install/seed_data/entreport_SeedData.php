...
sum( case when trunc(opportunities.date_closed, 'month') = trunc(ADD_MONTHS(sysdate, 1), 'month') then opportunities.amount_usdollar else 0 end ) \"{sc}0{sc}1\",
sum( case when trunc(opportunities.date_closed, 'month') = trunc(ADD_MONTHS(sysdate, 2), 'month') then opportunities.amount_usdollar else 0 end ) \"{sc}0{sc}2\",
sum( case when trunc(opportunities.date_closed, 'month') = trunc(ADD_MONTHS(sysdate, 3), 'month') then opportunities.amount_usdollar else 0 end ) \"{sc}0{sc}3\",
sum( case when trunc(opportunities.date_closed, 'month') = trunc(ADD_MONTHS(sysdate, 4), 'month') then opportunities.amount_usdollar else 0 end ) \"{sc}0{sc}4\",
sum( case when trunc(opportunities.date_closed, 'month') = trunc(ADD_MONTHS(sysdate, 5), 'month') then opportunities.amount_usdollar else 0 end ) \"{sc}0{sc}5\"
FROM opportunities
...
WHERE opportunities.date_closed <= ADD_MONTHS(sysdate,5) AND  opportunities.date_closed >= sysdate AND opportunities.opportunity_type = 'New Business'
) UNION (
SELECT
...
LEFT JOIN accounts 
ON accounts_opportunities.account_id=accounts.id
WHERE opportunities.date_closed <= ADD_MONTHS(sysdate,5) AND  opportunities.date_closed >= sysdate AND opportunities.opportunity_type = 'Existing Business'
) UNION (
SELECT
...
LEFT JOIN accounts 
ON accounts_opportunities.account_id=accounts.id
WHERE opportunities.date_closed <= ADD_MONTHS(sysdate,5) AND  opportunities.date_closed >= sysdate
)";
...
//BEGIN SUGARCRM flav=ent ONLY
	...
	LEFT JOIN accounts 
	ON accounts_opportunities.account_id=accounts.id
	WHERE opportunities.date_closed <= ADD_MONTHS(sysdate, 5)
