...
class Tokenizer {
    ...
    private function nextChar($signal_eof = null, $in_string = null) {
    ...
    private function find($str, $signal_eof = FALSE) {
    ...
    private function parse_error($err)  {
    ...
    private function read_escaped_char($in_string = null) {
    ...
    private function read_string($quote_string = FALSE) {
    ...
    private function read_regexp($regexp) {
        // The following line is a hack until PHP 5.4.
        $ref = $this;
