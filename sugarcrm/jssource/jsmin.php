...
/**
 * Wrapper class for JSMIN. JSMin was the original minifier which has been swapped out for
 * JSMinPlus (which is completely different) because of licensing reasons.
 *
 */
class JSMin {
    /**
