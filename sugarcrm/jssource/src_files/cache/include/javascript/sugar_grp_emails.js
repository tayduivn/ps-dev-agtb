...
SUGAR.forms.AssignmentHandler.registerForm(form.name,form);},toggleCheckbox:function(el)
...
SUGAR.dependentDropdown.debugMode=true;SUGAR.dependentDropdown.handleDependentDropdown=function(el){}
...
try{newElement.onchange();}catch(e){if(SUGAR.dependentDropdown.dropdowns.debugMode){debugger;}}}else{debugger;}}
