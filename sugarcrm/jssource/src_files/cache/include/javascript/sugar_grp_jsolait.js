 ...
 */
function method_callback(o){var resp=YAHOO.lang.JSON.parse(o.responseText),request_id=o.tId,result=resp.result;if(result==null){if(typeof(o)=='object'&&typeof(o.statusText)!='undefined'){alert("Error from json server: "+o.statusText);}else{alert("Error calling json server: "+o.statusText);}
return;}
