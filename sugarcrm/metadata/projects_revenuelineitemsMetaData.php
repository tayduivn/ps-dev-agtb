...
$dictionary['projects_revenuelineitems'] = array (
    ...
    'indices' => array (
        array('name' => 'projects_rli_pk', 'type' =>'primary', 'fields'=>array('id')),
        array('name' => 'idx_proj_rli_project', 'type' =>'index', 'fields'=>array('project_id')),
        array('name' => 'idx_proj_rli_product', 'type' =>'index', 'fields'=>array('rli_id')),
        array('name' => 'projects_rli_alt', 'type'=>'alternate_key', 'fields'=>array('project_id','rli_id')),
    ),
    'relationships' => array (
