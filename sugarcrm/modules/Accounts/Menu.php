...
if(ACLController::checkAccess('Accounts', 'import', true))$module_menu[]=Array("javascript:void(SUGAR.importWizard.renderDialog('Accounts','step1',''));", $mod_strings['LNK_IMPORT_ACCOUNTS'],"Import", 'Accounts');
?>