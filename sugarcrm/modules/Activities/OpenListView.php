...
if(ACLController::checkAccess('Meetings', 'list', true)){
	...
	//BEGIN SUGARCRM flav=ent ONLY
		$where .= " AND CONCAT(".db_convert("date_start","date_format",array("'YYYY-MM-DD'")).", CONCAT(' ',". db_convert("time_start","time_format",array("'HH24:MI:SS'"))." )) <=". "'".$laterWhere["date"]." ".$laterWhere["time"]."' ";				
