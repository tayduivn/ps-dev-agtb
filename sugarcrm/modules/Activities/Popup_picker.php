...
class Popup_Picker
{
    ...
    */
    function process_page() {
        ...
        echo "<A href='javascript:print();' class='utilsLink'>" . SugarThemeRegistry::current()->getImage/*ALTFIXED*/('print', "border='0' align='absmiddle'", 13, 13, ".gif", $app_strings['LNK_PRINT']) . "</a>&nbsp;<A href='javascript:print();' class='utilsLink'>".$app_strings['LNK_PRINT']."</A>\n";
        echo "</td></tr></table>";
        ...
        foreach($history_list as $activity)
        {
            ...
            if (isset($activity['filename'])) {
                $activity_fields['ATTACHMENT'] = "<a href='index.php?entryPoint=download&id=".$activity['id']."&type=Notes' target='_blank'>".SugarThemeRegistry::current()->getImage/*ALTFIXED*/("attachment","border='0' align='absmiddle'",null,null,'.gif',$activity['filename'])."</a>";
            }
