...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
			...
			<table id="passRequirementId" name="passRequirementName" width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
				<tr>
				...
				<tr>
							...
							<tr>
								...
								<td >
									...
									<input id='passwordsetting_oneupper' name='passwordsetting_oneupper'  type='checkbox' value='1' {$oneupper_checked}>
								</td>
								<td  scope="row">
								...
								<td >
									...
									<input id='passwordsetting_onelower' name='passwordsetting_onelower'  type='checkbox' value='1' {$onelower_checked}>
								</td>
							</tr>
							<tr>
								<td  scope="row">
								...
								<td >
									...
									<input id='passwordsetting_onenumber' name='passwordsetting_onenumber'  type='checkbox' value='1' {$onenumber_checked}>
								</td>
								<td  scope="row">
							...
							<tr>
								<td colspan='4'>
										<a class="tabFormAdvLink" href="javascript:toggleDisplay_2('regex_config_display')"><img id='regex_config_display_img' border="0" src="{sugar_getimagepath file="advanced_search.gif"}"/>&nbsp<span id='regex_config_display_lbl'>{$MOD.LBL_SHOW_ADVANCED_OPTIONS}<span></a>
								</td>
							</tr>
							<tr>
								<td colspan='4'>
						...
						<table id="emailTemplatesId" name="emailTemplatesName" width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
							...
							<!--//BEGIN SUGARCRM flav=pro ONLY -->
									...
									<table id="userGenPassExpId" name="userGenPassExpName" width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
										<tr>
											<th align="left" scope="row" colspan="4">
												<h4 scope="row" >
								...
								<table id="loginLockoutId" name="loginLockoutName" width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
								<tr>
									<th align="left" scope="row" colspan="4">
										<h4>
