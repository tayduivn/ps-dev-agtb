...
echo getClassicModuleTitle($mod_strings['LBL_MODULE_NAME'], array($mod_strings['LBL_UPGRADE_TITLE']), true);
$str1="";
...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Upgrade','alt="'. $mod_strings['LBL_UPGRADE_TEAM_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=upgradeTeams"><?php echo $mod_strings['LBL_UPGRADE_TEAM_TITLE']; ?></a></td>
...
<!-- //BEGIN SUGARCRM flav=pro ONLY -->
<tr>
    <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_REBUILD_EXPRESSIONS_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildExpressionPlugins"><?php echo $mod_strings['LBL_REBUILD_EXPRESSIONS_TITLE']; ?></a></td>
...
<!--//BEGIN SUGARCRM flav=pro ONLY -->
<tr>
    <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_REBUILD_CONFIG'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildWorkFlow"><?php echo $mod_strings['LBL_REBUILD_WORKFLOW']; ?></a></td>
...
<!--//BEGIN SUGARCRM flav=pro ONLY -->
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REPAIR_TEAMS'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RepairTeams&silent=0"><?php echo $mod_strings['LBL_REPAIR_TEAMS']; ?></a></td>
...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REPAIR_ORACLE_VARCHAR'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RepairOracleVarcharColumns"><?php echo $mod_strings['LBL_REPAIR_ORACLE_VARCHAR']; ?></a></td>
...
<!--//BEGIN SUGARCRM flav=dce ONLY -->
<tr>
    <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_IMPORT_INSTANCES'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=CreateImportAction"><?php echo $mod_strings['LBL_IMPORT_INSTANCES']; ?></a></td>
