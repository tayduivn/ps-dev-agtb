 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: index.php 54885 2010-02-24 18:49:06Z jmertic $
    ...
    foreach ($module_index as $mod_key=>$mod_val) {
        ...
        (!isset($addedHeaderGroups[$values[0]]))) {
            ...
            foreach ($mod as $link_idx =>$admin_option) {
                ...
                $colnum+=1;
                $header_image[$j][$i]= SugarThemeRegistry::current()->getImage/*ALTFIXED*/($admin_option[0],'border="0" align="absmiddle"',null,null,'.gif',translate($admin_option[1],'Administration'));
