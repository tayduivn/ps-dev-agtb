...
$mod_strings = array (
    ...
    'LBL_PREPEND_WILDCARD_HELP' => 'Select this option to automatically prepend the wildcard to the beginning of the entered text in the Global Search input field. The wildcard will not be displayed. For example, if the wildcard character is "%", the search will be performed on "%entered-string%" instead of "entered-string%.',
