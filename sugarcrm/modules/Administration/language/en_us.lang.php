...
$mod_strings = array (
    ...
    'LBL_PREPEND_WILDCARD_TITLE' => 'Flexible Search',
    'LBL_PREPEND_WILDCARD' => 'Prepend search string with wildcard',
    'LBL_PREPEND_WILDCARD_HELP' => 'Select this option to automatically prepend the wildcard to the beginning of the entered text in the Global Search input field. The wildcard will not be displayed. For example, if the wildcard character is "%", the search will be performed on "%entered-string%" instead of "entered-string%". <br><br>Note: If you use this option without the Full Text Search feature, your system will be at risk for performance degradation.',
...
//BEGIN SUGARCRM flav=dce ONLY
    'LBL_IMPORT_INSTANCES_DESC' =>'This tool allows you to import existing instances into DCE.  Please note that instances imported will have limited support and functionality.',
    'LBL_IMPORT_INSTANCES' =>'Import existing instances',
    'LBL_IMPORT_INSTANCE_ACTION'  =>  'Action to import existing Instances has been created.',
//END SUGARCRM flav=dce ONLY
    ...
    'LBL_STATUS'=>'Status ',
    //BEGIN SUGARCRM flav=sales ONLY
    'LBL_TOOLS_DESC' => 'Edit modules and module layouts, manage standard and custom fields. ',
    //END SUGARCRM flav=sales ONLY
    //BEGIN SUGARCRM flav!=sales ONLY
    ...
    //END SUGARCRM flav=com ONLY
    //BEGIN SUGARCRM flav=sales ONLY
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in Sugar. Create and manage roles.',
    //END SUGARCRM flav=sales ONLY
...
//BEGIN SUGARCRM flav=dce ONLY
    ...
    'LBL_DCE_DCEACTIONS_TITLE'=>'DCE Actions',
    'LBL_DCE_DCEACTIONS'=>'List actions that need to be taken by the Cluster/Client Server',
    'LBL_DCE_SETTINGS_TITLE'=>'DCE Settings',
    'LBL_DCE_SETTINGS'=>'Configure DCE settings',
    'LBL_DN_PROPERTIES_TITLE'=>'DCE Client Properties',
    'LBL_DN_PROPERTIES'=>'Configure DCE Client Properties',
//END SUGARCRM flav=dce ONLY
	//BEGIN SUGARCRM flav=pro ONLY
