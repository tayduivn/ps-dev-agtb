...
$admin_option_defs['Quotes']['quotes_setup']= array('Quotes','LBL_MANAGE_QUOTES_TITLE','LBL_MANAGE_QUOTES','javascript:void(parent.SUGAR.App.router.navigate("Quotes/config", {trigger: true}));');
