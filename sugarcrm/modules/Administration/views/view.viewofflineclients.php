...
class ViewViewofflineclients extends SugarView
{
	...
	public function display()
	{
        ...
        $ListView->xTemplateAssign("DELETE_INLINE_PNG",  SugarThemeRegistry::current()->getImage/*ALTFIXED*/('delete_inline','align="absmiddle" border="0"', null,null,'.gif', "{SYSTEM.LBL_DISABLE}"));
