...
$dictionary['BusinessCenter'] = [
    ...
    'fields' => [
        ...
        'sunday_closed_hour' => [
            'name' => 'sunday_closed_hour',
            'vname' => 'LBL_SUNDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'sunday_closed_minutes' => [
            'name' => 'sunday_closed_minutes',
            'vname' => 'LBL_SUNDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'monday_closed_hour' => [
            'name' => 'monday_closed_hour',
            'vname' => 'LBL_MONDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'monday_closed_minutes' => [
            'name' => 'monday_closed_minutes',
            'vname' => 'LBL_MONDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'tuesday_closed_hour' => [
            'name' => 'tuesday_closed_hour',
            'vname' => 'LBL_TUESDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'tuesday_closed_minutes' => [
            'name' => 'tuesday_closed_minutes',
            'vname' => 'LBL_TUESDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'wednesday_closed_hour' => [
            'name' => 'wednesday_closed_hour',
            'vname' => 'LBL_WEDNESDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'wednesday_closed_minutes' => [
            'name' => 'wednesday_closed_minutes',
            'vname' => 'LBL_WEDNESDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'thursday_closed_hour' => [
            'name' => 'thursday_closed_hour',
            'vname' => 'LBL_THURSDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'thursday_closed_minutes' => [
            'name' => 'thursday_closed_minutes',
            'vname' => 'LBL_THURSDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'friday_closed_hour' => [
            'name' => 'friday_closed_hour',
            'vname' => 'LBL_FRIDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'friday_closed_minutes' => [
            'name' => 'friday_closed_minutes',
            'vname' => 'LBL_FRIDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'saturday_closed_hour' => [
            'name' => 'saturday_closed_hour',
            'vname' => 'LBL_SATURDAY_CLOSED_HOUR',
            'type' => 'enum',
            'function' => 'getHoursDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
        ...
        'saturday_closed_minutes' => [
            'name' => 'saturday_closed_minutes',
            'vname' => 'LBL_SATURDAY_CLOSED_MINUTES',
            'type' => 'enum',
            'function' => 'getMinutesDropdown',
            'function_bean' => 'BusinessCenters',
            'len' => 2,
