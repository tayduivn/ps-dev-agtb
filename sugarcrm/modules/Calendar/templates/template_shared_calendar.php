 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: template_shared_calendar.php 42215 2008-11-26 20:35:04Z jmertic $
 ********************************************************************************/
...
<tr height="15">
	<td width="100%"></td>
    <td class="listViewCalCurrentApptLgnd"><?php echo SugarThemeRegistry::current()->getImage/*ALTFIXED*/('blank', '', 15, 15, ".gif", $mod_strings['LBL_SCHEDULED']); ?>&nbsp;</td>
    <td>&nbsp;<?php echo $mod_strings['LBL_SCHEDULED']; ?>&nbsp;</td>
    <td class="listViewCalOtherApptLgnd"><?php echo SugarThemeRegistry::current()->getImage/*ALTFIXED*/('blank', '', 15, 15, ".gif", $mod_strings['LBL_BUSY']); ?>&nbsp;</td>
    <td>&nbsp;<?php echo $mod_strings['LBL_BUSY']; ?>&nbsp;</td>
    <td class="listViewCalConflictApptLgnd"><?php echo SugarThemeRegistry::current()->getImage/*ALTFIXED*/('blank', '', 15, 15, ".gif", $mod_strings['LBL_CONFLICT']); ?>&nbsp;</td>
