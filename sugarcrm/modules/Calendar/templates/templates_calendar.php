...
<?php
	...
	function template_echo_slice_activities($args) {
		...
		foreach($args['slice']->acts_arr[$current_user->id] as $act) {
			...
			if($act->sugar_bean->object_name == 'Call') {
				...
				echo '<td>' . SugarThemeRegistry::current()->getImage('Calls','', null,null,'.gif',$app_list_strings['call_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name) . '</td>
				...
				$out = '<td>' . SugarThemeRegistry::current()->getImage('Meetings','', null,null,'.gif',$app_list_strings['meeting_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name) . '</td>
				...
				echo '<td>' .  SugarThemeRegistry::current()->getImage('Tasks','', null,null,'.gif',$app_list_strings['task_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name) . '</td>
	...
	function template_echo_slice_activities_shared($args) {
		...
		foreach($args['slice']->acts_arr[$shared_user->id] as $act) {
			...
			if($act->sugar_bean->object_name == 'Call') {
				echo "<tr><td>" . SugarThemeRegistry::current()->getImage('Calls','', null,null,'.gif',$app_list_strings['call_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name) . "</td>";
				...
				echo "<td>".
					SugarThemeRegistry::current()->getImage('Meetings','', null,null,'.gif',$app_list_strings['meeting_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name);
				echo "</td>";
				...
				echo "<td>".
					SugarThemeRegistry::current()->getImage('Tasks','',null,null,'.gif',$app_list_strings['task_status_dom'][$act->sugar_bean->status].': '.$act->sugar_bean->name);
				echo "</td>";
...
function template_get_next_calendar($args) {
	...
	global $mod_strings;
?>
<a href="index.php?action=index&module=Calendar&view=<?php echo $args['calendar']->view; ?><?php echo $args['calendar']->get_next_date_str(); ?>"><?php echo $mod_strings["LBL_NEXT_".$args['calendar']->get_view_name($args['calendar']->view)]; ?>&nbsp;<?php echo SugarThemeRegistry::current()->getImage('calendar_next','align="absmiddle" border="0"', null,null,'.gif',$mod_strings["LBL_NEXT_".$args['calendar']->get_view_name($args['calendar']->view)]); ?></a>
<?php
...
?>
<a href="index.php?action=index&module=Calendar&view=<?php echo $args['calendar']->view; ?><?php echo $args['calendar']->get_previous_date_str(); ?>"><?php echo SugarThemeRegistry::current()->getImage('calendar_previous','align="absmiddle" border="0"', null,null,'.gif',$mod_strings["LBL_PREVIOUS_".$args['calendar']->get_view_name($args['calendar']->view)]); ?>&nbsp;&nbsp;<?php echo $mod_strings["LBL_PREVIOUS_".$args['calendar']->get_view_name($args['calendar']->view)]; ?></a>
<?php
