...
//END SUGARCRM flav=pro ONLY
	...
	function get_list_view_data(){
		...
		if ($this->status == "Planned") {
			...
			$call_fields['SET_COMPLETE'] = $setCompleteUrl . SugarThemeRegistry::current()->getImage/*ALTFIXED*/("close_inline","title='".translate('LBL_LIST_CLOSE','Calls')."' border='0'", null,null,'.gif', translate('LBL_LIST_CLOSE','Calls')) . "</a>";
		}
		global $timedate;
