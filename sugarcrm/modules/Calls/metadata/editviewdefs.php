...
function formSubmitCheck(){ldelim}if(check_form(\'EditView\') && isValidDuration() && CAL.checkRecurrenceForm()){ldelim}SUGAR.ajaxUI.submitForm("EditView");{rdelim}{rdelim}</script>',
       'useTabs' => false,
    ),
    'panels' =>
    array (
