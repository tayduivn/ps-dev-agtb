...
function formSubmitCheck(){ldelim}if(check_form(\'EditView\') && isValidDuration()){ldelim}this.form.submit();{rdelim}{rdelim}</script>',
       'useTabs' => false,
    ),
    'panels' => 
    array (
