            ...
            foreach($pl_lists as $pl_id){
             ...
             if( $colorclass== "class='evenListRowS1'"){
              ...
              if(isset($pl_focus->id) && !empty($pl_focus->id)){
                ...
                $pl_tbl  .= SugarThemeRegistry::current()->getImage/*ALTFIXED*/('edit_inline', 'border=0', null, null, ".gif", $mod_strings['LBL_EDIT_INLINE']) . "</a>&nbsp;";
                ...
                $pl_tbl  .= SugarThemeRegistry::current()->getImage/*ALTFIXED*/('view_inline', 'border=0', null, null, ".gif", $mod_strings['LBL_VIEW_INLINE'])."</a></td>";                  
