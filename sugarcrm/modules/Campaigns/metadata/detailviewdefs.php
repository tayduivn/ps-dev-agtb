...
'templateMeta' => array('form' => array(
                                        ...
                                        'buttons' =>
                                            ...
                                            array('customCode'=>'<input title="{$MOD.LBL_TEST_BUTTON_TITLE}"  class="button" onclick="var _form = document.getElementById(\'formDetailView\'); _form.return_module.value=\'Campaigns\'; _form.return_action.value=\'TrackDetailView\';_form.action.value=\'Schedule\';_form.mode.value=\'test\';SUGAR.ajaxUI.submitForm(_form);" type="{$ADD_BUTTON_STATE}" name="button" id="send_test_button" value="{$MOD.LBL_TEST_BUTTON_LABEL}">'),
                                            array('customCode'=>'<input title="{$MOD.LBL_QUEUE_BUTTON_TITLE}" class="button" onclick="var _form = document.getElementById(\'formDetailView\');_form.return_module.value=\'Campaigns\'; _form.return_action.value=\'TrackDetailView\';_form.action.value=\'Schedule\';SUGAR.ajaxUI.submitForm(_form);" type="{$ADD_BUTTON_STATE}" name="button" id="send_emails_button" value="{$MOD.LBL_QUEUE_BUTTON_LABEL}">'),
                                            array('customCode'=>'<input title="{$APP.LBL_MAILMERGE}" class="button" onclick="var _form = document.getElementById(\'formDetailView\');_form.return_module.value=\'Campaigns\'; _form.return_action.value=\'TrackDetailView\';_form.action.value=\'MailMerge\';SUGAR.ajaxUI.submitForm(_form);" type="submit" name="button" id="mail_merge_button" value="{$APP.LBL_MAILMERGE}">'),
                                            array('customCode'=>'<input title="{$MOD.LBL_MARK_AS_SENT}" class="button" onclick="var _form = document.getElementById(\'formDetailView\');_form.return_module.value=\'Campaigns\'; _form.return_action.value=\'TrackDetailView\';_form.action.value=\'DetailView\';_form.mode.value=\'set_target\';SUGAR.ajaxUI.submitForm(_form);" type="{$TARGET_BUTTON_STATE}" name="button" id="mark_as_sent_button" value="{$MOD.LBL_MARK_AS_SENT}">'),
