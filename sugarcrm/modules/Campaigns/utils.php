 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: utils.php 55435 2010-03-17 14:20:37Z roger $
...
/*
			...
			//BEGIN SUGARCRM flav=ent ONLY
				...
				$insert_query.= " 		INNER JOIN prospect_list_campaigns niplc ON niplc.id = niplp.prospect_list_id and niplc.campaign_id='{$focus->id}' ";		
