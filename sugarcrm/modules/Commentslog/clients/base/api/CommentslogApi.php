...
/**
 * Extends ModuleApi for Commentslog specific work
 *
 * Class CommentslogApi
 */
class CommentslogApi extends ModuleApi
{
    ...
    public function registerApiRest()
    {
        return array(
            ...
            'retrieve' => array(
                ...
                'shortHelp' => 'Returns a single parent record of the given commentslog',
    ...
    /**
     * Retrieves the parent record of this commentslog instead
     * @throws SugarApiExceptionInvalidParameter When id for the given commentslog is not found
     * @throws SugarApiExceptionRequestMethodFailure Somehow the relationship won't load
     * @throws SugarApiExceptionInvalidParameter Can't find any parent record related to this commentslog
     */
    public function retrieveRecord(ServiceBase $api, array $args)
    {
        $this->requireArgs($args, array('module','record'));

        $bean = BeanFactory::retrieveBean('Commentslog', $args['record']);
        if ($bean === null) {
            // can't find the Commentslog
