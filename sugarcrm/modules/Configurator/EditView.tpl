...
<td>
	...
	<tr>
		<td  scope="row">{$MOD.LBL_WIRELESS_LIST_ENTRIES}: </td>
		<td  >
			<input type='text' size='4' name='wl_list_max_entries_per_page' value='{$config.wl_list_max_entries_per_page}'>
		</td>
		<td  scope="row">{$MOD.LBL_WIRELESS_SUBPANEL_LIST_ENTRIES}: </td>
		<td  >
			<input type='text' size='4' name='wl_list_max_entries_per_subpanel' value='{$config.wl_list_max_entries_per_subpanel}'>
		</td>
	</tr>
	<tr>
...
<tr><td>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><th align="left" scope="row" colspan="4"><h4>{$MOD.LBL_OC_STATUS}</h4></th>
	</tr><tr>
