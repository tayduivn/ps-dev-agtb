...
//BEGIN SUGARCRM flav=dce ONLY
    ...
    'DCE_PRIMARY_IT_EMAIL'=>'Primary IT Email',
    'DCE_SUPPORT_USER_TIME_LIMIT'=>'Support User Time Limit (in hours)',
    'DCE_UNIQUE_KEY'=>'Application ID',
    'DCE_LICENSING_USER'=>'Sugar Licensing User',
    'DCE_LICENSING_PASSWORD'=>'Sugar Licensing Password',
    'DEFAULT_DCE_SETTINGS'=>'DCE',
    'LBL_DCEMODULE_NAME'=>'DCE Settings',
    'DCE_MESSAGING' => 'DCE Messaging',
    'DCE_PRIMARY_IT_EMAIL'=>'Primary IT Email',
    'CREATE_EVAL_SUCCESS_MSG'=>'Create Eval Instance',
    'CREATE_INSTANCE_SUCCESS_MSG'=> 'Create Instance',
    'ARCHIVE_INSTANCE_MSG'=> 'Archive Instance' ,
    'SUPPORT_USER_MSG'=> 'Create Support User',
    'UPGRADE_LIVE_MSG'=> 'Upgrade',
    'UPGRADE_TEST_MSG'=> 'Test Upgrade',
    'ERROR_MESSAGE_MSG'=> 'DCE Client Errors',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
	...
	'LBL_USE_SPRITES' => 'Enable CSS Sprites',
	'LBL_USE_SPRITES_HELP' => 'By enabeling CSS Sprites UI performance may be improved. It is suggested to run "Repair->Rebuild CSS Sprites" first before activating this feature',
);
