...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LBL_COLLAPSE_SUBPANELS_DESC' => 'When this option is selected, all subpanels will load in a collapsed view to improve performance. Users wishing to view subpanel data will need to open subpanels each time a record is opened.',
    ...
    'COLLAPSE_SUBPANELS' => 'Collapse all subpanels and disable stickiness',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Copy</b> - Creates and relates copies of all of the Lead's activities to new records that are selected by the user during conversion. Copies are created for each of the selected records.<br><br><b>Move</b> - Creates and relates copies of all of the Lead's activities to new records that are selected by the user during conversion. Copies are created for each of the selected records. The activities are then removed from the Lead.<br><br><b>Do Nothing</b> - Does nothing with the Lead's activities during conversion. The activities remain related to the Lead only.",
