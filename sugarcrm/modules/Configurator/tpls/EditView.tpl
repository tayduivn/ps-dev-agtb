...
<tr>
	...
	<td>
		...
		&nbsp;<input title="{$MOD.LBL_SAVE_BUTTON_TITLE}"  class="button" id="ConfigureSettings_restore_button" type="submit" name="restore" value="  {$MOD.LBL_RESTORE_BUTTON_LABEL}  " >
		&nbsp;<input title="{$MOD.LBL_CANCEL_BUTTON_TITLE}"  onclick="document.location.href='index.php?module=Administration&action=index'" class="button" id="ConfigureSettings_cancel_button" type="button" name="cancel" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  " > </td>
	</tr>
</table>
