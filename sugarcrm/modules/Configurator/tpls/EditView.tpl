...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            <td width="25%" scope="row" valign='middle'>{$MOD.LBL_PREVIEW_EDIT_ON}&nbsp{sugar_help text=$MOD.LBL_PREVIEW_EDIT_HELP WIDTH=400}</td>
            {if !empty($settings.system_previewedit_on)}
                {assign var='system_previewedit_on_checked' value='CHECKED'}
            {else}
                {assign var='system_previewedit_on_checked' value=''}
            {/if}
            <td width="75%" align="left"  valign='middle'><input type='hidden' name='system_previewedit_on' value='0'><input name="system_previewedit_on" value="1" class="checkbox" tabindex='1' type="checkbox" {$system_previewedit_on_checked}></td>
        </tr>
    </table>
