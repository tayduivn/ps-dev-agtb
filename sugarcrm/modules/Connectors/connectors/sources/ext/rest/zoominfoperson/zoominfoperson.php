...
class ext_rest_zoominfoperson extends ext_rest {
	...
	var $process_record;
 	...
 	public function __construct(){
		...
		//BEGIN ENCODE 		
        $this->clientKey = !empty($properties['api_key']) ? $properties['api_key'] : base64_decode( get_zoominfoperson_api_key());	 	
        $this->partnerCode = !empty($properties['partner_code']) ? $properties['partner_code'] : base64_decode( get_zoominfoperson_partner_code());
 		//END ENCODE         			
 	}
