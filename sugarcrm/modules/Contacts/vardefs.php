...
//BEGIN SUGARCRM flav=dce ONLY
    'dceinstance_role_fields' =>
        array (
            ...
            'rname' => 'id',
            'relationship_fields'=>array('id' => 'dceinstance_role_id', 'contact_role' => 'dceinstance_role'),
            'vname' => 'LBL_ACCOUNT_NAME',
            'type' => 'relate',
            'link' => 'dceinstances',
            'link_type' => 'relationship_info',
            'join_link_name' => 'dceinstances_contacts',
            'source' => 'non-db',
            'importable' => 'false',
            'duplicate_merge'=> 'disabled',
            'studio' => false,
    ...
    'dceinstance_role' =>
        array(
            ...
            'options' => 'dceinstance_contact_relationship_type_dom',
            'importable' => 'false',
        ),
    'dceinstances' =>
        array (
