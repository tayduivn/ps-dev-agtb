	...
	function populateFromPost() {
		...
		if (!empty($this->enable_range_search))
		{
			...
			if(isset($_REQUEST['view_module']))
			{
			    ...
			    if(file_exists($GLOBALS['sugar_config']['cache_dir'] . 'modules/' . $module . '/SearchForm_basic.tpl')) 
                {
                   unlink($GLOBALS['sugar_config']['cache_dir'] . 'modules/' . $module . '/SearchForm_basic.tpl');
                }                
                
                if(file_exists($GLOBALS['sugar_config']['cache_dir'] . 'modules/' . $module . '/SearchForm_advanced.tpl')) 
                {
                   unlink($GLOBALS['sugar_config']['cache_dir'] . 'modules/' . $module . '/SearchForm_advanced.tpl');
                }
			}
		} else {
