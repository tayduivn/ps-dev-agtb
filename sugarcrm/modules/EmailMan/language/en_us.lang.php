...
$mod_strings = array (
    ...
    'LBL_EMAIL_OPT_OUT_DEFAULT_TOOLTIP' => 'When a new email address is added to a record with an email address, it will automatically be opted out of future campaigns. Changing this setting will not affect existing email addresses for those records.',
