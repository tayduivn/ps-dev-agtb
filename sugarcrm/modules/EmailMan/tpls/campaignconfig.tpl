			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<div id="rollover">
                        ...
                        <a href="#" class="rollover"><span>{$MOD.LBL_CAMP_MESSAGE_COPY_DESC}</span><<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_HELP}" src="index.php?entryPoint=getImage&themeName={$THEME}&imageName=helpInline.gif"></a>
                    </div>
					</td>
					<td >
