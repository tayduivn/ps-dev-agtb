...
$xtpl->assign("assign_user_select", SugarThemeRegistry::current()->getImage/*ALTFIXED*/('id-ff-select','',null,null,'.png',$mod_strings['LBL_SELECT']));
$xtpl->assign("assign_user_clear", SugarThemeRegistry::current()->getImage/*ALTFIXED*/('id-ff-clear','',null,null,'.gif',$mod_strings['LBL_ID_FF_CLEAR']));
//Assign qsd script
