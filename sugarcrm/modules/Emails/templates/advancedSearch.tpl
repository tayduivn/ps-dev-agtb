...
<table cellpadding="4" cellspacing="0" border="0" id='advancedSearchTable'>
    ...
    <tr class="toggleClass yui-hidden">
        ...
        <a href="javascript:void(0);"><<!-ALTFIX!-->img src="{sugar_getimagepath file='select.gif'}" align="absmiddle" border="0" alt="{$mod_strings.LBL_EMAIL_SELECTOR}" onclick="SUGAR.email2.composeLayout.callopenpopupForEmail2('_search',{ldelim}'form_name':'advancedSearchForm'{rdelim} );">
         </a>
        </td>
    </tr>
     <tr class="toggleClass yui-hidden">
