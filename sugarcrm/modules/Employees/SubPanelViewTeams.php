 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: SubPanelViewTeams.php 51719 2009-10-22 17:18:00Z mitani $
...
class SubPanelViewTeams {
	...
	function ProcessSubPanelListView($xTemplatePath, &$mod_strings, $action, $curModule = "") {
		...
		$ListView->xTemplateAssign("EDIT_INLINE_PNG",  SugarThemeRegistry::current()->getImage/*ALTFIXED*/('edit_inline.png','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_EDIT']));
		$ListView->xTemplateAssign("DELETE_INLINE_PNG",  SugarThemeRegistry::current()->getImage/*ALTFIXED*/('delete_inline.png','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_REMOVE']));
