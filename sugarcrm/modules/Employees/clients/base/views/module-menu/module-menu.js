 ...
 *
 * @class View.Views.Base.Employees.ModuleMenuView
 * @alias SUGAR.App.view.views.BaseEmployeesModuleMenuView
...
({
    ...
    handleRouteEvent: function(event) {
        if (App.config.idmModeEnabled && (event.target.getAttribute('data-navbar-menu-item') == 'LNK_NEW_EMPLOYEE')) {
            App.alert.show('idm_create_employee', {
                level: 'info',
                messages: App.lang
                    .get('ERR_CREATE_EMPLOYEE_FOR_IDM_MODE', 'Employees')
