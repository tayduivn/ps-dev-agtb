...
<form action="index.php" method="POST" name="EditView" id="EditView">
					...
					<tr>
						<td nowrap align='right' >
							...
							<button type='button' class='button' title='Previous' disabled>
								<<!--ALTFIXED-->img src="themes/default/images/previous_off.gif" width="8" height="11" alt="{$mod_strings.LBL_PREVIOUS}" border='0' align='absmiddle' />
							</button>&nbsp;&nbsp;(1)&nbsp;&nbsp;
							<button type='button' class='button' title='Next' disabled>
								<<!--ALTFIXED-->img src="themes/default/images/next_off.gif" width="8" height="11" alt="{$mod_strings.LBL_NEXT}" border='0' align='absmiddle' />
							</button>&nbsp;&nbsp;
						</td>
					</tr>
				</table>
 ...
 Member of:
													...
													<td valign="top" width='37.5%' class='tabEditViewDF' NOWRAP>
														<input type="text" name="parent_name" class="sqsEnabled" tabindex="p" id="parent_name" size="" value="" title='' autocomplete="off"><input type="hidden" name="parent_id" id="parent_id" value=""><input type="button" name="btn_parent_name" tabindex="p" title="Select [Alt+T]" accessKey="T" class="button" value="Select" onclick='open_popup("Accounts", 600, 400, "", true, false, {"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"parent_id","name":"parent_name"}}, "single", true);'><input type="button" name="btn_clr_parent_name" tabindex="p" title="Clear [Alt+C]" accessKey="C" class="button" onclick="this.form.parent_name.value = ''; this.form.parent_id.value = '';" value="Clear">
														<td valign="top" width='12.5%' scope="row" NOWRAP>
 Employees:
														</td>
														<td valign="top" width='37.5%' class='tabEditViewDF' NOWRAP>
																																						...
																																						<td scope="row" valign="top" NOWRAP>
																																							<div>
																																								<a href="javascript:addEmailAddress('','');">
																																									<<!--ALTFIXED-->img src="themes/default/images/plus_inline.gif" border="0" alt="{$mod_strings.LBL_EXPAND}" height="10" width="10" class="img">
																																								</a>&nbsp;
																																								<a href="javascript:addEmailAddress('','');">
																																									Add Address
																																								</a>
