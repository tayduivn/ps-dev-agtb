...
({
    ...
    initialize: function(options) {
        ...
        this.show_likely = app.util.getConfigValue('show_worksheet_likely');
        this.show_best = app.util.getConfigValue('show_worksheet_best');
        this.show_worst = app.util.getConfigValue('show_worksheet_worst');
