...
class Individual implements IChartAndWorksheet {
     ...
     */
    protected $def = array (
        'opportunities' => array('Opportunities', 'ForecastSeedReport1',
            '{
                "display_columns":[
                    {
                        "name":"id",
                     ...
                     {
                        "name":"date_closed","label":"Expected Close Date","table_key":"self"
                     },
                     {"name":"probability","label":"Probability (%)","table_key":"self"},
                     {"name":"commit_stage","label":"Commit Stage","table_key":"self"},
                     {"name":"sales_stage","label":"Sales Stage","table_key":"self"},
                     {"name":"date_closed_timstamp","label":"Expected Close Date Timestamp","table_key":"self"},
                     {"name":"name","label":"Opportunity Name","table_key":"self"},
                     {"name":"best_case","label":"Best case","table_key":"self"},
                     {"name":"worst_case","label":"Worst case","table_key":"self"},
                     {"name":"forecast","label":"Include in Forecast","table_key":"self"},
                     {"name":"id","label":"ID","table_key":"Opportunities:assigned_user_link"}
                 ],
                 ...
                 "group_defs":[
                    {
                        ...
                        "column_function":"month","qualifier":"month","table_key":"self","type":"date"},
                    {"name":"id","label":"ID","table_key":"Opportunities:assigned_user_link","type":"user_name"}
                 ],
                 "summary_columns":[
                    {
                        "name":"date_closed",
