...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configure how you would like to categorize {{forecastByModule}}. You may select two or more categories based on probability ranges or create categories which are not based on probability. <br><br>There are check-boxes to the left of your custom categories; use these to decide which ranges will be included within the Forecast amount committed and reported to managers. <br><br>A user may change the include/exclude status and category of {{forecastByModule}} manually from their worksheet.',
