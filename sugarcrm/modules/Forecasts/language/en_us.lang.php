...
$mod_strings = array (
    ...
    'LBL_COMMITTED_HISTORY_ALL_CHANGED' => 'Updated forecast likely {3} {4} to {5}, best {0} {1} to {2} and worst {6} {7} to {8}',
    'LBL_COMMITTED_HISTORY_LIKELY_BEST_CHANGED' => 'Updated forecast likely {3} {4} to {5}, best {0} {1} to {2} and worst stayed the same',
    'LBL_COMMITTED_HISTORY_LIKELY_WORST_CHANGED' => 'Updated forecast likely {3} {4} to {5}, best stayed the same and worst {0} {1} to {2}',
    ...
    'LBL_COMMITTED_HISTORY_NONE_CHANGED' => 'Updated forecast worst, likely and best all stayed the same',
