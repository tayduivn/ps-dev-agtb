...
$mod_strings = array (
    ...
    'LBL_COMMITTED_HISTORY_SETUP_FORECAST' => 'Set up forecast',
    ...
    'LBL_FORECASTS_CONFIG_SHOW_CUSTOM_BUCKETS_RANGES_DESCRIPTION' => 'Custom ranges: this option gives a user the ability to categorize their {{forecastByModule}} to be committed into the forecast into a committed range, excluded range and any others that you set up.',
    ...
    'LBL_DASHLET_MY_TEAMS_PIPELINE' => "Team Pipeline",
    ...
    'LBL_DASHLET_MY_TEAMS_FORECAST' => "Team Forecast",
