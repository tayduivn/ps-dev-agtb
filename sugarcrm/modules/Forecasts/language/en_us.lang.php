...
$mod_strings = array (
    ...
    'LBL_HELP_RECORDS' => 'The {{plural_module_name}} module incorporates {{opportunities_singular_module}} records to build {{module_name}}ing Worksheets and predict sales. Users can work towards sales quotas at the individual, team, and sales organization level. Before users can access the {{plural_module_name}} module to begin building {{module_name}}ing Worksheets, a user with administrator access must configure the {{plural_module_name}} module with the organization\'s desired Time Periods, Ranges, and Scenarios.
