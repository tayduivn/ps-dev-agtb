...
<script language="javsacript" src="../sidecar/lib/jstree/jquery.jstree.js">
...
<script src='../sidecar/src/view/views/tree-view.js'></script>
...
<script src="modules/Forecasts/tpls/main.js"></script>
{literal}
<style>
	.subhead table {
		margin-top: 0;
