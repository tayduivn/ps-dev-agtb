...
$dictionary['WorksheetAudit'] =  array('table' => 'worksheet', 'fields' => array (
  'id' =>
  array (
    'name' => 'id',
    'vname' => 'LBL_WK_ID',
...
$dictionary['WorksheetAudit'] =  array('table' => 'worksheet_audit', 'fields' => array (
  'id' =>
  array (
    'name' => 'id',
    'vname' => 'LBL_ID',
  ...
  array (
    ...
    'vname' => 'LBL_WK_ID',
    'type' => 'id',
    'comment' => 'Unique identifier for worksheet table id',
  ),
  'user_id' =>
  array (
    'name' => 'user_id',
 ...
 'indices' => array (
       array('name' =>'worksheet_audit_pk', 'type' =>'primary', 'fields'=>array('id')),
       array('name' => 'idx_worksheet_audit_wk_id', 'type' => 'index', 'fields' => array('worksheet_id')),
 )
