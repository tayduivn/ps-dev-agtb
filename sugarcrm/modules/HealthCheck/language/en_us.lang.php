...
//    'LBL_SCAN_417_LOG' => 'Incompatible module %s',
    ...
    'LBL_SCAN_403_TITLE' => 'Logic hook after_ui_frame detected',
    'LBL_SCAN_404_TITLE' => 'Logic hook after_ui_footer detected',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_408_TITLE' => 'Extension dir %s detected',
    'LBL_SCAN_409_TITLE' => 'Found customCode %s in %s',
    'LBL_SCAN_410_TITLE' => 'Max fields - Found more than %s fields (%s) in %s',
    'LBL_SCAN_411_TITLE' => 'Found \'get_subpanel_data\' with \'function:\' value in %s',
    ...
    'LBL_SCAN_416_TITLE' => 'By-ref parameter in hook file %s function %s',
//    'LBL_SCAN_417_TITLE' => 'Incompatible module %s',
    ...
    'LBL_SCAN_422_TITLE' => 'Vardef HTML function in %s',
    ...
    'LBL_SCAN_431_TITLE' => 'Vardef HTML function %s in $module module for field %s',
    ...
    'LBL_SCAN_403_DESCR' => 'This logic hook is not supported anymore in Sugar 7',
    'LBL_SCAN_404_DESCR' => 'This logic hook is not supported anymore in Sugar 7',
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_408_DESCR' => 'Stock Sugar module has one of the extensions which we do not support for upgrade, such as customized routing, access control, Javascript, etc.',
    'LBL_SCAN_409_DESCR' => 'The vardefs include user customCode definitions that we do not know how to convert',
    'LBL_SCAN_410_DESCR' => 'Too many fields in the view',
    'LBL_SCAN_411_DESCR' => 'Subpanel data is fetched by a function, we do not support upgrading this yet.',
    ...
    'LBL_SCAN_416_DESCR' => 'Old logic hook file uses by-reference parameter passing, which may lead to error messages being displayed (and thus mess up REST)',
//    'LBL_SCAN_417_DESCR' => 'Module Feeds or iFrames detected, which should not exist anymore',
    ...
    'LBL_SCAN_422_DESCR' => 'Vardef defines enum that is a result of HTML function, which is not supported for Sugar7',
    ...
    'LBL_SCAN_431_DESCR' => 'Field is defined as function producing HTML and can not be auto-converted (we know how to convert some stock fields like emails and currency)',
    ...
    'LBL_SCAN_518_DESCR' => 'Module Feeds or iFrames detected, which should not exist anymore',
