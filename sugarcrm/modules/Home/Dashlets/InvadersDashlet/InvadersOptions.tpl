...
// $Id: JotPadDashletOptions.tpl 16320 2006-08-23 00:15:55Z awu $
...
<tr>
    <td align="right" colspan="2">
        ...
        <input type='submit' class='button' value='{$clearLbl}' onclick='SUGAR.searchForm.clear_form(this.form,["title"]);return false;'>
   	</td>
</tr>
</table>
</form>
