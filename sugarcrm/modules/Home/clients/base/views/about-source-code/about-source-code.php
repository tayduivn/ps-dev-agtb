...
$viewdefs['Home']['base']['view']['about-source-code'] = array(
    'external_libs' => array(
        array(
            'name' => 'XTemplate',
        ...
        array(
            ...
            'description' => 'A free CAPTCHA service that helps to digitize books, newspapers and old time radio '
            . 'shows.',
        ),
        array(
            'name' => 'CssMin',
        ...
        array(
            ...
            'description' => 'The overflow:scroll for mobile webkit.  Native scrolling inside a fixed width/height '
            . 'element.',
        ),
        array(
            'name' => 'JavaScript InfoVis Toolkit',
            'url' => 'http://thejit.org/',
            'description' => 'The JavaScript InfoVis Toolkit provides tools for creating Interactive Data '
            . 'Visualizations for the Web.',
        ),
        array(
            'name' => 'FlashCanvas',
            'url' => 'http://flashcanvas.net/',
            'description' => 'FlashCanvas is a JavaScript library which adds the HTML5 Canvas support to Internet '
            . 'Explorer. It renders shapes and images via Flash drawing API. It supports almost all Canvas APIs '
        ...
        array(
            'name' => 'jQuery',
            'url' => 'http://jquery.com/',
            'description' => 'jQuery is a fast and concise JavaScript Library that simplifies HTML document '
