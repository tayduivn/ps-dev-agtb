...
//END SUGARCRM flav=dce ONLY
  ...
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover Sugar',
    ...
    'LBL_TOUR_PDF_MANAGER_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 157px; margin-right: 20px;"><img src="themes/default/images/pt-pdf-manager.png" width="157" height="167"><div class="caption">PDF Manager link in Admininstration</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Administrators can now modify predefined Quote and Invoice Templates</li><li class="icon-ok">Administrators can now add new templates for standard or custom modules using a flexible HMTL editor</li><li class="icon-ok">These new capabilities enables companies to provide standardized documents where the company\'s branding is maintained</li></ul><p>Link to PDF Manager is located on the Profile menu as indicated by the bouncing arrow</p><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 444px; top: -111px;"></i></div></div><div class="clear"></div>',
    ...
    'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Create and modify PDF templates</li><li class="icon-ok">Create recurring Meetings and Calls from detail view</li><li class="icon-ok">Search for and add invitees by account when scheduling Meetings and Calls</li><li class="icon-ok">Administrators are notified when Global Search indexing completes</li><li class="icon-ok">Spell is check available in TinyMCE</li><li class="icon-ok">IE 8 is no longer supported</li></ul><p>and much more!</p>',
