...
//END SUGARCRM flav=dce ONLY
  ...
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover Sugar',
    ...
    'LBL_TOUR_PDF_MANAGER_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 157px; margin-right: 20px;"><img src="themes/default/images/pt-pdf-manager.png" width="157" height="167"><div class="caption">PDF Manager link in Admininstration</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Administrators can now modify predefined Quote and Invoice Templates</li><li class="icon-ok">Administrators can now add new templates for standard or custom modules using a flexible HMTL editor</li><li class="icon-ok">These new capabilities enables companies to provide standardized documents where the company\'s branding is maintained</li></ul><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 444px; top: -72px;"></i></div></div><div class="clear"></div>',
