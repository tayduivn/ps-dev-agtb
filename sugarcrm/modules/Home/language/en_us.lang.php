...
//END SUGARCRM flav=dce ONLY
  ...
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover Sugar',
    ...
    'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Create and modify PDF templates</li><li class="icon-ok">Create recurring Meetings and Calls from detail view</li><li class="icon-ok">Search for invitees by account when scheduling Meetings and Calls</li><li class="icon-ok">Administrators are notified when Global Search indexing completes</li><li class="icon-ok">Spell Check is check available in TinyMCE</li><li class="icon-ok">IE 8 is no longer supported</li></ul><p>and much more!</p>',
