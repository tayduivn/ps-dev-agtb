...
//END SUGARCRM flav=dce ONLY
  ...
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover Sugar',
    ...
    'LBL_TOUR_PDF_MANAGER_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 157px; margin-right: 20px;"><img src="themes/default/images/pt-pdf-manager.png" width="157" height="167"><div class="caption">PDF Manager link in Admininstration</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Users can modify predefined Quote and Invoice Templates</li><li class="icon-ok">Users can add new templates for standard or custom modules utilizing a flexible HTML editor</li><li class="icon-ok">Companies can provide standardization of documents and maintain the company\'s branding</li></ul><i class="icon-arrow-left icon-lg" style="float: right; position: relative; right: 400px; top: -46px;"></i></div></div><div class="clear"></div>',
    'LBL_TOUR_MEETINGS_CALLS' => 'Meetings and Calls',
    'LBL_TOUR_MEETINGS_CALLS_DESCRIPTION' => '<ul><li class="icon-ok">Users can create recurring meetings and calls from the detail view.</li><li class="icon-ok">Meeting creators can search for users by account when adding invitees</li></ul>',
    'LBL_TOUR_NOTIFICATIONS' => 'Notifications',
    'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 317px; margin-right: 20px;"><img src="themes/default/images/pt-notifications.png" width="317" height="212"><div class="caption">Notifications</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Administrator receives a notification when indexing completes</li></ul></div></div><div class="clear"></div>',
    'LBL_TOUR_SPELL_CHECK' => 'Spell Check',
    'LBL_TOUR_SPELL_CHECK_DESCRIPTION' => '<div style="float: left;"><div class="well" style="float: left; width: 112px; margin-right: 20px;"><img src="themes/default/images/pt-spell-check.png" width="112" height="212"><div class="caption">Spell check menu</div></div><div style="float: left; width: 400px;"><ul><li class="icon-ok">Spell check is available in email templates <br>(in Emails, Campaigns, and Workflow modules), compose email, and PDF Manager templates!</li></ul></div></div><div class="clear"></div>',
    ...
    'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Create and modify PDF templates</li><li class="icon-ok">Recurring meetings and calls creatable from detail views</li><li class="icon-ok">Meetings & calls can be search for users by account when adding invitees</li><li class="icon-ok">Administrators notified when Global Search indexing completes</li><li class="icon-ok">Spell check available in TinyMCE</li><li class="icon-ok">IE 8 no longer supported</li></ul><p>and much more!</p>',
