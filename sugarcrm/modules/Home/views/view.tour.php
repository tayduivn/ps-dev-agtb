...
class HomeViewTour extends SugarView
{
    public function display()
    {
       ...
       if($upgrade)
       {
            ...
            $urlForString = '<a href="index.php?module=Users&action=EditView&record='.$current_user->id.'&scrollToCal=true" target="_blank">';
            $this->ss->assign('view_calendar_url', string_format($mod_strings['LBL_TOUR_CALENDAR_URL'], array($urlForString)));
       }
