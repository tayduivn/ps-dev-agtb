...
$mod_strings = array (
    ...
    'LBL_UPDATE_BUTTON_HELP' => 'Use this option if you would like to update to existing records. The data in the import file will be matched to the existing record based on record ID.',
    ...
    'LBL_MY_SAVED' => 'To use previously saved import settings, select from below:',
    'LBL_PUBLISH' => 'Publish',
    'LBL_DELETE' => 'Delete',
    ...
    'LBL_DATABASE_FIELD' => 'Sugar Field',
    ...
    'LBL_INDEX_USED' => 'Check data in these fields:',
    'LBL_INDEX_NOT_USED' => 'Fields available to check:',
    ...
    'LBL_SHOW_ADVANCED_OPTIONS' => 'Show Advanced Properties',
    'LBL_HIDE_ADVANCED_OPTIONS' => 'Hide Advanced Properties',
    'LBL_SHOW_PREVIEW_COLUMNS' => 'Show Preview Columns',
    'LBL_HIDE_PREVIEW_COLUMNS' => 'Hide Preview Columns',
    'LBL_SAVE_MAPPING_AS' => 'To save these import settings, provide a name for the saved settings:',
    ...
    'LBL_MY_SAVED_HELP' => 'Use this option to apply previously saved import file settings, field mappings and fields for the duplicate check to this import.<br><br>Click <b>Delete</b> to delete a mapping for all users.',
    'LBL_MY_SAVED_ADMIN_HELP' => 'Use this option to apply previously saved import file settings, field mappings and fields for the duplicate check to this import.<br><br>Click <b>Publish</b> to make the mapping available to other users.<br>Click <b>Un-Publish</b> to make the mapping unavailable to other users.<br>Click <b>Delete</b> to delete a mapping for all users.',
    ...
    'LBL_VERIFY_DUPLCATES_HELP' => 'Select the fields to use to check for data matching the mapped data in the import file in order to avoid creating duplicate records. If matches are found, new records will not be created for the rows in the import file containing the matched data. These rows will be listed in the Import results page.',
    ...
    'LBL_THIRD_PARTY_CSV_SOURCES_HELP' => 'If your file was exported from any of the listed sources, select the source to automatically apply custom mappings in order to simplify the mapping process (next step).',
    'LBL_EXTERNAL_SOURCE_HELP' => 'Use this option to import data directly from an external application or service, such as Gmail.',
    'LBL_EXAMPLE_FILE' => 'Sample Import File',
