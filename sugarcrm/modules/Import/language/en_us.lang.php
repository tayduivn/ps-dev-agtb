...
$mod_strings = array (
    ...
    'LBL_ADD_FIELD_HELP' => 'Use this option to add a value to a field in all records created and/or updated. Select the field and then select a Default Value for that field.',
