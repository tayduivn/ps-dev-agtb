...
$module_menu[]= array("index.php?module=InboundEmail&action=EditView&mailbox_type=caldav", $mod_strings['LNK_LIST_CREATE_NEW_CALDAV'], "CreateCaldavboxes");
...
$module_menu[]= array("index.php?module=InboundEmail&action=Test", $mod_strings['LNK_LIST_TEST_IMPORT'],"MailboxesTestImport");
