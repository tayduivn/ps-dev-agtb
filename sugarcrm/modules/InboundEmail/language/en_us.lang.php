...
$mod_strings = array(
    ...
    'LBL_FROM_ADDR_DESC'    => 'The email address specified here may not appear in the from address section of the email sent due to restrictions on the mail service provider.  In these circumstances, the email address defined in the outgoing mail server will be used.',
