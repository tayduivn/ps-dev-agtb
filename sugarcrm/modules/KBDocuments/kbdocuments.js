		...
		var myButtons = [ //{ text:"Ok", handler:handleSubmit },
		 ...
		 tagsTreeModalMoveDocs = new YAHOO.widget.SimpleDialog('moveDlg',
			...
			fillInTags = function(data) {
						...
						var listeners = new YAHOO.util.KeyListener(document, { keys : 27 }, {fn: function() {this.hide();}, scope: tree, correctScope:true} );
	...
	modalInit:function(){
		...
		document.getElementById('dialog1').style.display='';
			...
			fillInTags = function(data) {
					...
					var listeners = new YAHOO.util.KeyListener(document, { keys : 27 }, {fn: function() {this.hide();}, scope: myDialog, correctScope:true} );
