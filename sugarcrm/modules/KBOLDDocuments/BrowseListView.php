...
require_once('modules/KBOLDDocuments/SearchUtils.php');
    ...
    $search_str .= " and kbolddocuments.id NOT IN
                                (select kbolddocument_id from kbolddocuments_kboldtags where deleted = 0)";      
        
    }else{
        //create query for articles under this tag
    $search_str .= " and kbolddocuments.id
                        IN (
                            SELECT kbd.id
   ...
   $_REQUEST['KBOLDDocuments2_KBOLDDOCUMENT_ORDER_BY'] = $sortCol;
