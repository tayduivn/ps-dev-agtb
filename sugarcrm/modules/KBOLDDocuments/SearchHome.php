...
$focus = BeanFactory::getBean('KBOLDDocuments');

echo getClassicModuleTitle("KBOLDDocuments", array($app_strings['LBL_SEARCH']), true);
...
////////////////////////////////// FTS Section ///////////////////////////////////////
    ...
    $search_str = ' kbolddocuments.deleted=0 ';
    ...
    $ss->assign('LIST', $results );
        ...
        if (isset($_POST['canned_search'])){
            $ss->assign("CANNED_SEARCH_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_canned_search'], $_POST['canned_search']));
        }else{
            $ss->assign("CANNED_SEARCH_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_canned_search'], ''));
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////
    //display results
    $ss->display("modules/KBOLDDocuments/SearchHome.html");
...
function perform_advanced_search($focus,$default=false){
                ...
                if(isset($_POST['kbolddocument_name']) and !empty($_POST['kbolddocument_name'])){$searchVars['kbolddocument_name'] = $_POST['kbolddocument_name'];}
                ...
                if(isset($_POST['is_external_article']) and !empty($_POST['is_external_article'])){
                    $q_arr['operator'] = '=';
                    $q_arr['filter'] = $_POST['is_external_article'];
                    $searchVars['is_external_article'] = $q_arr;
                }
    ...
    function return_browse_tab(){
        ...
        require_once('modules/KBOLDTags/TreeData.php');


        $tagstree=new Tree('kb_browse_tags');
        $tagstree->set_param('module','KBOLDTags');
       ...
       if(empty($tagstree->_nodes)){
        ...
        return $ss_brws->fetch("modules/KBOLDDocuments/tpls/browseTab.tpl");
}
    ...
    function return_advanced_tab($focus,$json, $json_config){
        ...
        $ss_adv->assign("DOCUMENT_NAME",$focus->kbolddocument_name);
        ...
        if (isset($_POST['status_id'])){
            $status_option .=get_select_options_with_id($app_list_strings['kbolddocument_status_dom'], $_POST['status_id']);
            $ss_adv->assign("STATUS_OPTIONS", $status_option );
        }else{
            $status_option .=get_select_options_with_id($app_list_strings['kbolddocument_status_dom'], '');
            $ss_adv->assign("STATUS_OPTIONS", $status_option );
        }
    ...
    echo $str;
        ...
        if (isset($_POST['canned_search'])){
            $ss_adv->assign("CANNED_SEARCH_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_canned_search'], $_POST['canned_search']));
        }else{
            $ss_adv->assign("CANNED_SEARCH_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_canned_search'], ''));
        }
        ...
        if (isset($_POST['active_date_filter'])){
            $ss_adv->assign("ACTIVE_DATE_FILTER_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_date_filter_options'], $_POST['active_date_filter']));
            ...
            $ss_adv->assign("ACTIVE_DATE_FILTER_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_date_filter_options'], ''));
        }

        //set the expiration date filter if it exists.  Also set the style properties
        //that will determine whether to show or hide the supporting text boxes
        if (isset($_POST['exp_date_filter'])){
            $ss_adv->assign("EXP_DATE_FILTER_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_date_filter_options'], $_POST['exp_date_filter']));
            ...
            $ss_adv->assign("EXP_DATE_FILTER_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_date_filter_options'], ''));
        }
        ...
        if (isset($_POST['attachments'])){
            $ss_adv->assign("ATTACHMENT_SELECT_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_attachment_option_dom'], $_POST['attachments']));
            ...
            $ss_adv->assign("ATTACHMENT_SELECT_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_attachment_option_dom'], ''));
        }
        ...
        $ss_adv->assign('JSON_CONFIG_JAVASCRIPT', $json_config->get_static_json_server());
            ...
            if (isset($_POST['frequency'])){
                $ss_adv->assign("FRQ_VIEW_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_viewing_frequency_dom'], $_POST['frequency']));
            }else{
                $ss_adv->assign("FRQ_VIEW_OPTIONS", get_select_options_with_id($app_list_strings['kbolddocument_viewing_frequency_dom'], ''));
            }
            ...
            $tag = BeanFactory::getBean('KBOLDTags');
            ...
            return $ss_adv->fetch("modules/KBOLDDocuments/tpls/advancedTab.tpl");
}
    ...
    function getSavedSearchOptions($focus,$saved_search_id='',$completeHTML=false){
         global $current_user, $mod_strings, $app_strings;
            ...
            $ss_query = "select name, id from saved_search where deleted = '0' and assigned_user_id ='$current_user->id' and search_module='KBOLDDocuments'";
    ...
    function saveSearch($s_id, $s_name, $update=false){
        ...
        $search_bean->search_module= 'KBOLDDocuments';
