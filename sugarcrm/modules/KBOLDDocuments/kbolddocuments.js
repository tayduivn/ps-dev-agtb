...
SUGAR.kb = function() {
    ...
    var FAQ_TAG_NOT_RENAME_MESSAGE = SUGAR.language.get('KBOLDDocuments', 'LBL_FAQ_TAG_NOT_RENAME_MESSAGE');
    var ROOT_TAG = SUGAR.language.get('KBOLDTags', 'LBL_TAGS_ROOT_LABEL');
    ...
    return{
        ...
        displayNodeMessage:function() {
            ...
            document.getElementById('CreateNodeMessage').innerHTML = SUGAR.language.get('KBOLDDocuments', 'LBL_SELECT_NODE');
        ...
        hideMove:function () {
            ...
            document.getElementById('CreateNodeMove').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_A_TAG_FROM_TREE') + '</b>';
        ...
        hideApply:function () {
            ...
            document.getElementById('CreateNodeApply').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_TAGS_FROM_TREE') + '</b>';
            ...
            /*
             ...
             //myDialog.setHeader(SUGAR.kb.getLocalizedLabels('KBOLDDocuments','LBL_APPLYING_TAGS_TO_ARTICLES'));
             }
             */
        },
        ...
        displayNewNodeBody:function() {
            ...
            if (root != null && root.children.length > 0) {
                ...
                myDialog.setHeader(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_CREATING_NEW_TAG'));
        ...
        deleteTags:function() {
            ...
            if (!selected) {
                alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_TAGS_TO_DELETE'));
                return false;
            }
            else {
                ...
                postData = 'selectedTagIds=' + YAHOO.lang.JSON.stringify(selectedTagIds) + '&module=KBOLDTags&action=DeleteSelectedTags&to_pdf=1';
        ...
        selectArticles:function(action) {
            ...
            if (!selected) {
                if (action == 'Move') {
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_ARTICLES_TO_BE_MOVED_TO_OTHER_TAG'));
                }
                if (action == 'Apply') {
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_ARTICLES_TO_APPLY_TAGS'));
                }
                if (action == 'Delete') {
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_ARTICLES_TO_DELETE'));
                }
                return false;
            }
            ...
            if (!selected) {
                ...
                var callback = {
                    success:function(r) {
                        ...
                        //treeDiv.innerHTML=r.responseText;
                        if (r.responseText == 1) {
                            alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_TAG_ALREADY_EXISTS'));
                        }
                        else {
                            SUGAR.util.evalScript(r.responseText);
                        }
                ...
                postData = 'selectedArticles=' + YAHOO.lang.JSON.stringify(selectedArticleIds) + '&module=KBOLDDocuments&action=DeleteSelectedArticles&to_pdf=1';
                YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
            }
        },
        ...
        modalMoveDocs:function() {
            ...
            ajaxStatus.showStatus(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_LAUNCHING_TAG_BROWSING'));
            ...
            fillInTags = function(data) {
                try {
                    ...
                    result = new Array();
                    result['body'] = SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_THERE_WAS_AN_ERROR_HANDLING_TAGS');
                }
            ...
            postData = 'tagsMode=' + YAHOO.lang.JSON.stringify(moveTags) + '&module=KBOLDTags&action=SelectCreateApplyAndMoveTags&to_pdf=1';
        ...
        applyTagsModal:function() {
            ...
            fillInTags = function(data) {
                ...
                applyTagsToDocs.setHeader(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_HEAD_TAGS'));
                var listeners = new YAHOO.util.KeyListener(document, { keys : 27 }, {fn: function() {
            ...
            postData = 'tagsMode=' + YAHOO.lang.JSON.stringify(applyTags) + '&module=KBOLDTags&action=SelectCreateApplyAndMoveTags&to_pdf=1';
            YAHOO.util.Connect.asyncRequest('POST', 'index.php', {success: fillInTags, failure: fillInTags}, postData);
        ...
        serachTagAjax:function() {
            ...
            if (searchTag != null && searchTag.length > 0) {
                ...
                postData = 'searchTagName=' + YAHOO.lang.JSON.stringify(searchTag) + '&module=KBOLDTags&action=SearchTags&to_pdf=1';
                YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
            } else {
        ...
        moveDocsAndModalClose:function() {
            ...
            if (tagId == document.getElementById('tag_selected_move_from_id').value) {
                alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SOURCE_AND_TARGET_TAGS_ARE_SAME'));
            }
            ...
            postData = 'tagAndArticleIds=' + YAHOO.lang.JSON.stringify(selectedArticleIds) + '&module=KBOLDTags&action=MoveArticlesToTagsModal&to_pdf=1';
            YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
            document.getElementById('Move').style.visibility = "hidden";
            document.getElementById('Cancel_Move').style.visibility = "hidden";
            document.getElementById('CreateNodeMove').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_A_TAG_FROM_TREE') + '</b>';
        ...
        applyTagsAndmodalClose:function() {
            ...
            postData = 'tagAndArticleIds=' + YAHOO.lang.JSON.stringify(selectedTagsArticlesIds) + '&module=KBOLDTags&action=ApplyTagsToArticlesModal&to_pdf=1';
            YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
            document.getElementById('Apply').style.visibility = "hidden";
            document.getElementById('Cancel_Apply').style.visibility = "hidden";
            document.getElementById('CreateNodeApply').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_TAGS_FROM_TREE') + '</b>';
        ...
        addNewNode:function(admin) {
            ...
            if (newTag != null && newTag.length > 0) {
                ...
                if (!nodeChildExists) {
                    ...
                    ajaxStatus.showStatus(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SAVING_THE_TAG'));
                ...
                alert(SUGAR.language.get('KBOLDDocuments', 'LBL_TYPE_NEW_NODE_NAME'));
            }
        },
        ...
        searchTagsAll:function() {
            ...
            if (searchThisTag != null && searchThisTag.length > 0) {
                ...
                postData = 'searchTagName=' + YAHOO.lang.JSON.stringify(tagName) + '&module=KBOLDTags&action=SelectCreateApplyAndMoveTags&to_pdf=1';
                YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
            }
            else {
                alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_TYPE_TAG_NAME_TO_SEARCH'));
            }
        },
...
//                    ],
            ...
            var postData = 'tagsMode=' + YAHOO.lang.JSON.stringify(selectCreateTags) + '&module=KBOLDTags&action=SelectCreateApplyAndMoveTags&to_pdf=1';
        ...
        modalClose:function(treeid) {
            ...
            if (isThisSearchScreen) {
                ...
                if (node.data.id == 'All_Tags') {
                    clickedNode = '';
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_ROOT_TAG_MESSAGE'));
                    return;
                }
        ...
        selectTagToMoveArticles:function() {
            ...
            document.getElementById('tag_selected_id').value = tagId;
            tagsTreeModalMoveDocs.setHeader(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_MOVING_ARTICLES_TO_TAG'));
            node.getLabelEl().style.backgroundColor = "CCFFFF";  //light blue gray(CCCCCC)
            clickedNodeMove = node;
        },
        ...
        selectTagToApplyArticles:function() {
             ...
             */
            if (checked) {
                document.getElementById('CreateNodeApply').innerHTML = SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_CLICK_APPLY_TAG');
        ...
        multiAttachments:function(list_target, elmentsName, site_url, theme_name, isAtt, upload_maxsize) {
            ...
            this.addElement = function(element) {
                ...
                if (element.tagName == 'INPUT' && element.type == 'file') {
                    ...
                    element.onchange = function() {
                        if (typeof element.files == 'object' && element.files.length > 0) {
                            if (element.multi_selector.upload_maxsize <= element.files[0].size) {
                                ...
                                var error_message = SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'ERR_FILESIZE') + ' ' + element.multi_selector.upload_maxsize;
                                alert(error_message);
                                return;
                            }
                        }
                        ...
                        var callback = {
                            upload:function(r) {
                                ...
                                if (rets['status'] == 'failed') {
                                    ...
                                    var error_message = SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_NOT_A_VALID_FILE');
                                    ...
                                    if (!isAtt && rets['is_file_image'] == 0) {
                                        thediv.parentNode.removeChild(thediv);
                                        alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_NOT_A_VALID_FILE'));
                                    }
                                    else {
                        ...
                        var url = 'index.php?module=KBOLDDocuments&action=KbdocAttachments&to_pdf=1&div_name_and_El=' + divAndEl;
                    ...
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_ERROR_NOT_A_FILE_INPUT_ELEMENT'));
                }
                ;
            };
        ...
        cancelAdminActions:function() {
            ...
            document.getElementById('tag_message').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_PARENT_TAG_MESSAGE') + '</b>';
            document.getElementById('tag_message_rename').innerHTML = '<b><font COLOR=red>' + SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_SELECT_TAG_TO_BE_RENAMED_FROM_TREE') + '</b>';
            document.getElementById('tag_new').style.visibility = "hidden";
        ...
        adminClick:function() {
            ...
            if (currAction.value == 'Rename Tag') {
                if (node.parent == "RootNode" || node.data.id == 'All_Tags') {
                    alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_ROOT_TAG_CAN_NOT_BE_RENAMED'));
        ...
        renameTag:function(admin) {
            ...
            if (newTag != null && newTag.length > 0) {
                ...
                if (!nodeChildExists) {
                    ...
                    postData = 'newTagName=' + YAHOO.lang.JSON.stringify(idName) + '&module=KBOLDTags&action=RenameTagsAdmin&to_pdf=1';
                    YAHOO.util.Connect.asyncRequest('POST', 'index.php', callback, postData);
                    if (admin) {
                        //hideMessageAndNodeAdmin();
                ...
                alert(SUGAR.kb.getLocalizedLabels('KBOLDDocuments', 'LBL_TYPE_THE_NEW_TAG_NAME'));
            }
        },
        ...
        sortBrowseList:function(params, name, query)
        {
            ...
            var postData = stringURL + '&sortCol='+name+ '&module=KBOLDDocuments&action=BrowseListView&to_pdf=1';
            if(query)
            {
