 ...
 */
*}
<script type="text/javascript" language="Javascript" src="{sugar_getjspath file='modules/KBOLDDocuments/kbolddocuments.js'}"></script>
			...
			<div>				
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
					...
					<tr>
						...
						<td width = "35%" ><span sugar='slot2b'><input name='kbolddocument_name'  type='text' size='50' value="{$kbolddocument_name}"></span sugar='slot'></td>		        
