...
*}
			...
			<input type="hidden" name="module" id="module" value="KBOLDDocuments">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view search kb">
					...
					<tr>
						...
						<td width = "35%" ><span sugar='slot2b'><input name='kbolddocument_name' tabindex='1' type='text' size='50' value="{$kbolddocument_name}"></span sugar='slot'></td>
