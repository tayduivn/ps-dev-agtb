...
function tagHasArticle($kboldTagId){
	$hasArticle = false;
	$search_str = "SELECT kbolddocument_id from kbolddocuments_kboldtags
                          WHERE kboldtag_id = '$kboldTagId' and deleted=0";                                                        
    ...
    if(!$hasArticle){     
      $hasArticle = check_tag_child_tags_for_articles($kboldTagId);
     }    
    return $hasArticle;     
}
