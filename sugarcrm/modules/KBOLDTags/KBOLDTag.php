...
class KBOLDTag extends SugarBean {
	...
	var $table_name = "kboldtags";
	var $object_name = "KBOLDTag";
...
//todo remove leads relationship.
	...
	public function __construct() {
		parent::__construct();
		$this->setupCustomFields('KBOLDTags'); //parameter is module name
    ...
    function default_install_data() {
        $query="INSERT INTO kboldtags (id,tag_name) values('FAQs','FAQs')";          
