...
class Popup_Picker
{
	...
	function _get_where_clause()
	{
		...
		{
			$where_clauses = array();
			append_where_clause($where_clauses, "name", "kboldtags.tag_name");
	...
	function process_page()
	{
		...
		$form = new XTemplate('modules/KBOLDTags/Popup_picker.html');
		...
		// create the listview
		$seed_bean = BeanFactory::getBean('KBOLDTags');
