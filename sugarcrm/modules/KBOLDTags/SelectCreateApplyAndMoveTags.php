...
require_once('modules/KBOLDTags/KBTree.php');
...
if ($tagsMode == 'Move Tags') {
    ...
    $tagstreeModal->set_param('module', 'KBOLDTags');
...
if ($tagsMode == 'Apply Tags') {
    ...
    $tagstreeApply->set_param('module', 'KBOLDTags');
...
if ($tagsMode == 'Search Tags') {
    ...
    if (!empty($search_tag_name)) {
        ...
        $query = "select id,tag_name from kboldtags where tag_name='$search_tag_name' and deleted = 0";
