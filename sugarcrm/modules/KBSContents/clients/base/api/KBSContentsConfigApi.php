...
class KBSContentsConfigApi extends ConfigModuleApi
{
    /**
     * {@inheritdoc}
     *
    ...
    public function registerApiRest()
    {
        ...
        $api['kbscontentsConfigCreate'] = array(
            'reqType' => 'POST',
            'path' => array('KBSContents', 'config'),
            'pathVars' => array('module', ''),
            'method' => 'configSave',
            'shortHelp' => 'Creates the config entries for the KBSContents module.',
            'longHelp' => 'modules/KBSContents/clients/base/api/help/kb_config_put_help.html',
        );
        $api['kbscontentsConfigUpdate'] = array(
            'reqType' => 'PUT',
            'path' => array('KBSContents', 'config'),
            'pathVars' => array('module', ''),
            'method' => 'configSave',
            'shortHelp' => 'Updates the config entries for the KBSContents module',
            'longHelp' => 'modules/KBSContents/clients/base/api/help/kb_config_put_help.html',
        );
    ...
    /**
     * {@inheritdoc}
     * Overridden method to save KBSContents module settings.
     *
    ...
    protected function updateDocuments($values, $lang)
    {
        ...
        $bean = BeanFactory::getBean('KBSContents');
