 ...
 * terms and conditions of the License, and You may
 * not use this file except in compliance with the License. Under the terms of
 * the license, You
 * shall not, among other things: 1) sublicense, resell, rent, lease,
 * redistribute, assign or
 * otherwise transfer Your rights to the Software, and 2) use the Software for
 * timesharing or
 * service bureau purposes such as hosting the Software for commercial gain
 * and/or for the benefit
 * of a third party. Use of the Software may be subject to applicable fees and
 * any use of the
 * Software without first paying applicable fees is strictly prohibited. You do
 * not have the
 ...
 * the License. Please refer
 * to the License for the specific language governing these rights and
 * limitations under the License.
 * Portions created by SugarCRM are Copyright (C) 2004 SugarCRM, Inc.; All
 * Rights Reserved.
 * ******************************************************************************
 */
