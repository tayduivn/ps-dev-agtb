...
{if isset($bean->leadaccount_opportunity_id) && !empty($bean->leadaccount_opportunity_name)}
{assign var=displayPreform value=true}
...
{assign var=preForm value=$preForm|cat:$bean->leadaccount_opportunity_id}
{assign var=preForm value=$preForm|cat:"'>"}
{assign var=preForm value=$preForm|cat:$bean->leadaccount_opportunity_name}
{assign var=preForm value=$preForm|cat:"</a>"}
{/if}
