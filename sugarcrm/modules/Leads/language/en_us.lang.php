...
$mod_strings = array (
    ...
    'LBL_CONVERT_MODULE_SELECTED' => '{{moduleName}} Selected',
    'LBL_CONVERT_MODULE_ASSOCIATED_NEW_SUCCESS' => 'You selected the {{moduleNameLower}} {{recordName}} but it will not be created until you finish and save.',
    'LBL_CONVERT_MODULE_ASSOCIATED_SUCCESS' => 'You selected the {{moduleNameLower}} {{recordName}} but it will not be linked until you finish and save.',
    'LBL_CONVERT_CREATE_MODULE' => 'Create {{moduleName}}',
    'LBL_CONVERT_CREATED_MODULE' => 'Creating {{moduleName}}',
    'LBL_CONVERT_MODULE_CREATED' => '{{moduleName}} Created',
