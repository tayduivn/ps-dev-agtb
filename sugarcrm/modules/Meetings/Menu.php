...
if(ACLController::checkAccess('Meetings', 'import', true))$module_menu[] =Array("javascript:void(SUGAR.importWizard.renderDialog('Meetings','step1',''));", $mod_strings['LNK_IMPORT_MEETINGS'],"Import", 'Contacts');
