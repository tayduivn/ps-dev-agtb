...
class StudioBrowser{
    ...
    function loadRelatableModules(){
        ...
        while($e = $d->read()){
        	...
        	if(($_REQUEST['view_module'] == 'Project') && ($e=='ProjectTask') && $_REQUEST['id']=='relEditor' && $_REQUEST['relationship_name'] == '') continue; //46141 - disabling creating custom relationship between Projects and ProjectTasks in studio
