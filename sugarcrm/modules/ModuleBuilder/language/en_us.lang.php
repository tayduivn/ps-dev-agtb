...
'help'=>array(
    ...
    //BEGIN SUGARCRM flav=pro ONLY
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><img src="index.php?entryPoint=getImage&imageName=icon_calculated.gif"> Indicates a Calculated field whose value will be automatically determined based on a formula.'
    //END SUGARCRM flav=pro ONLY
    ,
