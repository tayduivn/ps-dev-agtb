...
'LBL_PORTAL_ROLE_DESC' => 'Do not delete this Role. Customer Self-Service Portal Role is a system-generated Role created during the Sugar Portal activation process. Use Access controls within this Role to enable and/or disable modules in Sugar Portal. Do not modify any other access controls for this role to avoid unknown and unpredictable system behavior. In case of accidental deletion of this role, recreate it by disabling and enabling Sugar Portal.',
//END SUGARCRM flav=pro ONLY
