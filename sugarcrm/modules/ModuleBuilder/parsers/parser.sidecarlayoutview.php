...
class ParserSidecarLayoutView extends ParserModifyLayoutView
{
    ...
    // helper method to determine what file we are using
    protected function determineSourceFile()
    {
    ...
    {
        $GLOBALS['log']->debug("in ParserSidecarLayoutView");
        ...
        $this->_sourceFile = $this->determineSourceFile();
