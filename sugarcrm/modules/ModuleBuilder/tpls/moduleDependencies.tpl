...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="list view">
	...
	{foreach from=$dependencies item='dep' key='depName'}
		...
		<tr class="{$_rowColor}ListRowS1">
			...
			<td width="10px"><<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_EDIT}" src="themes/default/images/edit_inline.gif"/></td>
			<td width="10px"><<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_DELETE}" src="themes/Sugar/images/delete_inline.gif"/></td>
		</tr>
		<tr style="display:none" id="{$dep.name}actions">
    		...
    		<table cellspacing="0" class="action view list" border="0" cellpadding="0"/>
    			...
    			<td width="10px"><<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_EDIT}" src="themes/default/images/edit_inline.gif"/></td>
    			<td width="10px"><<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_DELETE}" src="themes/Sugar/images/delete_inline.gif"/></td></tr>
    			{/foreach}
    			<tr><td colspan="5"><div class="action new" style="text-align:center">New Action 
    			<<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_NEW}" src="themes/default/images/new_inline.gif" style="position: relative; top: 0.15em;"/></div></td></tr>
    		</table>
    	</td></tr>  
	{/foreach}
</table>
    ...
    store: depstore,
     columns: [
        ...
        {header: '', width: 20, sortable: false, dataIndex: '', renderer:function(){
			return '<<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_EDIT}" src="themes/default/images/edit_inline.gif"/>';
		}},
		{header: '', width: 20, sortable: false, dataIndex: '',renderer:function(){
			return '<<!--ALTFIXED-->img border="0" alt="{$mod_strings.LBL_EDIT}" src="themes/default/images/edit_inline.gif"/>';
		}}
