...
$mod_strings = array(
    ...
    'LBL_CONFIG_TITLE_MODULE_SETTINGS_GLOBAL' => 'Notification Center System Settings',
    'LBL_CONFIG_TITLE_MODULE_SETTINGS_USER' => 'Notification Center Settings',
    'LBL_CARRIER_DELIVERY_OPTION_TITLE_GLOBAL' => 'Notification Delivery Methods',
    'LBL_CARRIER_DELIVERY_OPTION_TITLE_USER' => 'Notification Delivery Methods',
    'LBL_CARRIER_DELIVERY_DESC_GLOBAL' => 'Enable how your users can receive notifications. ' .
        'The delivery methods selected will determine the subset of options available to users.',
    'LBL_CARRIER_DELIVERY_DESC_USER' => 'Select how you would like to receive notifications.',
    'LBL_CARRIER_DELIVERY_OPTION_HELP_GLOBAL' =>
    ...
    'LBL_CARRIER_DELIVERY_OPTION_HELP_USER' =>
        'Configure notification delivery methods.<br/><br/>Please note, the delivery methods selected will determine '.
    ...
    'LBL_APPLICATION_EMITTER_TITLE_GLOBAL' => 'SugarCRM Application Notifications',
    'LBL_APPLICATION_EMITTER_TITLE_USER' => 'SugarCRM Application Notifications',
    'LBL_APPLICATION_EMITTER_DESC_GLOBAL' => 'As an Administrator get application specific notifications.',
    'LBL_APPLICATION_EMITTER_DESC_USER' => 'As a User get application specific notifications.',
    'LBL_APPLICATION_EMITTER_HELP_GLOBAL' =>
    ...
    'LBL_APPLICATION_EMITTER_HELP_USER' =>
        'User can configure notification delivery for system-wide events.<br/><br/>' .
        '<i>{{sendFor}}</i> column represents system events (system failure, non-configured service, etc.).<br/>' .
        'You can configure Notification Center to receive notifications of particular event by clicking checkbox ' .
        'in the corresponding delivery method column.<br/>' .
        'It is also possible to disable all notification methods for a particular event by clicking the leftmost ' .
    ...
    'LBL_BEAN_EMITTER_TITLE_GLOBAL' => 'General Notifications',
    'LBL_BEAN_EMITTER_TITLE_USER' => 'General Notifications',
    'LBL_BEAN_EMITTER_DESC_GLOBAL' => 'Chose what types of notifications your users receive. ' .
        'You can also change the delivery methods for each notification. Notifications apply to the users ' .
        'that are assigned to a record, on a team with belonging to a record, or invited to a call or meeting.',
