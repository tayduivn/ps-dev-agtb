...
/**
 * Class to run a job which should create related product for every old opp
 */
class CreateDefaultProductJob implements RunnableSchedulerJob {
    ...
    public function run($data)
    {
        ...
        $product->expert_id = $opp->assigned_user_id;
