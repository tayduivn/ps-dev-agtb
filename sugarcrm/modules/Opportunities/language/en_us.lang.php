...
//END DON'T CONVERT
    ...
    'TPL_RLI_CREATE' => 'An opportunity must have an associated {{str "LBL_MODULE_NAME_SINGULAR" "RevenueLineItems"}}. <a href="javascript:void(0);" id="createRLI">Create a {{str "LBL_MODULE_NAME_SINGULAR" "RevenueLineItems"}}</a>.',
