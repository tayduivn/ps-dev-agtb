 ...
 * PLACE ANY CUSTOMIZATIONS IN Orders
 */

class Orders_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'Orders';
	var $object_name = 'Orders';
	...
	function bean_implements($interface){
        ...
        {
		//mail("jbartek@sugarcrm.com","called get summary text",$this->order_id,"From: Jim <jbartek@sugarcrm.com>");
                return "$this->name";
        }
