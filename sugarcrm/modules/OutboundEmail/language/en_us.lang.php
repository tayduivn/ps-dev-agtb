...
$mod_strings = array(
    ...
    'LBL_MAIL_SMTPSSL' => 'Transport Encryption',
    'LBL_EMAIL_PROVIDER' => 'Email Provider',
    'LBL_LISTVIEW_FILTER_ALL' => 'All Accounts',
    'LBL_HELP_RECORDS' => 'The {{plural_module_name}} module is used to manage SMTP email accounts that you can ' .
        'use to send emails to your customers.',
