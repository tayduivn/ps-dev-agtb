...
*/
	...
	function set_productbundle_product_relationship($product_id, $product_index, $bundle_id='')
	{
		...
		$query = "insert into $this->rel_products (id,product_index,product_id,bundle_id, date_modified) VALUES ('".create_guid()."','$product_index', '$product_id', '$bundle_id', ".db_convert("'".TimeDate2::getInstance()->nowDb()."'", 'datetime').")";
    ...
    function set_product_bundle_note_relationship($note_index, $note_id, $bundle_id='')
    {
    	...
    	$query = "INSERT INTO $this->rel_notes (id,bundle_id,note_id,note_index, date_modified) VALUES ('".create_guid()."','".$bundle_id."','".$note_id."','".$note_index."', ".db_convert("'".TimeDate2::getInstance()->nowDb()."'", 'datetime').")";
	...
	function set_productbundle_quote_relationship($quote_id, $bundle_id, $bundle_index='')
	{
		...
		$query = "insert into $this->rel_quotes (id,quote_id,bundle_id,bundle_index, date_modified) values ('".create_guid()."', '$quote_id', '$bundle_id', '$bundle_index', ".db_convert("'".TimeDate2::getInstance()->nowDb()."'", 'datetime').")";
