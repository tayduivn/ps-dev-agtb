...
if(ACLController::checkAccess('Products', 'import', true))$module_menu[] =Array("javascript:void(SUGAR.importWizard.renderDialog('Products','step1',''));", $mod_strings['LNK_IMPORT_PRODUCTS'],"Import", 'Products');
