...
if(ACLController::checkAccess('Products', 'create', true))$module_menu[] = Array("index.php?module=Products&action=EditView&return_module=Products&return_action=DetailView", $mod_strings['LNK_NEW_PRODUCT'],"CreateProducts");
