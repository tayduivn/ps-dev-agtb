	...
	'templateMeta' => array( 'maxColumns' => '2',
                             ...
                             'form' => array(
                             			'buttons'=> array(
											...
											array( 'customCode' => '{if $EDIT_RIGHTS_ONLY}<input title="{$MOD.LBL_VIEW_GANTT_TITLE}" '.
															'accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" type="submit" '.
															'name="EditProjectTasks" value="  {$MOD.LBL_VIEW_GANTT_TITLE}  " '.
															'onclick="prep_edit_project_tasks(this.form);" />{/if}',
													),
											array( 'customCode' =>'<input title="{$SAVE_AS}" ' .
														'accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" type="submit" ' .
											...
											array( 'customCode' => '<input title="{$MOD.LBL_EXPORT_TO_MS_PROJECT}" ' .
