...
$mod_strings = array (
  ...
  'LBL_LIST_PROSPECTLIST_NAME'=>'Name',
    ...
    // Help Text
    'LBL_HELP_CREATE' => 'A {{module_name}} consists of a collection of individuals or organizations you want to include or exclude in a mass marketing {{campaign_module}}. {{plural_module_name}} can contain any number and any combination of {{target_module}}, {{contact_module}}, {{lead_module}}, {{user_module}}, and {{account_module}}.
