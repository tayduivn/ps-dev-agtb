...
// $Id: SubPanelViewProjects.php 45763 2009-04-01 19:16:18Z majed $
...
{	
	$header_text = " <a href='index.php?action=index"
		...
		. "&from_module=Quotes'>"
		. SugarThemeRegistry::current()->getImage/*ALTFIXED*/( 'EditLayout', "border='0' align='bottom'",null,null,'.gif',$mod_strings['LBL_EDITLAYOUT'])
		. '</a>';
}
