 ...
 ********************************************************************************/
/*********************************************************************************
 * $Id: Standard.php 53409 2010-01-04 03:31:15Z roger $
...
$quote[1]['VALUE'] = $timedate->nowDate();
$quote[2]['VALUE'] = $locale->getLocaleFormattedName($rep->first_name, $rep->last_name);
