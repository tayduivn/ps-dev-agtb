    ...
    function display() {
        ...
        foreach($this->data['data'] as $i => $rowData) {
            ...
            //BEGIN SUGARCRM flav!=sales ONLY
                	...
                	$this->data['data'][$i]['IS_EDIT'] = "<a title=\"{$app_strings['LBL_EDIT_BUTTON']}\" href=\"index.php?action=ReportsWizard&module=Reports&page=report&record={$rowData['ID']}\">".SugarThemeRegistry::current()->getImage/*ALTFIXED*/("edit_inline", '', null, null, ".gif", $mod_strings['LBL_EDIT'])."</a>";
            	}
            }
            //END SUGARCRM flav!=sales ONLY
        }
