...
<input title="Filter" accessKey="Q" class="button" type="submit" name="button" value="   Filter   "/>
<input title="Clear" accessKey="C" onclick="clear_form(this.form);" class="button" type="button" name="clear" value=" Clear All "/>
...
<input readonly name='<?php echo $field['name']; ?>' type="text" value="<?php echo $name; ?>"><input name='<?php echo $field['id_name']; ?>' type="hidden" value='<?php echo $id_name; ?>'>&nbsp;<input title="Change" accessKey="G" type="button" tabindex='1' class="button" value='Change' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=<?php echo $field['module']; ?>&action=Popup&form=EditView&form_submit=false","test","width=600,height=400,resizable=1,scrollbars=1");'>
<input title="Clear" accessKey="C" onclick="clear_form_names(this.form,'<?php echo $field['id_name']; ?>','<?php echo $field['name']; ?>');" class="button" type="button" name="clear" value=" Clear "/>
