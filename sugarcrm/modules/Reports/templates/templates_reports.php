...
function reportCriteriaWithResult(&$reporter,&$args) {
	...
	if ($report_type == 'tabular') {
		$duplicateButtons = '<button class="button" onclick="showDuplicateOverlib(\'tabular\');" type="button">' .
				$app_strings['LBL_DUPLICATE_BUTTON_LABEL'].SugarThemeRegistry::current()->getImage/*ALTFIXED*/("more", 'border="0" align="absmiddle"', null, null, ".gif", $mod_strings['LBL_MORE']).'</button>';
	}
