...
// $Id: ListViewGeneric.tpl 16424 2006-08-25 21:44:13 +0000 (Fri, 25 Aug 2006) wayne $
...
<input tabindex='2' title='{$APP.LBL_CLEAR_BUTTON_TITLE}' accessKey='{$APP.LBL_CLEAR_BUTTON_KEY}' onclick='SUGAR.searchForm.clear_form(this.form); return false;' class='button' type='button' name='clear' value=' {$APP.LBL_CLEAR_BUTTON_LABEL} ' id="search_form_clear"/>
</form>