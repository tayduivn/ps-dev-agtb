    ...
    'fields' => array(
        ...
        */
        ...
        'quotes' =>  array(
            'name' => 'quotes',
            'type' => 'link',
            'relationship' => 'quote_revenuelineitem',
            'vname' => 'LBL_QUOTE',
            'source' => 'non-db',
        ),
//BEGIN SUGARCRM flav=pro ONLY
        ...
        'campaign_name' => array(
            ...
            'vname' => 'LBL_CAMPAIGN',
            'type' => 'relate',
            'link' => 'campaign_revenuelineitem',
            'isnull' => 'true',
            'table' => 'campaigns',
            'module' => 'Campaigns',
            'source' => 'non-db',
        ),
        'campaign_revenuelineitem' => array(
            'name' => 'campaign_revenuelineitem',
            'type' => 'link',
            'vname' => 'LBL_CAMPAIGN_PRODUCT',
            'relationship' => 'campaign_revenuelineitem',
            'source' => 'non-db',
        ),
//END SUGARCRM flav=pro ONLY
        ...
        'contracts' => array(
            ...
            'type' => 'link',
            'vname' => 'LBL_CONTRACTS',
            'relationship' => 'contracts_revenuelineitem',
            'link_type' => 'one',
            'source' => 'non-db',
        ),
...
//END SUGARCRM flav=pro ONLY
        ...
        'contact_link' =>  array(
            'name' => 'contact_link',
            'type' => 'link',
            'relationship' => 'contact_revenuelineitem',
            'vname' => 'LBL_CONTACT',
            'link_type' => 'one',
            'module' => 'Contacts',
            'bean_name' => 'Contact',
        ...
        'projects' =>  array(
            'name' => 'projects',
            'type' => 'link',
            'relationship' => 'projects_revenuelineitem',
            'source' => 'non-db',
            'vname' => 'LBL_PROJECTS',
        ),
        'revenuelineitem_bundles' =>  array(
            'name' => 'revenuelineitem_bundles',
            'type' => 'link',
            'relationship' => 'revenuelineitem_bundle_product',
