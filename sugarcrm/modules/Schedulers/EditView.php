...
$params = [];
$params[] = sprintf(
    '<a href="index.php?module=Schedulers&action=index">%s</a>',
    htmlspecialchars($mod_strings['LBL_MODULE_TITLE'])
);
if (empty($focus->id)) {
...
$xtpl->assign('PAGE_TITLE', getClassicModuleTitle('Schedulers', $params, true));
