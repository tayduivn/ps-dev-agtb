<table class="listView" width="80%">
  ...
  <tr>
	<th width="40%" class="listViewThS1" scope="col">
	  {$mod.LBL_DATEFIELDRULE_FIELDVALUE} {sugar_help text=$mod.LBL_HELP_COL_DATE_VALUE WIDTH=500}
	</td>
  ...
  <tr>
	<td>
	  <input type="text" name="{$prefix}_rows[{$rowid}][value]"
	  size=4 maxlength=8 value="{$row.value}">
	</td>
	<td>
  ...
  <tr id="{$prefix}_newrow">
	<td>
	  <input size=4 maxlength=8 type="text" name="{$prefix}_rows[][value]" value="">
	</td>
	<td colspan="4">
