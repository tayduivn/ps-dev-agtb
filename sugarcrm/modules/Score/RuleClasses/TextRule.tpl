<table class="listView" width="80%">
  ...
  <tr>
	<td>
	  ...
	  <input type="text" size=30 maxlength=255 readonly value="{$mod.LBL_TEXTRULE_DEFAULT}"><input type="hidden"
	  name="{$prefix}_rows[{$rowid}][value]" value="_DEFAULT">
	  {else}
	  <input name="{$prefix}_rows[{$rowid}][value]" size=30 maxlength=255 value="{$row.value}">
	  {/if}
	</td>
	<td>
  ...
  <tr id="{$prefix}_newrow">
	<td>
	  <input name="{$prefix}_rows[][value]" size=30 maxlength=255>
	</td>
	<td colspan="4">
