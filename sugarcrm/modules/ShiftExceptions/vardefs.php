...
$dictionary['ShiftException'] = [
    ...
    'fields' => [
        ...
        'shift_name' => [
            ...
            'source' => 'non-db',
            'unified_search' => true,
            'comment' => 'The name of the shift represented by the shift_id field',
            'required' => true,
            'importable' => 'required',
            'exportable' => true,
        ],
        'shift_id' => [
            ...
            'audited' => true,
            'massupdate' => false,
            'comment' => 'The shift to which the shift exception is associated',
        ],
        'shifts' => [
            'name' => 'shifts',
            'type' => 'link',
            'relationship' => 'shifts_shift_exceptions',
            'link_type' => 'one',
            'side' => 'right',
            'source' => 'non-db',
            'vname' => 'LBL_SHIFTS',
