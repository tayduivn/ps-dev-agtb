...
function get_new_record_form() {
	...
	$add_field_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("plus_inline", 'style="margin-left:4px;margin-right:4px;" border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_ADD_FIELD']);
	$minus_field_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("minus_inline", 'style="margin-left:4px;margin-right:4px;" border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_ADD_FIELD']);
	$edit_field_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("edit_inline", 'style="margin-left:4px;margin-right:4px;" border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_ADD_FIELD']);
	$delete = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("delete_inline", "border='0' style='margin-left:4px;margin-right:4px;'",null,null,'.gif',$mod_strings['LBL_DELETE']);
	$show_bin = true;
...
EOQ;
		...
		$add_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("plus_inline", 'style="margin-left:4px;margin-right:4px;" border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_MAXIMIZE']);
		$min_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("minus_inline", 'style="margin-left:4px;margin-right:4px;"  border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_MINIMIZE']);
	   $del_icon = SugarThemeRegistry::current()->getImage/*ALTFIXED*/("delete_inline", 'style="margin-left:4px;margin-right:4px;" border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_MINIMIZE']);
		$html .=<<<EOQ
