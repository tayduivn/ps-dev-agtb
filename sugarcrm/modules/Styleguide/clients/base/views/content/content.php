...
$viewdefs['Styleguide']['base']['view']['content'] = array(
    ...
    'page_data' => array (
        ...
        "base" => array (
            ...
            "pages" => array (
                ...
                "icons" => array("js"=>true, "label"=>"Icons", "description"=>"Font Awesome icon library for scalable font based icons and glyphs for a full array of web-related actions."),
                ...
                "labels" => array("js"=>true, "label"=>"Labels", "description"=>"Label and annotate text."),
        ...
        "forms" => array (
            ...
            "pages" => array (
                ...
                "editable" => array("js"=>true, "label"=>"Editable", "description"=>"Inline form edit inputs."),
                "layouts" => array("js"=>true, "label"=>"Form layouts", "description"=>"Customized layouts of field components."),
                "file" => array("js"=>true, "label"=>"File uploader", "description"=>"Avatar file upload widget."),
                "datetime" => array("js"=>true, "label"=>"Date-time picker", "description"=>"Lightweight date/time picker."),
                "select2" => array("js"=>true, "label"=>"Select2", "description"=>"jQuery plugin replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results."),
                "jstree" => array("js"=>true, "label"=>"jsTree", "description"=>"jQuery plugin cross browser tree component."),
                "range" => array("js"=>true, "label"=>"Range Slider", "description"=>"jQuery plugin range picker."),
                "switch" => array("js"=>true, "label"=>"Switch", "description"=>"jQuerty plugin turns check boxes into toggle switch."),
            )
        ),
        "components" => array (
            "title" => "Components",
            ...
            "index" => true,
            "pages" => array (
                "alerts" => array("js"=>true, "label"=>"Alerts", "description"=>"Styles for success, warning, and error messages."),
                ...
                "dropdowns" => array("js"=>true, "label"=>"Dropdowns", "description"=>"Add dropdown menus to nearly anything with this simple plugin. Features full dropdown menu support on in the navbar, tabs, and pills."),
                "popovers" => array("js"=>true, "label"=>"Popovers", "description"=>"Add small overlays of content, like those on the iPad, to any element for housing secondary information."),
                "progress" => array("label"=>"Progress bars", "description"=>"For loading, redirecting, or action status."),
                "tooltips" => array("js"=>true, "label"=>"Tooltips", "description"=>"A new take on the jQuery Tipsy plugin, Tooltips don't rely on images, uss CSS3 for animations, and data-attributes for local title storage."),
            )
        ),
        "layouts" => array (
            "title" => "Layouts & Views",
            ...
            "pages" => array (
                ...
                "drawer" => array("js"=>true, "label"=>"Drawers", "description"=>"Drawer is a form of a modal that pushes main content down and expands from the top taking 100% of the screen width."),
                "navbar" => array("label"=>"Navbar", "description"=>"Top level navigation layout."),
                "tabs" => array("js"=>true, "label"=>"Tab Navigation", "description"=>"Use this plugin to make tabs and pills more useful by allowing them to toggle through tabbable panes of local content."),
                //"modals" => array("js"=>true, "label"=>"Modals", "description"=>"A streamlined, but flexible, take on the traditional javascript modal plugin with only the minimum required functionality and smart defaults."),
        ...
        "charts" => array (
            ...
            "index" => true,
            "pages" => array (
                "circular" => array("js"=>true, "label"=>"Circular", "description"=>"Used for comparing parts to a whole."),
                "line" => array("js"=>true, "label"=>"Line", "description"=>"Used for comparing data series."),
                "horizontal" => array("js"=>true, "label"=>"Horizontal Bar", "description"=>"Used for comparing many values in a single series."),
                "vertical" => array("js"=>true, "label"=>"Vertical Bar", "description"=>"Used for comparing multiple series with a few values."),
                "custom" => array("js"=>true, "label"=>"Custom", "description"=>"Used for comparing values in a process."),
                "implementation" => array("label"=>"Implementation", "description"=>"Patterns for inserting and configuring charts."),
                "colors" => array("js"=>true, "label"=>"Colors", "description"=>"Flexible methods for assigning color maps and fill methods to D3 charts."),
            )
        ),
    ),
);
