...
//BEGIN SUGARCRM flav=pro ONLY
                ...
                $lvsParams['custom_from'] .= " LEFT JOIN (select DISTINCT tst.team_set_id, team_memberships.id as team_membership_id from team_sets_teams tst INNER JOIN team_memberships team_memberships ON tst.team_id = team_memberships.team_id AND team_memberships.user_id = '" . $current_user->id . "' AND team_memberships.deleted=0) sugarfeed_tf on sugarfeed_tf.team_set_id  = sugarfeed.team_set_id ";
