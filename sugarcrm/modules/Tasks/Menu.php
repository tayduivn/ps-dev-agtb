...
if(ACLController::checkAccess('Tasks', 'import', true))$module_menu[] =Array("javascript:void(SUGAR.importWizard.renderDialog('Tasks','step1',''));", $mod_strings['LNK_IMPORT_TASKS'],"Import", 'Contacts');
