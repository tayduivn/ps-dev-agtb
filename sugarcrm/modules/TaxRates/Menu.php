...
if(ACLController::checkAccess('TaxRates', 'import', true))  $module_menu[] =Array("javascript:void(SUGAR.importWizard.renderDialog('TaxRates','step1',''));", $mod_strings['LNK_IMPORT_TAXRATES'],"Import", 'Contacts');
