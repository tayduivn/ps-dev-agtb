...
foreach($notices as $notice){
	...
	$teamNotice->date_start = $timedate->to_display_date(date($GLOBALS['timedate']->dbDayFormat));
	$teamNotice->date_end = $timedate->to_display_date(date($GLOBALS['timedate']->dbDayFormat, time() + 86400 * 7));
