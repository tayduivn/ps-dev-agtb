...
$mod_strings = array(
    ...
    'LBL_TBA_CONFIGURATION_WARNING_DESC' => '<strong>Warning:</strong> Disabling team-based permissions for a module will revert any data associated with team-based permissions for that module. This includes any Roles using the "Owner & Selected team" option for that module, and any team-based permissions data for records in that module. We also recommend that you use Quick Repair and Rebuild tool to clear your system cache after disabling team-based permissions for any module.',
);
