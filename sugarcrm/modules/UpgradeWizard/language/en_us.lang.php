...
$mod_strings = array(
	...
	'LBL_UW_CANCEL_DESC'						=> 'The upgrade has been cancelled. All temporary files and the uploaded .zip file(s) have been deleted.<br><br>Click "Done" to restart the Upgrade Wizard.',
	...
	'LBL_UW_END_LOGOUT'							=> 'The upgrade is complete.  <br><br>If you plan to apply another upgrade package using the Upgrade Wizard, log out and log back in prior to doing so.',
	...
	'LBL_LAYOUT_MERGE_DESC' => 'There are new fields available which have been added as part of this upgrade and can be automatically appended to your existing module layouts.  To learn more about the new fields, please refer to the Release Notes for the version to which you are upgrading.<br><br>If you do not wish to append the new fields, please uncheck the module, and your custom layouts will remain unchanged. The fields will be available in Studio after the upgrade. <br><br>Click next to commit the upgrade again. If you did not choose to append the new fields, click next to finish the upgrade.',
