...
$mod_strings = array(
	...
	'LBL_UW_END_LOGOUT'							=> 'If you plan to apply another upgrade package using the Upgrade Wizard, log out of and log back in prior to doing so.',
	...
	'LBL_UW_PREFLIGHT_TESTS_PASSED2'			=> 'Press "Next" to copy the upgraded files to the system.',
    ...
    'LBL_UW_COMMIT_DESC'						=> 'During this step, the upgrade runs additional upgrade scripts. Click Next to merge the current system layouts with any layouts updated during the upgrade.',
