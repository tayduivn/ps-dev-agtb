...
class AuthenticationController
{
	...
	public function login($username, $password, $PARAMS = array())
	{
		...
		if($this->loginSuccess){
		    ...
		    if ( is_admin($GLOBALS['current_user']) && empty($config->settings['system_adminwizard']) && array_key_exists('action', $_REQUEST) && $_REQUEST['action'] != 'AdminWizard' ) {
			...
			if(empty($ut) && $checkTimeZone && array_key_exists('action', $_REQUEST) && $_REQUEST['action'] != 'SetTimezone' && $_REQUEST['action'] != 'SaveTimezone' ) {
