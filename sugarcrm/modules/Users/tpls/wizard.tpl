        ...
        <td>
            ...
            <tr>
               ...
               <p> {$MOD.LBL_WIZARD_WELCOME_NOSMTP}</p>
				...
				<div class="userWizWelcome"><<!--ALTFIXED-->img src='include/images/sugar_wizard_welcome.jpg' border='0' alt="{$mod_strings.LBL_WIZARD_WELCOME_TAB}" width='765px' height='325px'></div>
                </td>
            </tr>
            </table>
            </div>
