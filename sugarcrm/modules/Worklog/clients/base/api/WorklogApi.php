...
/**
 * Extends ModuleApi for Worklog specific work
 *
 * Class WorklogApi
 */
class WorklogApi extends ModuleApi
{
    ...
    public function registerApiRest()
    {
        return array(
            ...
            'retrieve' => array(
                ...
                'shortHelp' => 'Returns a single parent record of the given worklog',
    ...
    /**
     * Retrieves the parent record of this worklog instead
     * @throws SugarApiExceptionInvalidParameter When id for the given worklog is not found
     * @throws SugarApiExceptionRequestMethodFailure Somehow the relationship won't load
     * @throws SugarApiExceptionInvalidParameter Can't find any parent record related to this worklog
     */
    public function retrieveRecord(ServiceBase $api, array $args)
    {
        $this->requireArgs($args, array('module','record'));

        $bean = BeanFactory::retrieveBean('Worklog', $args['record']);
        if ($bean === null) {
            // can't find the worklog
