...
$dictionary['csurv_SurveyResponse'] = array(
  ...
  array (
  	'name' => 'contact_link',
  	'type' => 'link',
  	'relationship' => 'csurv_SurveyResponse_contacts',
  	'source' => 'non-db',
  	'link_type' => 'one',
  	'rname' => 'LBL_CONTACTS',
  	'module' => 'Contacts',
  ...
  array (
  	'name' => 'case_link',
  	'type' => 'link',
  	'relationship' => 'csurv_SurveyResponse_cases',
  	'source' => 'non-db',
  	'link_type' => 'one',
  	'rname' => 'LBL_CASES',
  	'module' => 'Cases',
  ...
  array (
	...
	'relationships'=>array (
		'csurv_SurveyResponse_contacts' => array('lhs_module' => 'Contacts', 'lhs_table' => 'contacts', 'lhs_key' => 'id', 'rhs_module' => 'csurv_SurveyResponse', 'rhs_table' => 'csurv_surveyresponse', 'rhs_key' => 'contact_id', 'relationship_type' => 'one-to-many'),
		'csurv_SurveyResponse_cases' => array('lhs_module' => 'Cases', 'lhs_table' => 'cases', 'lhs_key' => 'id', 'rhs_module' => 'csurv_SurveyResponse', 'rhs_table' => 'csurv_surveyresponse', 'rhs_key' => 'acase_id', 'relationship_type' => 'one-to-many'),
