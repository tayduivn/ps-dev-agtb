 ...
 * PLACE ANY CUSTOMIZATIONS IN gtb_contacts
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class gtb_contacts_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'gtb_contacts';
    public $object_name = 'gtb_contacts';
    public $table_name = 'gtb_contacts';
