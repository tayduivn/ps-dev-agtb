...
ExpressionControl.prototype.addVariablesList=function(a,b){var c,d;d={fieldToFilter:"type",filter:b.typeFilter,title:b.moduleText,data:[],itemsContent:function(a,b){var c="[item]",d,k,c=b.text;k=this.createHTMLElement("div");d=this.createHTMLElement("span");d.className="adam expressionbuilder-variableitem-text";d.textContent=c;c=this.createHTMLElement("span");c.className="adam expressionbuilder-variableitem-datatype";c.textContent=b.type;k.appendChild(d);k.appendChild(c);return k}};for(c=0;c<a.length;c+=
