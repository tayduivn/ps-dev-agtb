...
$mod_strings = array (
    ...
    'LBL_PMSE_HISTORY_LOG_ACTION'  => "The %s Action %s was processed on the %s record",
    'LBL_PMSE_HISTORY_LOG_ASSIGN_USER_ACTION'  => "was assigned Process #%s %s the %s record by the %s Action %s",
    ...
    'LBL_PMSE_HISTORY_STATUS_COMPLETED' => 'Process was Completed.',
    'LBL_PMSE_HISTORY_STATUS_TERMINATED' => 'Process was Terminated.',
    'LBL_PMSE_HISTORY_STATUS_CANCELLED' => 'Process was Cancelled.',
