...
AdamConnectionDropBehavior.prototype.onDrop=function(a){return function(b,c){var d=a.getCanvas(),e=c.draggable.attr("id"),g,h,f,k,r;k=d.currentConnection;a.entered=!1;if(!a.dropBehavior.dropStartHook(a,b,c))return!1;if("none"===a.getConnectionType())return App.alert.show("warning_connection",{level:"warning",messages:translate("LBL_PMSE_ADAM_UI_INVALID_CONNECTION"),autoClose:!0,autoCloseDelay:9E3}),!0;k&&(f=k.srcPort,k=k.destPort,f=f.id===e?f:k.id===e?k:null);if(c.helper&&"drag-helper"===c.helper.attr("id")){e=
a.canvas.connectionSegment.startPoint;g=a.canvas.connectionSegment.pointsTo;if(g.parent&&g.parent.id===a.id)return!0;g.setPosition(g.oldX,g.oldY);e.x-=g.absoluteX;e.y-=g.absoluteY;f=new jCore.Port({width:10,height:10});k=new jCore.Port({width:10,height:10});h=c.offset.left-a.canvas.getX()-a.getAbsoluteX()+a.canvas.getLeftScroll();r=c.offset.top-a.canvas.getY()-a.getAbsoluteY()+a.canvas.getTopScroll();g.addPort(f,e.x,e.y);a.addPort(k,h,r,!1,f);e=new AdamFlow({srcPort:f,destPort:k,canvas:a.canvas,segmentStyle:a.connectionType.segmentStyle,
flo_type:a.connectionType.type});e.setSrcDecorator(new jCore.ConnectionDecorator({width:11,height:11,canvas:d,decoratorPrefix:"undefined"!==typeof a.connectionType.srcDecorator&&null!==a.connectionType.srcDecorator?a.connectionType.srcDecorator:"adam-decorator",decoratorType:"source",parent:e}));e.setDestDecorator(new jCore.ConnectionDecorator({width:11,height:11,canvas:d,decoratorPrefix:"undefined"!==typeof a.connectionType.destDecorator&&null!==a.connectionType.destDecorator?a.connectionType.destDecorator:
"adam-decorator",decoratorType:"target",parent:e}));e.canvas.commandStack.add(new jCore.CommandConnect(e));e.connect();e.setSegmentMoveHandlers();d.addConnection(e);e.setTargetShape(k.parent);e.setOriginShape(f.parent);e.savePoints();f.attachListeners(f);k.attachListeners(k);d.triggerCreateEvent(e,[])}else if(f&&(f.setOldParent(f.getParent()),f.setOldX(f.getX()),f.setOldY(f.getY()),g=c.position.left,h=c.position.top,f.setPosition(g,h),a.dragging=!1,a.getID()!==f.parent.getID()?(f.parent.removePort(f),
g=c.offset.left-d.getX()-a.absoluteX+a.canvas.getLeftScroll(),h=c.offset.top-d.getY()-a.absoluteY+a.canvas.getTopScroll(),a.addPort(f,g,h,!0),d.regularShapes.insert(f)):a.definePortPosition(f,f.getPoint(!0)),f.connection.connect(),d.triggerPortChangeEvent(f),f.connection.disconnect(),e=new jCore.CommandReconnect(f),f.canvas.commandStack.add(e),e=f.getConnection(),k=e.srcPort.getID()===f.getID()?AdamConnectionDropBehavior.prototype.validate(a,e.destPort.getParent()):AdamConnectionDropBehavior.prototype.validate(e.srcPort.getParent(),
a)))f.setOldParent(f.getParent()),f.setOldX(f.getX()),f.setOldY(f.getY()),g=c.position.left,h=c.position.top,f.setPosition(g,h),a.dragging=!1,a.getID()!==f.parent.getID()?(f.parent.removePort(f),g=c.offset.left-d.getX()-a.absoluteX+a.canvas.getLeftScroll(),h=c.offset.top-d.getY()-a.absoluteY+a.canvas.getTopScroll(),a.addPort(f,g,h,!0),d.regularShapes.insert(f)):a.definePortPosition(f,f.getPoint(!0)),k={before:{condition:e.flo_condition,type:e.flo_type,segmentStyle:e.segmentStyle,srcDecorator:e.srcDecorator.getDecoratorPrefix(),
destDecorator:e.destDecorator.getDecoratorPrefix()},after:{type:k.type,segmentStyle:k.connection,srcDecorator:k.srcDecorator,destDecorator:k.destDecorator}},e.connect(),d.triggerPortChangeEvent(f),e=new AdamCommandReconnect(f,k),e.execute(),f.canvas.commandStack.add(e);return!1}};var AdamConnectionContainerDropBehavior=function(a){AdamConnectionDropBehavior.call(this,a)};AdamConnectionContainerDropBehavior.prototype=new AdamConnectionDropBehavior;
AdamConnectionContainerDropBehavior.prototype.type="AdamConnectionContainerDropBehavior";AdamConnectionContainerDropBehavior.prototype.defaultSelector=".custom_shape,.port";AdamConnectionContainerDropBehavior.prototype.onDrop=function(a){return function(b,c){AdamConnectionDropBehavior.prototype.onDrop.call(this,a)(b,c)||AdamContainerDropBehavior.prototype.onDrop.call(this,a)(b,c)}};AdamConnectionContainerDropBehavior.prototype.getSpecificType=AdamContainerDropBehavior.prototype.getSpecificType;
AdamConnectionContainerDropBehavior.prototype.validDrop=AdamContainerDropBehavior.prototype.validDrop;AdamConnectionContainerDropBehavior.prototype.dropHook=AdamContainerDropBehavior.prototype.dropHook;var AdamShape=function(a){jCore.CustomShape.call(this,a);this.label=this.labels.get(0)};AdamShape.prototype=new jCore.CustomShape;AdamShape.prototype.type="AdamShape";AdamShape.prototype.adamConnectionDropBehavior=null;AdamShape.prototype.getType=function(){return this.type};
AdamShape.prototype.setName=function(a){var b;this.label&&(this.label.setMessage(a),listPanelError&&listPanelError.items.length&&(b=listPanelError.getItemById(this.id))&&(a.trim().length?b.setTitle(a):b.setTitle("[unnamed]")));return this};AdamShape.prototype.getName=function(){var a="";this.label&&(a=this.label.getMessage());return a};AdamShape.prototype.getContextMenu=function(){return{}};AdamShape.prototype.getContextMenuCallbacks=function(){return{}};
AdamShape.prototype.setDimension=function(a,b){var c;jCore.CustomShape.prototype.setDimension.call(this,a,b);c="AdamEvent"===this.getType()||"AdamGateway"===this.getType()?3:"AdamActivity"===this.getType()&&"SCRIPTTASK"===this.act_task_type?3:1;this.label&&(this.label.setDimension(0.9*this.zoomWidth*c/this.canvas.zoomFactor,this.label.height),this.label.setLabelPosition(this.label.location,this.label.diffX,this.label.diffY));return this};
...
AdamShape.prototype.getFamilyNumber=function(a){return{AdamActivity:5,AdamEvent:6,AdamGateway:7,AdamData:8,AdamArtifact:9}[a.getType()]};
AdamShape.prototype.attachErrorToShape=function(a){var b,c,d,e,g,h,f;this.BPMNError=new jCore.ArrayList;for(b=0;b<a.length;b+=1){e=a[b].message;g=a[b].rules;d=8===a[b].family&&4===a[b].familyType?!1:!0;for(c=0;c<g.length;c+=1)if(f=g[c],h=this.countFlow(f.element,f.direction),8===a[b].family&&4===a[b].familyType)d=d||h>f.value;else switch(f.compare){case "=":d=d&&h===f.value;break;case ">":d=d&&h>f.value;break;case "<":d=d&&h<f.value}d||this.BPMNError.insert({code:a[b].id,direction:f.direction,description:e})}0<
this.BPMNError.getSize()?this.addErrorLayer("error",2):this.clearErrors();listPanelError.setItems(this.getShapeWithErros());countErrors&&(listPanelError.getItems().length?(countErrors.style.display="block",a=listPanelError.getAllErros(),countErrors.textContent=1===a?a+translate("LBL_PMSE_BPMN_WARNING_SINGULAR_LABEL"):a+translate("LBL_PMSE_BPMN_WARNING_LABEL")):countErrors.textContent="0"+translate("LBL_PMSE_BPMN_WARNING_SINGULAR_LABEL"))};
AdamShape.prototype.getShapeWithErros=function(){var a,b,c,d=[],e={},g={};for(a=0;a<canvas.getCustomShapes().getSize();a+=1)if(b=canvas.getCustomShapes().get(a),void 0!==b.BPMNError&&b.BPMNError.getSize()){e={};e.title=b.getName()||"[unnamed]";e.errorType=this.getShapeType(b.getType(),b);e.items=[];e.errorId=b.getID();b=b.BPMNError;for(j=0;j<b.getSize();j+=1)g={},c=b.get(j),g.messageId=c.code,g.message=c.description,e.items.push(g);d.push(e)}return d};
AdamShape.prototype.getShapeType=function(a,b){var c,d;c="";switch(a){case "AdamActivity":c=b.act_task_type;c=a+c;break;case "AdamEvent":c=b.getEventType();d=b.getEventMessage()||b.getEventMarker();c=a+c+d;break;case "AdamGateway":c=b.getGatewayType(),b.getGatewayType(),c=a+c}return c};
AdamShape.prototype.countFlow=function(a,b){var c,d={sequenceFlow:"regular",associationFlow:"dotted"},e,g,h=0;for(c=0;c<this.getPorts().getSize();c+=1)switch(e=this.getPorts().get(c),g=e.getConnection(),b){case "incoming":d[a]===g.segmentStyle&&e.getID()===g.getDestPort().getID()&&(h+=1);break;case "outgoing":d[a]===g.segmentStyle&&e.getID()===g.getSrcPort().getID()&&(h+=1);break;case "none":e.getID()===g.getSrcPort().getID()&&(h+=1)}return h};
AdamShape.prototype.addErrorLayer=function(a,b){var c,d;c=this.layers.find("id",this.id+"Layer-Errors");d="undefined"===typeof b||null===b?a:"div-empty";"undefined"===typeof c?(c={layerName:"error-layer",priority:3,visible:!0,style:{cssClasses:[]}},c=this.createLayer(c)):("undefined"===typeof b||null===b)&&c.setElementClass(d);"undefined"!==typeof b&&null!==b&&this.addErrors(c,b)};
AdamShape.prototype.clearErrors=function(){var a,b;for(a=0;a<this.markersArray.getSize();a+=1)if(b=this.markersArray.get(a),2===b.position){b.removeAllClasses();break}};
AdamShape.prototype.addErrors=function(a,b){var c,d=!1,e=[],g,h;for(h=0;h<this.markersArray.getSize();h+=1)if(c=this.markersArray.get(h),c.position===b){d=!0;break}for(h=0;h<a.ZOOMSCALES;h+=1)g="adam-status-"+(25*h+50)+"-warning adam-error-color icon-exclamation-sign",e.push(g);d||(c=new AdamMarker({parent:a,position:b,height:17,width:17,markerZoomClasses:e}),this.markersArray.insert(c),c.paint());c.setElementClass(e)};
...
CommandSingleProperty.prototype.execute=function(){this.receiver[this.propertyName]=this.after;this.receiver.canvas.triggerCommandAdam(this.receiver,[this.propertyName],[this.before],[this.after]);this.receiver.canvas.bpmnValidation()};CommandSingleProperty.prototype.undo=function(){this.receiver[this.propertyName]=this.before;this.receiver.canvas.triggerCommandAdam(this.receiver,[this.propertyName],[this.after],[this.before]);this.receiver.canvas.bpmnValidation()};
CommandSingleProperty.prototype.redo=function(){this.execute()};var AdamActivityContainerBehavior=function(){};AdamActivityContainerBehavior.prototype=new jCore.RegularContainerBehavior;AdamActivityContainerBehavior.prototype.type="AdamActivityContainerBehavior";
AdamActivityContainerBehavior.prototype.addToContainer=function(a,b,c,d,e){var g=0,h=0,f,k,r=!0===e?0:1;k="Canvas"===a.family?a:a.canvas;e=b.getZoomWidth();f=b.getZoomHeight();g=(g+(c-e/2*r))/a.zoomFactor;h=(h+(d-f/2*r))/a.zoomFactor;b.setParent(a);a.getChildren().insert(b);this.addShape(a,b,g,h);b.fixZIndex(b,0);k.addToList(b);"AdamEvent"===b.getType()&&"BOUNDARY"===b.evn_type&&(b.setAttachedTo(a.act_uid),a.boundaryArray.insert(b),a.boundaryPlaces.isEmpty()&&a.makeBoundaryPlaces(b),b.attachToActivity())};
...
var callbackCS,AdamProject=function(a){this.canvas=this.description=this.name=this.uid=null;this.url="/rest/v10/Project/";this.restClient=null;this.isWaitingResponse=this.isDirty=this.loaded=!1;this.saveInterval=3E4;this.showWarning=!1;this.dirtyElements=[{activities:{},gateways:{},events:{},artifacts:{},flows:{}},{activities:{},gateways:{},events:{},artifacts:{},flows:{}}];this.propertiesGrid=null;this._metadata={};this.process_definition={};AdamProject.prototype.preinit.call(this,a)};
AdamProject.prototype.type="AdamProject";AdamProject.prototype.preinit=function(a){var b={metadata:[]};jQuery.extend(!0,b,a);this.setMetadata(b.metadata)};AdamProject.prototype.getUid=function(){return this.uid};AdamProject.prototype.setUid=function(a){this.uid=a};AdamProject.prototype.setName=function(a){var b,c;this.name=a;b=$("#ProjectTitle");c=$("#txt-title");b.html(a);c.html(a)};AdamProject.prototype.setDescription=function(a){this.description=a;return this};
AdamProject.prototype.setCanvas=function(a){a instanceof AdamCanvas?(this.canvas=a,this.canvas.setProject(this),$(this.canvas.html).on("selectelement",this.onSelectElementHandler(this.canvas))):this.canvas=null;return this};AdamProject.prototype.setRestClient=function(a){a instanceof RestClient&&(this.restClient=a);return this};AdamProject.prototype.setRestURL=function(a){this.url=a;return this};AdamProject.prototype.setSaveInterval=function(a){this.saveInterval=a;return this};
AdamProject.prototype.load=function(a,b){var c=!1,d=this,e,g={};"undefined"!==typeof a&&(this.uid=a);e=App.api.buildURL("pmse_Project/project/"+this.uid,null,null);g={};App.api.call("read",e,g,{success:function(a){d.loadProject(a);c=!0;b&&b.success&&b.success.call(this,a);canvas&&canvas.bpmnValidation()},error:function(a){}});return c};
...
nonResizableStyle:{cssProperties:{"background-color":"white",border:"1px solid black"}}},drop:{type:"connection"},evn_name:a.evn_name,evn_type:a.evn_type.toLowerCase(),evn_marker:a.evn_marker,evn_behavior:d,evn_message:e,evn_uid:g});if("BOUNDARY"===a.evn_type&&(f=!1,g=this.canvas.getCustomShapes().find("id",a.evn_attached_to)))g.activityContainerBehavior.addToContainer(g,c,parseInt(a.bou_x,10),parseInt(a.bou_y,10),!0),c.attachListeners();break;case "AdamActivity":g=a.act_uid;h=a.act_task_type;c=a.act_type;
...
readOnly:!0}),c.push({name:"evn_operation_implementation",label:translate("LBL_PMSE_PROPERTY_GRID_OPERATION_IMPLEMENTATION_REF"),type:"text",value:a.evn_operation_implementation,readOnly:!0}),c.push({name:"evn_operation_name",label:translate("LBL_PMSE_PROPERTY_GRID_OPERATION_NAME"),type:"text",value:a.evn_operation_name,readOnly:!0}));switch(a.evn_type){case "START":c.push({name:"listen",label:translate("LBL_PMSE_PROPERTY_GRID_LISTEN"),type:"select",options:[{label:translate("LBL_PMSE_PROPERTY_GRID_LEAD"),
...
AdamProject.prototype.addMetadata=function(a,b,c){var d;b=b||{};if("object"!==typeof b)throw Error("addMetadata(): the second (which is optional) must be an object or null.");if(!this._metadata[a]||c){d=this._metadata[a]={};if("string"===typeof b.dataURL&&b.dataURL){d.dataURL=b.dataURL;d.dataRoot=b.dataRoot;a=new SugarProxy;a.url=b.dataURL;a.getData(null,{success:function(a){d.data=b.dataRoot?a[b.dataRoot]:a;"function"===typeof b.success&&b.success(d.data)}});return}b.data&&(d.data=b.data)}"function"===
typeof b.success&&b.success(this._metadata[a].data);return this};AdamProject.prototype.setMetadata=function(a){var b,c;if(!jQuery.isArray(a))throw Error("setMetadata(): The parameter must be an array.");for(b=0;b<a.length;b++){if("object"!==typeof a[b])throw Error("setMetadata(): All the elements of the array parameter must be objects.");(c=a[b].name)&&this.addMetadata(c,a[b],!0)}return this};AdamProject.prototype.getMetadata=function(a){return this._metadata[a]&&this._metadata[a].data||null};
var AdamCanvas=function(a){jCore.Canvas.call(this,a);this.dia_id=null;this.projectUid="";this.currentMenu=this.project=null;this.isClicked=!1;this.bpmnRules={AdamEvent:{start:[{id:"106107",type:1,family:6,familyType:1,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_START_EVENT_OUTGOING"),rules:[{compare:">",value:0,direction:"outgoing",element:"sequenceFlow"}]}],end:[{id:"106108",type:1,family:6,familyType:3,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_END_EVENT_INCOMING"),
rules:[{compare:">",value:0,direction:"incoming",element:"sequenceFlow"}]}],intermediate:[{id:"106109",type:1,family:6,familyType:2,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_INTERMEDIATE_EVENT_INCOMING"),rules:[{compare:">",value:0,direction:"incoming",element:"sequenceFlow"}]},{id:"106112",type:1,family:6,familyType:2,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_INTERMEDIATE_EVENT_OUTGOING"),rules:[{compare:"=",value:1,direction:"outgoing",element:"sequenceFlow"}]}],
boundary:[{id:"106115",type:1,family:6,familyType:4,familySubType:1,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_BOUNDARY_EVENT_OUTGOING"),rules:[{compare:"=",value:1,direction:"outgoing",element:"sequenceFlow"}]}]},AdamActivity:{task:[{id:"105101",type:1,family:5,familyType:1,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_ACTIVITY_INCOMING"),rules:[{compare:">",value:0,direction:"incoming",element:"sequenceFlow"}]},{id:"105102",type:1,family:5,familyType:1,familySubType:0,
action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_ACTIVITY_OUTGOING"),rules:[{compare:">",value:0,direction:"outgoing",element:"sequenceFlow"}]}]},AdamGateway:{diverging:[{id:"107101",type:1,family:7,familyType:1,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_DIVERGING_INCOMING"),rules:[{compare:">=",value:1,direction:"incoming",element:"sequenceFlow"}]},{id:"107102",type:1,family:7,familyType:1,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_DIVERGING_OUTGOING"),
rules:[{compare:">",value:1,direction:"outgoing",element:"sequenceFlow"}]}],converging:[{id:"107201",type:1,family:7,familyType:2,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_CONVERGING_INCOMING"),rules:[{compare:">",value:1,direction:"incoming",element:"sequenceFlow"}]},{id:"107202",type:1,family:7,familyType:2,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_CONVERGING_OUTGOING"),rules:[{compare:"=",value:1,direction:"outgoing",element:"sequenceFlow"}]}],
mixed:[{id:"107301",type:1,family:7,familyType:3,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_MIXED_INCOMING"),rules:[{compare:">",value:1,direction:"incoming",element:"sequenceFlow"}]},{id:"107302",type:1,family:7,familyType:3,familySubType:0,action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_GATEWAY_MIXED_OUTGOING"),rules:[{compare:">",value:1,direction:"outgoing",element:"sequenceFlow"}]}]},AdamArtifact:{textannotation:[{id:"109101",type:1,family:9,familyType:1,familySubType:0,
action:1,message:translate("LBL_PMSE_MESSAGE_ERROR_ANNOTATION"),rules:[{compare:">",value:0,direction:"none",element:"associationLine"}]}]}};AdamCanvas.prototype.initObject.call(this,a)};AdamCanvas.prototype=new jCore.Canvas;AdamCanvas.prototype.type="AdamCanvas";AdamCanvas.prototype.getProjectUid=function(){return this.projectUid};AdamCanvas.prototype.getType=function(){return this.type};AdamCanvas.prototype.setDiaUid=function(a){this.dia_id=a;return this};
...
AdamCanvas.prototype.getContextMenu=function(){var a,b,c,d,e,g,h,f,k,r,s,t,n,l,p,w,u,x,y,q,m,v,A,B,C;c=new HiddenField({name:"pro_module"});g=new TextField({name:"prj_name",label:translate("LBL_PMSE_LABEL_PROCESS_NAME"),required:!0});h=new TextareaField({name:"prj_description",label:translate("LBL_PMSE_LABEL_DESCRIPTION")});d=new ItemMatrixField({jtype:"itemmatrix",label:translate("LBL_PMSE_LABEL_LOCKED_FIELDS"),name:"pro_locked_variables",submit:!0,fieldWidth:350,fieldHeight:90,visualStyle:"table",
nColumns:2});k=new CriteriaField({name:"pro_terminate_variables",label:translate("LBL_PMSE_LABEL_TERMINATE_PROCESS"),required:!1,fieldWidth:250,fieldHeight:80,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,operators:{logic:!0,group:!0},constant:!1,decimalSeparator:PMSE_DECIMAL_SEPARATOR});e=function(a,e){App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1});(new SugarProxy({url:"pmse_Project/CrmData/fields/"+
a,uid:"",callback:null})).getData(null,{success:function(g){c.setValue(a);void 0!==e?d.setList(g.result,PROJECT_LOCKED_VARIABLES):d.setList(g.result);App.alert.dismiss("upload");b.html.style.display="inline"}})};f=new ComboboxField({jtype:"combobox",label:translate("LBL_PMSE_FORM_LABEL_MODULE"),name:"comboModules",submit:!1,change:function(){return e(this.value)},proxy:new SugarProxy({url:"pmse_Project/CrmData/modules",uid:"",callback:null})});r=new SugarProxy({url:"pmse_Project/CrmData/project/"+
adamUID,uid:adamUID,callback:null});v=function(a){f.value!==x?(B=a.pro_locked_variables,PROJECT_LOCKED_VARIABLES=d.getLockedField(),q.show()):(m={description:h.value,pro_terminate_variables:k.value,pro_locked_variables:a.pro_locked_variables},null!==g.value&&""!==g.value&&(m={name:g.value,description:h.value,pro_locked_variables:a.pro_locked_variables,pro_terminate_variables:k.value},project.setName(PROJECT_NAME=g.value)),project.process_definition.pro_terminate_variables=k.value,project.setDescription(PROJECT_DESCRIPTION=
h.value),r.sendData(m),PROJECT_LOCKED_VARIABLES=d.getLockedField(),project.process_definition.pro_locked_variables=d.getLockedField(),b.close())};y=new SugarProxy({url:"pmse_Project/CrmData/putData/"+adamUID,uid:adamUID,callback:null});new HiddenField({name:"pro_new_module"});new HiddenField({name:"pro_old_module"});new LabelField({name:"lblAlert",label:translate("LBL_PMSE_FORM_LABEL_THE_WARNING"),options:{marginLeft:35}});q=new MessagePanel({title:"Module change warning",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_REMOVE_ALL_START_CRITERIA"),
buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_OK"),handler:function(){m={prj_name:g.value,prj_description:h.value,pro_locked_variables:B,pro_module:f.value};project.setDescription(PROJECT_DESCRIPTION=h.value);project.setName(PROJECT_NAME=g.value);r.sendData(m);PROJECT_MODULE=f.value;project.canvas.cleanAllFlowConditions();m={pro_new_module:PROJECT_MODULE,pro_old_module:x};y.sendData(m,{success:function(a){a.success?b.close():(errorModule=new MessagePanel({title:"Error",wtype:"Error",
message:translate("LBL_PMSE_ADAM_ENGINE_ERROR_UPDATEBPMFLOW")}),errorModule.show())},failure:function(a,b){}});q.hide()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){f.removeOptions();f.proxy.getData(null,{success:function(a){g.setValue(project.name);h.setValue(project.description);f.setOptions(a.result);f.setValue(x);k.setValue(project.process_definition.pro_terminate_variables);PROJECT_LOCKED_VARIABLES=project.process_definition.pro_locked_variables.slice();e(PROJECT_MODULE||
a.result[0].value,!0);d.setLockedFields(PROJECT_LOCKED_VARIABLES);x=PROJECT_MODULE;q.hide()}})}}]});a=new Form({items:[g,h,f,k,d,c],buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_SAVE"),handler:function(){a.submit()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){a.isDirty()?(A=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM"),buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){PROJECT_LOCKED_VARIABLES=
project.process_definition.pro_locked_variables.slice();A.close();b.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){A.close()}}]}),A.show()):b.close()}}],callback:{loaded:function(a){App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1});k.setModuleEvaluation({dataURL:"pmse_Project/CrmData/related/"+PROJECT_MODULE,dataRoot:"result",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",fieldDataRoot:"result"});g.setValue(project.name);f.proxy.getData(null,
{success:function(a){f.setOptions(a.result);f.setValue(PROJECT_MODULE||a.result[0].value);g.setValue(project.name);h.setValue(project.description);k.setValue(project.process_definition.pro_terminate_variables);PROJECT_LOCKED_VARIABLES=project.process_definition.pro_locked_variables.slice();e(PROJECT_MODULE||a.result[0].value,!0);d.setLockedFields(PROJECT_LOCKED_VARIABLES);x=f.value}})},submit:function(a){g.value!==project.name?(C=App.api.buildURL("pmse_Project",null,null,{filter:[{name:g.value}]}),
App.api.call("read",C,null,{success:function(b){0===b.records.length?v(a):(new MessagePanel({title:"Error",wtype:"Error",message:translate("LBL_PMSE_MESSAGE_THEPROCESSNAMEALREADYEXISTS","pmse_Project",g.value)})).show()}})):v(a)}},proxy:null,language:PMSE_DESIGNER_FORM_TRANSLATIONS});b=new Window({width:580,height:450,modal:!0,title:translate("LBL_PMSE_CONTEXT_MENU_PROCESS_DEFINITION")});b.addPanel(a);s=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_SAVE"),cssStyle:"adam-menu-icon-save",handler:function(){project.save();
jCore.getActiveCanvas().RemoveCurrentMenu()},disabled:!project.isDirty});t=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_REFRESH"),cssStyle:"adam-menu-icon-refresh",handler:function(){document.location.reload(!0)}});n=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_50"),cssStyle:"",handler:function(){jCore.getActiveCanvas().applyZoom(1);$("#zoom").val(1)},disabled:0.5===jCore.getActiveCanvas().getZoomFactor()});l=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_75"),cssStyle:"",handler:function(){jCore.getActiveCanvas().applyZoom(2);
$("#zoom").val(2)},disabled:0.75===jCore.getActiveCanvas().getZoomFactor()});p=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_100"),cssStyle:"",handler:function(){jCore.getActiveCanvas().applyZoom(3);$("#zoom").val(3)},disabled:1===jCore.getActiveCanvas().getZoomFactor()});w=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_125"),cssStyle:"",handler:function(){jCore.getActiveCanvas().applyZoom(4);$("#zoom").val(4)},disabled:1.25===jCore.getActiveCanvas().getZoomFactor()});u=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_150"),
cssStyle:"",handler:function(){jCore.getActiveCanvas().applyZoom(5);$("#zoom").val(5)},disabled:1.5===jCore.getActiveCanvas().getZoomFactor()});return{items:[new Action({text:translate("LBL_PMSE_CONTEXT_MENU_PROCESS_DEFINITION"),cssStyle:"adam-menu-icon-configure",handler:function(){b.show();b.html.style.display="none"}}),{jtype:"separator"},s,t,{label:translate("LBL_PMSE_CONTEXT_MENU_ZOOM"),icon:"adam-menu-icon-zoom",menu:{items:[n,l,p,w,u]}}]}};
AdamCanvas.prototype.onRightClickHandler=function(a,b,c){var d;d=a.getContextMenu();d.items?(d.canvas=this,d=new Menu(d),d.setParent(a),d.show(b,c)):this.RemoveCurrentMenu()};AdamCanvas.prototype.dropBehaviorFactory=function(a,b){var c;"container"===a?(this.containerDropBehavior||(this.containerDropBehavior=new AdamContainerDropBehavior(b)),c=this.containerDropBehavior):c=jCore.BehavioralElement.prototype.dropBehaviorFactory.call(this,a,b);return c};
AdamCanvas.prototype.onCreateElementHandler=function(a){this.RemoveCurrentMenu();this.project instanceof AdamProject&&(this.project.addElement(a),a=this.getDiagramTree(),Tree.treeReload("tree",a));this.bpmnValidation()};
...
AdamCanvas.prototype.onRemoveElementHandler=function(a){var b,c;this.project instanceof AdamProject&&(this.project.removeElement(a),b=this.getDiagramTree(),Tree.treeReload("tree",b),this.project.updatePropertiesGrid());if(listPanelError&&listPanelError.items.length)for(b=0;b<a.length;b+=1)"Connection"!==a[b].type&&(c=listPanelError.getItemById(a[b].getID()))&&listPanelError.removeItemById(a[b].getID());this.bpmnValidation();countErrors&&(listPanelError.getItems().length?(countErrors.style.display=
"block",a=listPanelError.getAllErros(),countErrors.textContent=1===a?a+translate("LBL_PMSE_BPMN_WARNING_SINGULAR_LABEL"):a+translate("LBL_PMSE_BPMN_WARNING_LABEL")):countErrors.textContent="0"+translate("LBL_PMSE_BPMN_WARNING_SINGULAR_LABEL"))};AdamCanvas.prototype.triggerCommandAdam=function(a,b,c,d){var e=[],g;for(g=0;g<b.length;g+=1)e.push({field:b[g],newVal:d[g],oldVal:c[g]});this.updatedElement=[{fields:e,id:a.id,relatedObject:a,type:a.type,adam:!0}];$(this.html).trigger("changeelement")};
...
AdamCanvas.prototype.bpmnValidation=function(){var a,b,c=this.bpmnRules,d,e;for(a=0;a<this.getCustomShapes().getSize();a+=1){e=[];b=this.getCustomShapes().get(a);d=b.getFamilyNumber(b);switch(d){case 5:if("TASK"===b.getActivityType()||"SUBPROCESS"===b.getActivityType())e=c[b.getType()].task;break;case 6:c[b.getType()]&&c[b.getType()][b.getEventType().toLowerCase()]&&(e=c[b.getType()][b.getEventType().toLowerCase()]);break;case 7:switch(b.getDirection()){case "CONVERGING":e=c[b.getType()].converging;
break;case "DIVERGING":e=c[b.getType()].diverging;break;case "MIXED":e=c[b.getType()].mixed}break;case 9:c[b.getType()]&&c[b.getType()][b.getArtifactType().toLowerCase()]&&(e=c[b.getType()][b.getArtifactType().toLowerCase()])}b.attachErrorToShape(e)}return this};
var AdamMarker=function(a){jCore.Shape.call(this,a);this.positions="left top;center top;right top;left bottom;center bottom;right bottom".split(";");this.offset="5 5;0 5;0 0;5 -1;0 -1;-5 -1".split(";");this.markerType=null;AdamMarker.prototype.initObject.call(this,a)};AdamMarker.prototype=new jCore.Shape;AdamMarker.prototype.type="AdamMarker";
...
AdamMarker.prototype.setElementClass=function(a){this.setEClass(a);this.removeAllClasses();this.applyZoom();return this};
var AdamEvent=function(a){AdamShape.call(this,a);this.evn_marker=this.evn_type=this.evn_uid=null;this.evn_is_interrupting=!0;this.evn_attached_to=null;this.evn_cancel_activity=!1;this.evn_activity_ref=null;this.evn_wait_for_completion=!1;this.evn_behavior=this.evn_time_duration=this.evn_time_cycle=this.evn_time_date=this.evn_operation_implementation=this.evn_operation_name=this.evn_message=this.evn_condition=this.evn_escalation_code=this.evn_escalation_name=this.evn_error_code=this.evn_error_name=
null;this.numberRelativeToActivity=0;this.markersArray=new jCore.ArrayList;AdamEvent.prototype.initObject.call(this,a)};AdamEvent.prototype=new AdamShape;AdamEvent.prototype.type="AdamEvent";
...
AdamEvent.prototype.getContextMenu=function(){var a,b,c,d,e,g,h,f,k,r,s,t,n,l,p=this,w,u=[];w=this.createConfigureAction();new Action({text:translate("LBL_PMSE_CONTEXT_MENU_START_EVENT"),handler:function(){p.updateEventType("START")},disabled:"START"===this.evn_type});new Action({text:translate("LBL_PMSE_CONTEXT_MENU_INTERMEDIATE_EVENT"),handler:function(){p.updateEventType("INTERMEDIATE")},disabled:"INTERMEDIATE"===this.evn_type});new Action({text:translate("LBL_PMSE_CONTEXT_MENU_END_EVENT"),handler:function(){p.updateEventType("END")},
disabled:"END"===this.evn_type});a=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DELETE"),cssStyle:"adam-menu-icon-delete",handler:function(){var a;if(a=p.canvas.customShapes.find("id",p.id))a.canvas.emptyCurrentSelection(),a.canvas.addToSelection(a),a.canvas.removeElements()}});b=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_LEADS"),cssStyle:"adam-menu-icon-event-leads",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_message:"Leads",evn_behavior:"CATCH"})},disabled:"MESSAGE"===
this.evn_marker&&"CATCH"===this.evn_behavior&&"START"===this.evn_type&&"Leads"===this.evn_message});c=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_OPPORTUNITIES"),cssStyle:"adam-menu-icon-event-opportunities",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_message:"Opportunities",evn_behavior:"CATCH"})},disabled:"MESSAGE"===this.evn_marker&&"CATCH"===this.evn_behavior&&"START"===this.evn_type&&"Opportunities"===this.evn_message});d=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DOCUMENTS"),
cssStyle:"adam-menu-icon-event-documents",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_message:"Documents",evn_behavior:"CATCH"})},disabled:"MESSAGE"===this.evn_marker&&"CATCH"===this.evn_behavior&&"START"===this.evn_type&&"Documents"===this.evn_message});e=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_OTHER_MODULES"),handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_message:"",evn_behavior:"CATCH"})},disabled:"MESSAGE"===this.evn_marker&&"CATCH"===this.evn_behavior&&
"START"===this.evn_type&&(""===this.evn_message||null===this.evn_message)});g=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_RECEIVE_MESSAGE"),cssStyle:"adam-menu-icon-event-recive-message",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_behavior:"CATCH"})},disabled:"MESSAGE"===this.evn_marker&&"CATCH"===this.evn_behavior&&"INTERMEDIATE"===this.evn_type});h=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_SEND_MESSAGE"),cssStyle:"adam-menu-icon-event-send-message",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",
evn_behavior:"THROW"})},disabled:"MESSAGE"===this.evn_marker&&"THROW"===this.evn_behavior&&"INTERMEDIATE"===this.evn_type});f=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_TIMER"),cssStyle:"adam-menu-icon-event-timer",handler:function(){p.updateEventMarker({evn_marker:"TIMER",evn_behavior:"CATCH"})},disabled:"TIMER"===this.evn_marker&&"CATCH"===this.evn_behavior&&"INTERMEDIATE"===this.evn_type});k=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DO_NOTHING"),handler:function(){p.updateEventMarker({evn_marker:"EMPTY",
evn_behavior:"THROW"})},disabled:"EMPTY"===this.evn_marker&&"THROW"===this.evn_behavior&&"END"===this.evn_type});r=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_SEND_MESSAGE"),cssStyle:"adam-menu-icon-event-send-message",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_behavior:"THROW"})},disabled:"MESSAGE"===this.evn_marker&&"THROW"===this.evn_behavior&&"END"===this.evn_type});s=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_TERMINATE_PROCESS"),cssStyle:"adam-menu-icon-event-terminate-process",
handler:function(){p.updateEventMarker({evn_marker:"TERMINATE",evn_behavior:"THROW"})},disabled:"TERMINATE"===this.evn_marker&&"THROW"===this.evn_behavior&&"END"===this.evn_type});t=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_RECEIVE_MESSAGE"),cssStyle:"adam-menu-icon-event-recive-message",handler:function(){p.updateEventMarker({evn_marker:"MESSAGE",evn_behavior:"CATCH"})},disabled:"MESSAGE"===this.evn_marker&&"CATCH"===this.evn_behavior&&"BOUNDARY"===this.evn_type});n=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_TIMER"),
...
l.menu.items.push(h);l.menu.items.push(f);break;case "END":l.label=translate("LBL_PMSE_CONTEXT_MENU_RESULT");l.menu.items.push(k);l.menu.items.push(r);l.menu.items.push(s);break;case "BOUNDARY":l.label=translate("LBL_PMSE_CONTEXT_MENU_EVENT"),l.menu.items.push(t),l.menu.items.push(n)}l.icon="adam-menu-icon-convert";u.push(w,{jtype:"separator"});"START"!==this.evn_type&&u.push(l,{jtype:"separator"});u.push(a);return{items:u}};
...
AdamEvent.prototype.createConfigureAction=function(){var a,b,c,d,e,g,h,f=null,k=!1,r,s,t,n,l,p,w,u=this,x,y={},q,m,v,A,B;c=new SugarProxy({url:"pmse_Project/EventDefinition/"+this.id,uid:this.id,callback:null});if("START"===this.evn_type&&(""===this.evn_message||null===this.evn_message))h=!0;else switch(h=!1,this.evn_message){case "Leads":f="Leads";break;case "Opportunities":f="Opportunities";break;case "Documents":f="Documents"}switch(this.evn_type){case "START":A=new CriteriaField({name:"evn_criteria",
label:translate("LBL_PMSE_FORM_LABEL_CRITERIA"),required:!1,fieldWidth:250,fieldHeight:80,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,operators:{logic:!0,group:!0},constant:!1});q=new ComboboxField({jtype:"combobox",name:"evn_module",label:translate("LBL_PMSE_FORM_LABEL_MODULE"),required:!0,readOnly:!h,initialValue:f,helpTooltip:{message:translate("LBL_PMSE_FORM_TOOLTIP_EVENT_MODULE")},change:function(a,b,c){0<A.getItems().length?
r.show(b,c):A.setModuleEvaluation({dataURL:"pmse_Project/CrmData/related/"+this.value,dataRoot:"result",textField:"text",valueField:"value",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",fieldDataRoot:"result",fieldTextField:"text",fieldValueField:"value",fieldTypeField:"type"})},related:"modules",proxy:new SugarProxy({url:"pmse_Project/CrmData/related_modules/"+PROJECT_MODULE,uid:PROJECT_MODULE,callback:null})});d=[q,{jtype:"combobox",name:"evn_params",label:translate("LBL_PMSE_FORM_LABEL_APPLIES_TO"),
options:[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),value:""},{text:translate("LBL_PMSE_FORM_OPTION_NEW_RECORDS_ONLY"),value:"new"},{text:translate("LBL_PMSE_FORM_OPTION_UPDATED_RECORDS_ONLY"),value:"updated"}],required:!0,helpTooltip:{message:translate("LBL_PMSE_FORM_TOOLTIP_WHEN_START_EVENT")}},A];g=280;e=500;y={loaded:function(b){u.canvas.emptyCurrentSelection();q.proxy.getData(null,{success:function(b){q.setValue(u.evn_message||b.result[0].value||null);A.setModuleEvaluation({dataURL:"pmse_Project/CrmData/related/"+
q.value,dataRoot:"result",textField:"text",valueField:"value",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",fieldDataRoot:"result",fieldTextField:"text",fieldValueField:"value",fieldTypeField:"type"}).setUserEvaluation({defaultUsersDataURL:"pmse_Project/CrmData/defaultUsersList",defaultUsersDataRoot:"result",defaultUsersValueField:"value",userRolesDataURL:"pmse_Project/CrmData/rolesList",userRolesDataRoot:"result",usersDataURL:"pmse_Project/CrmData/users",usersDataRoot:"result",usersValueField:"value"});
App.alert.dismiss("upload");a.html.style.display="inline"}})}};r={_messagePanel:null,show:function(a,b){this._messagePanel=new MessagePanel({title:"Module change warning",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_REMOVE_ALL_START_CRITERIA"),buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_OK"),handler:function(){A.clear().setModuleEvaluation({dataURL:"pmse_Project/CrmData/related/"+a,dataRoot:"result",textField:"text",valueField:"value",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",
fieldDataRoot:"result",fieldTextField:"text",fieldValueField:"value",fieldTypeField:"type"});r.hide()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){q.setValue(b);r.hide()}}]});this._messagePanel.show()},hide:function(){this._messagePanel&&this._messagePanel.hide()}};break;case "INTERMEDIATE":"MESSAGE"===this.evn_marker&&("THROW"===this.evn_behavior?(m=new ComboboxField({jtype:"combobox",required:!0,name:"evn_criteria",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_TEMPLATE"),
proxy:new SugarProxy({url:"pmse_Project/CrmData/emailtemplates",uid:"",callback:null})}),q=new ComboboxField({jtype:"combobox",required:!0,name:"evn_module",label:translate("LBL_PMSE_FORM_LABEL_MODULE"),proxy:new SugarProxy({url:"pmse_Project/CrmData/modules",uid:"",callback:null}),change:function(){m.proxy.uid=this.value;m.proxy.url="pmse_Project/CrmData/emailtemplates/"+this.value;m.removeOptions();v=[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),value:""}];m.proxy.getData(null,{success:function(a){v=
v.concat(a.result);m.setOptions(v)}})}}),x=new HiddenField({name:"evn_params"}),d=function(){var a=this.parent,b={};b.to=a.items[2].getObject();b.cc=a.items[3].getObject();b.bcc=a.items[4].getObject();x.setValue(JSON.stringify(b))},d=[q,m,{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_TO"),name:"address_to",required:!0,submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",
suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_CC"),name:"address_cc",required:!1,submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_BCC"),name:"address_bcc",required:!1,
submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},x],g=380,e=500,y={loaded:function(c){var d=null,e,g=[];u.canvas.emptyCurrentSelection();if(c&&c.evn_params){try{d=JSON.parse(c.evn_params)}catch(h){}if(d){x.setValue(c.evn_params);for(e=0;e<b.items.length;e+=1)switch(b.items[e].name){case "address_to":b.items[e].setValue(d.to);
g.push(e);break;case "address_cc":b.items[e].setValue(d.cc);g.push(e);break;case "address_bcc":b.items[e].setValue(d.bcc),g.push(e)}}}q.proxy.getData(null,{success:function(b){b&&b.result&&(q.setOptions(b.result),q.setValue(c.evn_module||b.result[0]&&b.result[0].value||null));m.proxy.uid=q.value;m.proxy.url="pmse_Project/CrmData/emailtemplates/"+q.value;v=[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),value:""}];m.proxy.getData(null,{success:function(b){v=v.concat(b.result);m.setOptions(v);b&&b.result&&
m.setValue(c.evn_criteria||b.result[0]&&b.result[0].value||null);App.alert.dismiss("upload");a.html.style.display="inline"}})}});project.addMetadata("teams",{dataURL:project.getMetadata("teamsDataSource").url,dataRoot:project.getMetadata("teamsDataSource").root,success:function(a){var c;if(g.length)for(c=0;c<g.length;c+=1)b.items[g[c]].setTeamNameField("text"),b.items[g[c]].setTeams(a);else for(c=0;c<b.items.length;c+=1)switch(b.items[c].name){case "address_to":case "address_cc":case "address_bcc":b.items[c].setTeamNameField("text"),
b.items[c].setTeams(a)}}})},submit:function(a){}}):(d=[{jtype:"criteria",name:"evn_criteria",label:translate("LBL_PMSE_FORM_LABEL_CRITERIA"),required:!1,operators:{logic:!0,group:!0},constant:!1,evaluation:{module:{dataURL:"pmse_Project/CrmData/related/"+PROJECT_MODULE,dataRoot:"result",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",fieldDataRoot:"result"},user:{defaultUsersDataURL:"pmse_Project/CrmData/defaultUsersList",defaultUsersDataRoot:"result",userRolesDataURL:"pmse_Project/CrmData/rolesList",
userRolesDataRoot:"result",usersDataURL:"pmse_Project/CrmData/users",usersDataRoot:"result"}},decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator}],g=185,e=500,y={loaded:function(b){u.canvas.emptyCurrentSelection();App.alert.dismiss("upload");a.html.style.display="inline"}}));if("TIMER"===this.evn_marker){t=new HiddenField({name:"evn_timer_type"});p=new TextField({jtype:"text",name:"evn_duration_criteria",label:translate("LBL_PMSE_FORM_LABEL_DURATION"),
required:!0,helpTooltip:{message:translate("LBL_PMSE_FORM_TOOLTIP_DURATION")},fieldWidth:"50px"});w=new ComboboxField({name:"evn_duration_params",label:translate("LBL_PMSE_FORM_LABEL_UNIT"),options:[{text:translate("LBL_PMSE_FORM_OPTION_DAYS"),value:"day"},{text:translate("LBL_PMSE_FORM_OPTION_HOURS"),value:"hour"},{text:translate("LBL_PMSE_FORM_OPTION_MINUTES"),value:"minute"}],initialValue:"hour"});e=[];for(d=1;30>=d;d+=1)e.push({text:translate(d),value:d});new ComboboxField({name:"evn_cyclic_repeat_every",
label:translate("LBL_PMSE_LABEL_REPEATSEVERY"),options:e,initialValue:1,required:!0});new DateField({name:"evn_cyclic_date",label:translate("LBL_PMSE_LABEL_BEGINS"),required:!0,fieldWidth:"100px",readOnly:!0});n=new RadiobuttonField({jtype:"radio",name:"evn_timer_type",label:translate("LBL_PMSE_FORM_LABEL_DURATION"),value:!0,labelAlign:"right",onClick:function(a,b){t.setValue("duration");p.enable();w.enable();B.disable();B.clear();B.isValid()}});l=new RadiobuttonField({jtype:"radio",name:"evn_timer_type",
label:translate("LBL_PMSE_FORM_LABEL_FIXED_DATE"),reverse:!0,labelAlign:"right",onClick:function(a,b){t.setValue("fixed date");p.disable();w.disable();B.enable()}});B=new CriteriaField({name:"evn_criteria",label:translate("LBL_PMSE_LABEL_CRITERIA"),required:!1,fieldWidth:300,fieldHeight:80,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,operators:{arithmetic:["+","-"]},constant:{date:!0,timespan:!0},variable:{dataURL:project.getMetadata("fieldsDataSource").url.replace("{MODULE}",
project.process_definition.pro_module),dataRoot:project.getMetadata("fieldsDataSource").root,dataFormat:"hierarchical",dataChildRoot:"fields",textField:"text",valueField:"value",typeField:"type",typeFilter:["Date","Datetime"],moduleTextField:"text",moduleValueField:"value"},dateFormat:project.getMetadata("datePickerFormat")});new RadiobuttonField({jtype:"radio",name:"evn_timer_type",label:translate("LBL_PMSE_LABEL_CYCLIC"),reverse:!0,labelAlign:"right",onClick:function(a,b){t.setValue("cyclic");p.disable();
w.disable()}});d=[t,n,p,w,l,B];g=420;e=500;y={loaded:function(b){u.canvas.emptyCurrentSelection();switch(b.evn_params){case "fixed date":n.setValue(!1);l.setValue(!0);t.setValue("fixed date");p.disable();w.disable();B.enable();break;case "cyclic":t.setValue("cyclic");p.disable();w.disable();break;default:t.setValue("duration"),n.setValue(!0),l.setValue(!1),p.enable(),p.setValue(b.evn_criteria||""),w.enable(),w.setValue(b.evn_params||"minute"),B.disable()}App.alert.dismiss("upload");a.html.style.display=
"inline"},submit:function(a){}}}break;case "END":"MESSAGE"===this.evn_marker&&(m=new ComboboxField({jtype:"combobox",name:"evn_criteria",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_TEMPLATE"),proxy:new SugarProxy({url:"pmse_Project/CrmData/emailtemplates/",uid:"",callback:null})}),q=new ComboboxField({jtype:"combobox",required:!0,name:"evn_module",label:translate("LBL_PMSE_FORM_LABEL_MODULE"),proxy:new SugarProxy({url:"pmse_Project/CrmData/modules/",uid:"",callback:null}),change:function(){m.proxy.uid=
this.value;m.proxy.url="pmse_Project/CrmData/emailtemplates/"+this.value;m.removeOptions();v=[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),value:""}];m.proxy.getData(null,{success:function(a){v=v.concat(a.result);m.setOptions(v)}})}}),x=new HiddenField({name:"evn_params"}),d=function(){var a=this.parent,b={};b.to=a.items[2].getObject();b.cc=a.items[3].getObject();b.bcc=a.items[4].getObject();x.setValue(JSON.stringify(b))},d=[q,m,{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_TO"),
name:"address_to",required:!0,submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_CC"),name:"address_cc",required:!1,submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",
suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},{jtype:"emailpicker",label:translate("LBL_PMSE_FORM_LABEL_EMAIL_BCC"),name:"address_bcc",required:!1,submit:!1,fieldWidth:250,fieldHeight:50,change:d,suggestionItemName:"fullName",suggestionItemAddress:"emailAddress",suggestionDataURL:"pmse_Project/CrmData/emails/{$0}",suggestionDataRoot:"result",teams:project.getMetadata("teams")||[]},x],g=380,e=500,y={loaded:function(c){var d=null,e;u.canvas.emptyCurrentSelection();if(c&&c.evn_params){try{d=
JSON.parse(c.evn_params)}catch(g){}if(d){x.setValue(c.evn_params);for(e=0;e<b.items.length;e+=1)switch(b.items[e].name){case "address_to":b.items[e].setValue(d.to);break;case "address_cc":b.items[e].setValue(d.cc);break;case "address_bcc":b.items[e].setValue(d.bcc)}}}q.proxy.getData(null,{success:function(b){b&&b.result&&(q.setOptions(b.result),q.setValue(c.evn_module||b.result[0]&&b.result[0].value||null));m.proxy.uid=q.value;m.proxy.url="pmse_Project/CrmData/emailtemplates/"+q.value;v=[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),
value:""}];m.proxy.getData(null,{success:function(b){v=v.concat(b.result);m.setOptions(v);App.alert.dismiss("upload");a.html.style.display="inline"}})}})}})}b=new Form({proxy:c,closeContainerOnSubmit:!0,items:d,buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){$(".hasDatepicker").datepicker("hide");b.isDirty()?(s=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM"),
buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){s.close();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){s.close()}}]}),s.show()):a.close()}}],callback:y,language:PMSE_DESIGNER_FORM_TRANSLATIONS});a=new Window({width:e,height:g,modal:!0,title:translate("LBL_PMSE_FORM_TITLE_LABEL_EVENT")+": "+this.getName()});a.addPanel(b);"BOUNDARY"===this.evn_type&&(k=!0);"END"===this.evn_type&&"MESSAGE"!==this.evn_marker&&(k=!0);return new Action({text:translate("LBL_PMSE_CONTEXT_MENU_SETTINGS"),
cssStyle:"adam-menu-icon-configure",handler:function(){u.canvas.project.save();a.show();a.html.style.display="none";App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1})},disabled:k})};
AdamEvent.prototype.stringify=function(){var a=AdamShape.prototype.stringify.call(this),b={evn_marker:this.getEventMarker(),evn_message:this.getEventMessage(),evn_condition:this.evn_condition,evn_attached_to:this.evn_attached_to,evn_is_interrupting:this.evn_is_interrupting,evn_behavior:this.evn_behavior};$.extend(!0,a,b);return a};var AdamGateway;
AdamGateway=function(a){AdamShape.call(this,a);this.gat_default_flow=this.gat_waiting_for_start=this.gat_activation_count=this.gat_event_gateway_type=this.gat_instantiate=this.gat_direction=this.gat_type=this.gat_uid=null;this.markersArray=new jCore.ArrayList;AdamGateway.prototype.initObject.call(this,a)};AdamGateway.prototype=new AdamShape;AdamGateway.prototype.type="AdamGateway";
...
AdamGateway.prototype.getDirection=function(){return this.gat_direction};AdamGateway.prototype.getGatewayType=function(){return this.gat_type};
AdamGateway.prototype.getContextMenu=function(){var a,b,c,d,e,g;c="EXCLUSIVE"===this.gat_type;d="PARALLEL"===this.gat_type;e="INCLUSIVE"===this.gat_type;g="EVENTBASED"===this.gat_type;var h,f=this.getDestElements(),k=1<f.length?!1:!0,r=[],s,t=[],n=this,l,p,w,u,x;u="UNSPECIFIED"===this.gat_direction;x="DIVERGING"===this.gat_direction;var y="CONVERGING"===this.gat_direction;w="MIXED"===this.gat_direction;k=function(a){return function(){var b=new CommandDefaultFlow(n,a);b.execute();n.canvas.commandStack.add(b)}};
b=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DELETE"),cssStyle:"adam-menu-icon-delete",handler:function(){var a;if(a=n.canvas.customShapes.find("id",n.id))a.canvas.emptyCurrentSelection(),a.canvas.addToSelection(a),a.canvas.removeElements()}});a=this.createConfigureAction();c=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_EXCLUSIVE_GATEWAY"),cssStyle:"adam-menu-icon-gateway-exclusive",handler:function(){n.updateGatewayType("EXCLUSIVE")},disabled:c});d=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_PARELLEL_GATEWAY"),
cssStyle:"adam-menu-icon-gateway-parallel",handler:function(){n.updateGatewayType("PARALLEL")},disabled:d});e=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_INCLUSIVE_GATEWAY"),cssStyle:"adam-menu-icon-gateway-inclusive",handler:function(){n.updateGatewayType("INCLUSIVE")},disabled:e});g=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_EVENT_BASED_GATEWAY"),cssStyle:"adam-menu-icon-gateway-eventbase",handler:function(){n.updateGatewayType("EVENTBASED")},disabled:g});if(1<f.length){h=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_NONE"),
cssStyle:"adam-menu-icon-none",handler:k(""),disabled:0!==n.gat_default_flow?!1:!0});r.push(h);for(h=0;h<this.getPorts().getSize();h+=1)if(l=this.getPorts().get(h),p=l.connection,p.srcPort.parent.getID()===this.getID()){l=p.destPort.parent;switch(l.getType()){case "AdamActivity":s=""!==l.getName()?l.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_TASK");break;case "AdamEvent":s=""!==l.getName()?l.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_EVENT");break;case "AdamGateway":s=""!==l.getName()?
l.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_GATEWAY")}r.push(new Action({text:s,cssStyle:n.getCanvas().getTreeItem(l).icon,handler:k(p.getID()),disabled:n.gat_default_flow===p.getID()?!0:!1}))}k="PARALLEL"===this.gat_type||"EVENTBASED"===this.gat_type?!0:!1;h={label:translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_FLOW"),icon:"adam-menu-icon-default-flow",disabled:k,menu:{items:r}}}t.push(c);t.push(d);"CONVERGING"!==this.gat_direction&&(t.push(e),t.push(g));r={label:translate("LBL_PMSE_CONTEXT_MENU_CONVERT"),
icon:"adam-menu-icon-convert",menu:{items:t}};t=[];new Action({text:translate("LBL_PMSE_CONTEXT_MENU_UNSPECIFIED"),cssStyle:"adam-menu-icon-none",handler:function(){n.updateDirection("UNSPECIFIED")},disabled:u});u=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_CONVERGING"),cssStyle:"adam-menu-icon-gateway-converging",handler:function(){n.updateDirection("CONVERGING");n.cleanFlowConditions()},disabled:y});x=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DIVERGING"),cssStyle:"adam-menu-icon-gateway-diverging",
handler:function(){n.updateDirection("DIVERGING")},disabled:x});new Action({text:translate("LBL_PMSE_CONTEXT_MENU_MIXED"),cssStyle:"adam-menu-icon-gateway-mixed",handler:function(){n.updateDirection("MIXED")},disabled:w});w={label:translate("LBL_PMSE_CONTEXT_MENU_DIRECTION"),icon:"adam-menu-icon-gateway-direction",menu:{items:[u,x]}};1<f.length?(0<a.size&&t.push(a.action,{jtype:"separator"}),"EVENTBASED"!==this.getGatewayType()&&"INCLUSIVE"!==this.getGatewayType()&&t.push(w,{jtype:"separator"}),t.push(r,
{jtype:"separator"},h,{jtype:"separator"},b)):(0<a.size&&t.push(a.action,{jtype:"separator"}),"EVENTBASED"!==this.getGatewayType()&&"INCLUSIVE"!==this.getGatewayType()&&t.push(w,{jtype:"separator"}),t.push(r,{jtype:"separator"},b));return{items:t}};
AdamGateway.prototype.createConfigureAction=function(){var a,b,c,d,e,g=[],h=this.canvas,f=0,k,r,s,t=this,n,l;n=new SugarProxy({url:"pmse_Project/GatewayDefinition/"+this.id,uid:this.id,callback:null});b=new Window({width:750,height:500,modal:!0,title:translate("LBL_PMSE_FORM_TITLE_GATEWAY")+": "+this.getName()});for(d=0;d<this.getPorts().getSize();d+=1)e=this.getPorts().get(d).connection,this.gat_default_flow!==e.getID()&&(e.flo_element_origin===this.getID()&&"DEFAULT"!==e.flo_type)&&(f+=1);c=new Form({proxy:n,
buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){c.isDirty()?(s=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM"),buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){s.close();b.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){s.close()}}]}),s.show()):b.close()}}],callback:{submit:function(a,
c){var d=[];$.each(a,function(a,b){e=h.connections.find("id",a.split("-")[1]);e.setFlowCondition("[]"!==b?b:"");d.push({flo_uid:e.id,flo_condition:e.getFlowCondition()})});n.sendData(d);b.close()},loaded:function(a){t.canvas.emptyCurrentSelection();$(c.body).sortable({connectWith:".adam-field",stop:function(a,b){t.reorderItem(c,b.item.attr("id"))},start:function(a,b){var d,e;d=c.items;for(e=0;e<d.length;e+=1)d[e].closePanel();$(".multiple-item-panel").hide();$(c.body).css("cursor","move")}});$(c.body).on("mouseover",
".adam-field",function(a){$(c.body).sortable("enable");$(c.body).css("cursor","row-resize");a.stopPropagation()});$(c.body).on("mouseover",".multiple-item-container",function(a){$(c.body).sortable("disable");$(c.body).css("cursor","default");a.stopPropagation()});l=a.data;if(a&&a.data)for(d=0;d<l.length;d+=1)e=t.canvas.getConnections().find("id",l[d].flo_uid),k=e.getName()&&""!==e.getName()?e.getName():e.getDestPort().parent.getName(),r=translate("LBL_PMSE_FORM_LABEL_CRITERIA")+" ("+k+")",g.push({jtype:"criteria",
name:"condition-"+e.getID(),label:r,required:!1,value:e.getFlowCondition(),fieldWidth:288,fieldHeight:128,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,operators:{logic:!0,group:!0,aritmetic:!1,comparison:!1},evaluation:{module:{dataURL:"pmse_Project/CrmData/related/"+project.process_definition.pro_module,dataRoot:"result",fieldDataURL:"pmse_Project/CrmData/fields/{{MODULE}}",fieldDataRoot:"result",fieldTypeField:"type"},
form:{dataURL:"pmse_Project/CrmData/activities/"+project.uid,dataRoot:"result"},business_rule:{dataURL:"pmse_Project/CrmData/businessrules/"+project.uid,dataRoot:"result"},user:{defaultUsersDataURL:"pmse_Project/CrmData/defaultUsersList",defaultUsersDataRoot:"result",userRolesDataURL:"pmse_Project/CrmData/rolesList",userRolesDataRoot:"result",usersDataURL:"pmse_Project/CrmData/users",usersDataRoot:"result"}},constant:!1});c.setItems(g);for(d=0;d<c.items.length;d+=1)html=c.items[d].getHTML(),$(html).find("select, input, textarea").focus(c.onEnterFieldHandler(c.items[d])),
c.body.appendChild(html);c.proxy=null;App.alert.dismiss("upload");b.html.style.display="inline"}},language:PMSE_DESIGNER_FORM_TRANSLATIONS});b.addPanel(c);a="PARALLEL"===this.gat_type||"EVENTBASED"===this.gat_type||"CONVERGING"===this.gat_direction?!0:!1;a=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_SETTINGS"),cssStyle:"adam-menu-icon-configure",handler:function(){b.show();b.html.style.display="none";App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1})},disabled:a});return{size:f,
action:a}};AdamGateway.prototype.reorderItem=function(a,b){var c,d,e,g;for(c=0;c<a.items.length;c+=1)if(d=a.items[c],b===d.id){e=c;break}d=$(".adam-panel-body > div").map(function(){return this.id}).get();for(c=0;c<d.length;c+=1)if(b===d[c]){g=c;break}c=a.items[g];a.items[g]=a.items[e];a.items[e]=c};
...
AdamActivity.prototype.getContextMenu=function(){var a=this,b,c,d,e=this.getDestElements(),g=1<e.length?!1:!0,h,f=[],k,r,s,t,n=[],l,p,w,u,x,y;b=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_DELETE"),cssStyle:"adam-menu-icon-delete",handler:function(){var b;if(b=a.canvas.customShapes.find("id",a.id))b.canvas.emptyCurrentSelection(),b.canvas.addToSelection(b),b.canvas.removeElements()}});l=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_UNASSIGNED"),cssStyle:"adam-menu-script-none",handler:function(){a.updateScriptType("NONE")},
disabled:"NONE"===this.act_script_type});p=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_ASSIGN_USER"),cssStyle:"adam-menu-script-assign_user",handler:function(){a.updateScriptType("ASSIGN_USER")},disabled:"ASSIGN_USER"===this.act_script_type});w=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_ASSIGN_TEAM"),cssStyle:"adam-menu-script-assign_team",handler:function(){a.updateScriptType("ASSIGN_TEAM")},disabled:"ASSIGN_TEAM"===this.act_script_type});u=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_CHANGE_FIELD"),
cssStyle:"adam-menu-script-change_field",handler:function(){a.updateScriptType("CHANGE_FIELD")},disabled:"CHANGE_FIELD"===this.act_script_type});x=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_ADD_RELATED_RECORD"),cssStyle:"adam-menu-script-add_related_record",handler:function(){a.updateScriptType("ADD_RELATED_RECORD")},disabled:"ADD_RELATED_RECORD"===this.act_script_type});y=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_BUSINESS_RULE"),cssStyle:"adam-menu-script-business_rule",handler:function(){a.updateScriptType("BUSINESS_RULE")},
disabled:"BUSINESS_RULE"===this.act_script_type});c="USERTASK"===this.act_task_type?this.createConfigurateAction():this.actionFactory(this.act_script_type);d=this.createAssignUsersAction();if(1<e.length){s=function(b){return function(){var c=new CommandDefaultFlow(a,b);c.execute();a.canvas.commandStack.add(c)}};h=new Action({text:translate("LBL_PMSE_CONTEXT_MENU_NONE"),cssStyle:"adam-menu-icon-none",handler:s(""),disabled:0!==a.act_default_flow?!1:!0});f.push(h);for(h=0;h<this.getPorts().getSize();h+=
1)if(r=this.getPorts().get(h),t=r.connection,t.srcPort.parent.getID()===this.getID()){r=t.destPort.parent;switch(r.getType()){case "AdamActivity":k=""!==r.getName()?r.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_TASK");break;case "AdamEvent":k=""!==r.getName()?r.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_EVENT");break;case "AdamGateway":k=""!==r.getName()?r.getName():translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_GATEWAY")}f.push(new Action({text:k,cssStyle:a.getCanvas().getTreeItem(r).icon,
handler:s(t.getID()),disabled:a.act_default_flow===t.getID()?!0:!1}))}s={label:translate("LBL_PMSE_CONTEXT_MENU_DEFAULT_FLOW"),icon:"adam-menu-icon-default-flow",disabled:g,menu:{items:f}}}c=[c];"USERTASK"===this.act_task_type&&c.push({jtype:"separator"},d);c.push({jtype:"separator"});"SCRIPTTASK"===this.act_task_type&&(n.push(l),n.push(y),n.push(p,w,u,x),c.push({label:translate("LBL_PMSE_CONTEXT_MENU_ACTION_TYPE"),icon:"adam-menu-icon-convert",menu:{items:n}},{jtype:"separator"}));1<e.length&&"USERTASK"===
this.act_task_type?c.push(s,{jtype:"separator"},b):c.push(b);return{items:c}};AdamActivity.prototype.updateDefaultFlow=function(a){this.act_default_flow=a;return this};AdamActivity.prototype.updateTaskType=function(a){var b;b=this.getMarkers().get(0);a=new AdamShapeMarkerCommand(this,{markers:[b],type:"changeactivitymarker",changes:{taskType:a}});a.execute();this.canvas.commandStack.add(a);return this};
...
AdamActivity.prototype.createConfigurateAction=function(){var a,b,c,d=this,e,g,h,f=this,k=translate("LBL_PMSE_CONTEXT_MENU_FORMS"),r,s,t,n,l,p,w,u,x,y,q,m,v,A,B,C,z;z=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM")});a=new Window({width:510,height:"USERTASK"===this.act_task_type?340:150,modal:!0,title:translate("LBL_PMSE_FORM_TITLE_ACTIVITY")+": "+this.getName()});"USERTASK"===this.act_task_type?(s="adam-menu-icon-form",e=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+
this.id,uid:this.id,callback:null,data2:{hola:"hola"}}),g=new ItemMatrixField({jtype:"itemmatrix",label:translate("LBL_PMSE_FORM_LABEL_READ_ONLY_FIELDS"),name:"act_readonly_fields",submit:!0,fieldWidth:350,fieldHeight:200,visualStyle:"table",nColumns:2}),c=new Form({items:[g],closeContainerOnSubmit:!0,labelWidth:"16%",buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){c.isDirty()?(z.setButtons([{jtype:"normal",
caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){z.hide();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){z.hide()}}]),z.show()):a.close()}}],language:PMSE_DESIGNER_FORM_TRANSLATIONS}),g=new ItemMatrixField({jtype:"itemmatrix",label:translate("LBL_PMSE_FORM_LABEL_REQUIRED_FIELDS"),name:"act_required_fields",submit:!0,fieldWidth:350,fieldHeight:200,visualStyle:"table",nColumns:2}),y=new Form({items:[g],closeContainerOnSubmit:!0,labelWidth:"16%",buttons:[{jtype:"submit",
caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){c.isDirty()?(z.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){z.hide();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){z.hide()}}]),z.show()):a.close()}}]}),q=new Form({closeContainerOnSubmit:!0,labelWidth:"100%",buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),
handler:function(){c.isDirty()?(z.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){z.hide();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){z.hide()}}]),z.show()):a.close()}}]}),v=new HiddenField({name:"act_expected_time"}),m=function(){var a={time:"",unit:""};a.time=A.value;a.unit=B.value;v.setValue(a)},A=new NumberField({name:"evn_criteria",label:translate("LBL_PMSE_FORM_LABEL_DURATION"),helpTooltip:{message:translate("LBL_PMSE_FORM_TOOLTIP_DURATION")},
fieldWidth:"50px",submit:!1,change:m}),B=new ComboboxField({name:"evn_params",label:translate("LBL_PMSE_FORM_LABEL_UNIT"),options:[{text:translate("LBL_PMSE_FORM_OPTION_DAYS"),value:"day"},{text:translate("LBL_PMSE_FORM_OPTION_HOURS"),value:"hour"},{text:translate("LBL_PMSE_FORM_OPTION_MINUTES"),value:"minute"}],initialValue:"hour",submit:!1,change:m}),g=[v,A,B],C=new Form({items:g,closeContainerOnSubmit:!0,buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),
handler:function(){C.isDirty()?(z.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){z.hide();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){z.hide()}}]),z.show()):a.close()}}],language:PMSE_DESIGNER_FORM_TRANSLATIONS}),h=function(){switch(this.name){case "combo_teams":n.setValue(l.value);break;case "combo_teams_1":n.setValue(p.value)}},r=new ComboboxField({name:"act_type",label:translate("LBL_PMSE_FORM_LABEL_FORM_TYPE"),
required:!1,proxy:new SugarProxy({url:"pmse_Project/CrmData/dynaforms/"+adamUID,uid:adamUID,callback:null})}),t=new ComboboxField({name:"act_response_buttons",label:translate("LBL_PMSE_FORM_LABEL_RESPONSE_BUTTONS"),required:!1}),g=new LabelField({name:"lblAssigment",label:translate("LBL_PMSE_FORM_LABEL_OTHER_DERIVATION_OPTIONS"),options:{marginLeft:35}}),u=new CheckboxField({name:"act_reassign",label:translate("LBL_PMSE_FORM_LABEL_RECORD_OWNERSHIP"),required:!1,value:!1,options:{labelAlign:"right",
marginLeft:80},change:function(){$(u.html).children("input").is(":checked")?l.setReadOnly(!1):l.setReadOnly(!0)}}),l=new ComboboxField({name:"act_reassign_team",label:translate("LBL_PMSE_FORM_LABEL_TEAM"),required:!1,readOnly:!0,change:h,proxy:new SugarProxy({url:"pmse_Project/CrmData/teams/reassign",uid:"reassign",callback:null})}),x=new CheckboxField({name:"act_adhoc",label:translate("LBL_PMSE_FORM_LABEL_REASSIGN"),required:!1,value:!1,options:{labelAlign:"right",marginLeft:80},change:function(){$(x.html).children("input").is(":checked")?
p.setReadOnly(!1):p.setReadOnly(!0)}}),p=new ComboboxField({name:"act_adhoc_team",label:translate("LBL_PMSE_FORM_LABEL_TEAM"),required:!1,readOnly:!0,change:h}),w=new ComboboxField({name:"act_adhoc_behavior",label:translate("LBL_PMSE_FORM_LABEL_TYPE"),required:!1,readOnly:!0}),n=new HiddenField({name:"act_adhoc_reassign_team"}),new HiddenField({name:"act_reassignment_type"}),actTypeField=new HiddenField({name:"act_type"}),g=[t,g,u,l,x,p,actTypeField],h={submit:function(a){a=c.getData();var d=b.getData(),
g=C.getData(),h=y.getData();q.getData();a.act_readonly_fields=JSON.parse(a.act_readonly_fields);h.act_required_fields=JSON.parse(h.act_required_fields);$.extend(!0,d,a);$.extend(!0,d,g);$.extend(!0,d,h);e.sendData(d)},loaded:function(g){var h=[],f=[{text:translate("LBL_PMSE_FORM_OPTION_APPROVE_REJECT"),value:"APPROVE"},{text:translate("LBL_PMSE_FORM_OPTION_ROUTE"),value:"ROUTE"}],k=[{text:translate("LBL_PMSE_FORM_OPTION_ONE_WAY"),value:"ONE_WAY"},{text:translate("LBL_PMSE_FORM_OPTION_ROUND_TRIP"),
value:"ROUND_TRIP"}],s=c.items[0],n=y.items[0],q,v=[],C=[],z=[],D=[];e.getData({module:PROJECT_MODULE},{success:function(c){d.canvas.emptyCurrentSelection();for(q=0;q<c.act_readonly_fields.length;q+=1)z.push({text:c.act_readonly_fields[q].label,value:c.act_readonly_fields[q].name}),c.act_readonly_fields[q].readonly&&v.push(c.act_readonly_fields[q].name);s.getHTML();s.setList(z,v);for(q=0;q<c.act_required_fields.length;q+=1)D.push({text:c.act_required_fields[q].label,value:c.act_required_fields[q].name}),
c.act_required_fields[q].required&&C.push(c.act_required_fields[q].name);n.getHTML();n.setList(D,C);r.proxy.getData(null,{success:function(a){h=h.concat(a.result);r.setOptions(h)}});l.proxy.getData(null,{success:function(b){l.setOptions(b.result);p.setOptions(b.result);App.alert.dismiss("upload");a.html.style.display="inline"}});t.setOptions(f);w.setOptions(k);u.setValue(!1);x.setValue(!1);c&&(c.act_expected_time&&(A.setValue(c.act_expected_time.time),B.setValue(c.act_expected_time.unit),m()),c.act_type&&
(r.setValue(c.act_type),actTypeField.setValue(c.act_type)),c.act_response_buttons&&t.setValue(c.act_response_buttons),c.act_reassign&&"1"===c.act_reassign&&(u.setValue(!0),$(u.html).children("input").prop("checked",!0),l.setReadOnly(!1),c.act_reassign_team&&(l.setValue(c.act_reassign_team),$(l.html).children("select").val(c.act_reassign_team))),c.act_adhoc&&"1"===c.act_adhoc&&(x.setValue(!0),$(x.html).children("input").prop("checked",!0),p.setReadOnly(!1),c.act_adhoc_team&&(p.setValue(c.act_adhoc_team),
$(p.html).children("select").val(c.act_adhoc_team))),b.proxy=null)}})}},c.setCallback({submit:h.submit}),C.setCallback({submit:h.submit}),y.setCallback({submit:h.submit}),q.setCallback({submit:h.submit})):(s="adam-menu-icon-configure",e=null,k="Configuration...",g=[{jtype:"textarea",required:!1,fieldWidth:"250px",fieldHeight:"100px",label:translate("LBL_PMSE_FORM_LABEL_SCRIPT"),name:"act_script",helpTooltip:{message:"Enter the PHP code script"}}],h={submit:function(a){f.act_script!==a.act_script&&
f.updateScript(a.act_script)},loaded:function(){d.canvas.emptyCurrentSelection();var a={};a.act_script=f.act_script;b.data=a;b.applyData(!0)}});b=new Form({items:g,closeContainerOnSubmit:!0,buttons:[{jtype:"submit",caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){b.isDirty()?(z.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){z.hide();a.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),
handler:function(){z.hide()}}]),z.show()):a.close()}}],callback:h,language:PMSE_DESIGNER_FORM_TRANSLATIONS});a.addPanel({title:translate("LBL_PMSE_FORM_LABEL_GENERAL_SETTINGS"),panel:b});c&&a.addPanel({title:translate("LBL_PMSE_FORM_LABEL_READ_ONLY_FIELDS"),panel:c});y&&a.addPanel({title:translate("LBL_PMSE_FORM_LABEL_REQUIRED_FIELDS"),panel:y});C&&a.addPanel({title:translate("LBL_PMSE_FORM_LABEL_EXPECTED_TIME"),panel:C});return new Action({text:k,cssStyle:s,handler:function(){d.canvas.project.save();
a.show();a.html.style.display="none";App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1})},disabled:!1})};AdamActivity.prototype.updateScript=function(a){a=new CommandAdam(this,["act_script"],[a]);a.execute();this.canvas.commandStack.add(a);return this};
AdamActivity.prototype.createAssignUsersAction=function(){var a=this,b,c,d,e,g,h,f,k,r,s;s=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM")});r=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null});k=function(){switch(this.name){case "combo_teams":e.setValue(h.value);d.setValue(null);break;case "combo_users":e.setValue(null),d.setValue(g.value)}};e=new HiddenField({name:"act_assign_team"});d=new HiddenField({name:"act_assign_user"});
...
caption:translate("LBL_PMSE_BUTTON_SAVE")},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){c.isDirty()?(s.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){s.hide();b.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){s.hide()}}]),s.show()):b.close()}}],callback:{submit:function(a){fData=c.getData();r.sendData(fData)},loaded:function(k){r.getData({module:PROJECT_MODULE},{success:function(k){var s=
[{text:translate("LBL_PMSE_FORM_OPTION_CURRENT_USER"),value:"currentuser"},{text:translate("LBL_PMSE_FORM_OPTION_RECORD_OWNER"),value:"owner"},{text:translate("LBL_PMSE_FORM_OPTION_SUPERVISOR"),value:"supervisor"}];a.canvas.emptyCurrentSelection();h.proxy.getData(null,{success:function(a){h.setOptions(a.result);e.setValue(k.act_assign_team||a.result[0].value)}});g.proxy.getData(null,{success:function(a){s=s.concat(a.result);g.setOptions(s);App.alert.dismiss("upload");b.html.style.display="inline";
d.setValue(k.act_assign_user||s[0].value)}});k&&(f.setValue(k.act_assignment_method),"static"===k.act_assignment_method?(g.setValue(k.act_assign_user),g.setReadOnly(!1),h.setReadOnly(!0)):(h.setValue(k.act_assign_team),g.setReadOnly(!0),h.setReadOnly(!1)));c.proxy=null}})}},language:PMSE_DESIGNER_FORM_TRANSLATIONS});b=new Window({width:500,height:350,title:translate("LBL_PMSE_FORM_TITLE_USER_DEFINITION")+": "+this.getName(),modal:!0});b.addPanel(c);return new Action({text:translate("LBL_PMSE_CONTEXT_MENU_USERS"),
...
AdamActivity.prototype.actionFactory=function(a){var b,c,d=this,e,g,h=null,f=[],k={},r=!1,s="",t,n,l="30%",p,w,u,x,y,q,m,v;q=new MessagePanel({title:"Confirm",wtype:"Confirm",message:translate("LBL_PMSE_MESSAGE_CANCEL_CONFIRM")});switch(a){case "NONE":b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS");r=!0;c="adam-menu-icon-configure";break;case "ASSIGN_USER":p=new ComboboxField({jtype:"combobox",label:translate("LBL_PMSE_FORM_LABEL_ASSIGN_TO_USER"),name:"act_assign_user",submit:!0,proxy:new SugarProxy({url:"pmse_Project/CrmData/users",
uid:null,callback:null}),required:!0});v=new CheckboxField({name:"act_update_record_owner",label:translate("LBL_PMSE_FORM_LABEL_UPDATE_RECORD_OWNER"),required:!1,value:!1,options:{labelAlign:"right",marginLeft:80}});h=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null});f=[p,v];t=500;n=160;b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS");c="adam-menu-icon-configure";k={loaded:function(a){var b=[{text:"Select...",value:""}];d.canvas.emptyCurrentSelection();p.proxy.getData(null,
{success:function(c){b=b.concat(c.result);p.setOptions(b);a&&(p.setValue(a.act_assign_user||b[0].value),a.act_update_record_owner&&1==a.act_update_record_owner&&(v.setValue(!0),$(v.html).children("input").prop("checked",!0)));App.alert.dismiss("upload");e.html.style.display="inline"}})}};s=translate("LBL_PMSE_FORM_TITLE_ASSIGN_USER")+": "+this.getName();break;case "ASSIGN_TEAM":w=new ComboboxField({jtype:"combobox",label:translate("LBL_PMSE_FORM_LABEL_ASSIGN_TO_TEAM"),name:"act_assign_team",submit:!0,
...
value:"selfservice"}],initialValue:"balanced",editable:!1,readOnly:!0});b=new HiddenField({name:"act_assignment_method",initialValue:"balanced"});h=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null});f=[w,v,b];t=500;n=160;b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS");c="adam-menu-icon-configure";k={loaded:function(a){d.canvas.emptyCurrentSelection();w.proxy.getData(null,{success:function(b){w.setOptions(b.result);a&&(w.setValue(a.act_assign_team||b.result[0].value),
a.act_update_record_owner&&1==a.act_update_record_owner&&(v.setValue(!0),$(v.html).children("input").prop("checked",!0)));App.alert.dismiss("upload");e.html.style.display="inline"}})}};s=translate("LBL_PMSE_FORM_TITLE_ASSIGN_TEAM")+": "+this.getName();break;case "CHANGE_FIELD":l="20%";b=function(){App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1});m.proxy.url="pmse_Project/CrmData/fields/"+u.value;m.proxy.getData(null,{success:function(a){App.alert.dismiss("upload");a&&m.setOptions(a.result,
!0)}})};u=new ComboboxField({label:translate("LBL_PMSE_FORM_LABEL_MODULE"),name:"act_field_module",submit:!0,change:b,proxy:new SugarProxy({url:"pmse_Project/CrmData/related/"+PROJECT_MODULE,uid:PROJECT_MODULE,callback:null})});m=new UpdaterField({label:translate("LBL_PMSE_FORM_LABEL_FIELDS"),name:"act_fields",submit:!0,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,proxy:new SugarProxy({url:"pmse_Project/CrmData/fields/"+
PROJECT_MODULE,uid:null,callback:null}),fieldWidth:470,fieldHeight:260,hasCheckbox:!0});t=670;n=400;b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS");c="adam-menu-icon-configure";f=[u,m];h=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null});s=translate("LBL_PMSE_FORM_TITLE_CHANGE_FIELDS")+": "+this.getName();k={loaded:function(a){d.canvas.emptyCurrentSelection();u.proxy.getData(null,{success:function(b){b&&b.success&&(u.setOptions(b.result),x=m.proxy.uid=PROJECT_MODULE,
m.proxy.url="pmse_Project/CrmData/fields/"+x,m.proxy.getData(null,{success:function(b){b&&(m.setVariables(b.result),m.setOptions(b.result,!0),m.setValue(a.act_fields||null),App.alert.dismiss("upload"),e.html.style.display="inline")}}))}})}};break;case "ADD_RELATED_RECORD":l="20%";b=function(){App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1});m.proxy.uid=u.value;m.proxy.url="pmse_Project/CrmData/addRelatedRecord/"+u.value;m.proxy.getData(null,{success:function(a){App.alert.dismiss("upload");
a&&m.setOptions(a.result,!0)}})};u=new ComboboxField({jtype:"combobox",label:translate("LBL_PMSE_FORM_LABEL_RELATED_MODULE"),name:"act_field_module",submit:!0,change:b,proxy:new SugarProxy({url:"pmse_Project/CrmData/related/"+PROJECT_MODULE,uid:PROJECT_MODULE,callback:null})});m=new UpdaterField({label:translate("LBL_PMSE_FORM_LABEL_FIELDS"),name:"act_fields",submit:!0,decimalSeparator:SUGAR.App.config.defaultDecimalSeparator,numberGroupingSeparator:SUGAR.App.config.defaultNumberGroupingSeparator,
proxy:new SugarProxy({url:"pmse_Project/CrmData/addRelatedRecord/"+PROJECT_MODULE,uid:null,callback:null}),fieldWidth:470,fieldHeight:260});t=680;n=420;b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS");c="adam-menu-icon-configure";f=[u,m];h=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null});s=translate("LBL_PMSE_FORM_TITLE_ADD_RELATED_RECORD")+": "+this.getName();k={loaded:function(a){d.canvas.emptyCurrentSelection();u.proxy.getData(null,{success:function(b){b&&
b.success&&(u.setOptions(b.result),x=a.act_field_module||b.result[0].value,m.proxy.uid=PROJECT_MODULE,m.proxy.url="pmse_Project/CrmData/addRelatedRecord/"+x,m.proxy.getData(null,{success:function(b){m.setOptions(b.result);m.setVariables(b.result);m.setValue(a.act_fields||null);App.alert.dismiss("upload");e.html.style.display="inline"}}))}})}};break;case "BUSINESS_RULE":y=new ComboboxField({label:translate("LBL_PMSE_LABEL_RULE"),name:"act_fields",submit:!0,proxy:new SugarProxy({url:"pmse_Project/CrmData/rulesets/"+
adamUID,uid:adamUID,callback:null})}),h=new HiddenField({name:"act_field_module",initialValue:PROJECT_MODULE}),t=500,n=140,b=translate("LBL_PMSE_CONTEXT_MENU_SETTINGS"),c="adam-menu-icon-configure",f=[y,h],h=new SugarProxy({url:"pmse_Project/ActivityDefinition/"+this.id,uid:this.id,callback:null}),s=translate("LBL_PMSE_FORM_TITLE_BUSINESS_RULE")+": "+this.getName(),k={loaded:function(a){var b=[{text:translate("LBL_PMSE_FORM_OPTION_SELECT"),value:"",selected:!0}];d.canvas.emptyCurrentSelection();y.proxy.getData(null,
{success:function(c){c&&c.success&&(b=b.concat(c.result),y.setOptions(b),a&&y.setValue(a.act_fields||""));App.alert.dismiss("upload");e.html.style.display="inline"}})}}}g=new Form({proxy:h,items:f,closeContainerOnSubmit:!0,buttons:[{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_SAVE"),handler:function(){g.submit()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_CANCEL"),handler:function(){g.isDirty()?(q.setButtons([{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_YES"),handler:function(){q.hide();
e.close()}},{jtype:"normal",caption:translate("LBL_PMSE_BUTTON_NO"),handler:function(){q.hide()}}]),q.show()):e.close()}}],labelWidth:l,callback:k,language:PMSE_DESIGNER_FORM_TRANSLATIONS});e=new Window({width:t,height:n,title:s,modal:!0});e.addPanel(g);return new Action({text:b,cssStyle:c,handler:function(){d.canvas.project.save();e.show();e.html.style.display="none";App.alert.show("upload",{level:"process",title:"LBL_LOADING",autoclose:!1})},disabled:r})};
var AdamArtifact=function(a){AdamShape.call(this,a);this.art_category_ref=this.art_uid=this.art_type=null;AdamArtifact.prototype.initObject.call(this,a)};AdamArtifact.prototype=new AdamShape;AdamArtifact.prototype.type="AdamArtifact";AdamArtifact.prototype.adamArtifactResizeBehavior=null;
AdamArtifact.prototype.resizeBehaviorFactory=function(a){return"adamArtifactResize"===a?(this.adamArtifactResizeBehavior||(this.adamArtifactResizeBehavior=new AdamArtifactResizeBehavior),this.adamArtifactResizeBehavior):AdamShape.prototype.resizeBehaviorFactory.call(this,a)};
...
CommandDefaultFlow.prototype.execute=function(){var a,b,c,d;this.receiver.setDefaultFlow(""===this.after.defaultDestID?0:this.after.defaultDestID);if(!this.after.connections){this.after.connections=[];b=this.receiver.getPorts();c=b.getSize();for(a=0;a<c;a+=1)d=b.get(a).connection,this.after.connections.push({id:d.getID(),condition:d.getFlowCondition(),type:d.getFlowType()})}this.fireTrigger()};
...
"AdamActivity"===this.srcShape.type?this.srcShape[this.prefix[this.srcShape.type]+"_default_flow"]:"";this.condition=this.after.type=null;this.after.defaultFlow=""};c.prototype.fireTrigger=function(a){var b=[],c=this.receiver.connection,h,f,k;if("DEFAULT"===this.after.type||"DEFAULT"===this.before.type)b.push({id:this.srcShape.getID(),relatedObject:this.srcShape,type:this.srcShape.type,fields:[{field:"default_flow",newVal:this.srcShape[this.prefix[this.srcShape.type]+"_default_flow"],oldVal:a?this.after.defaultFlow:
...
Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return d.init.apply(this,arguments);a.error("Method "+b+" does not exsts!");return!0}})(jQuery);
(function(a){var b={id:null,rows:[],width:"100%",fontSize:"11px",prefix:"progrid",onValueChanged:null,onChangeDiscarded:null,onViewMode:null,onEditMode:null,onRowsInitialized:null,onRowSelected:null,onRowDeselected:null,onGridReady:null},c=0,d=function(b,c){b.name||a.error("name setting is required!");var d=a.extend({label:"",type:"",readOnly:!1,trueLabel:"true",falseLabel:"false",yesNoValueMode:"boolean",validate:"none"},b),e={name:d.name,label:d.label,type:d.type,readOnly:d.readOnly},g=null,f=null,
h=null,w=function(b){"undefined"===typeof b||b?(a(g).find("td").on("selectRow",x),a(g).on("click",function(){a(this).find("td:last").trigger("selectRow")})):(a(g).find("td").off("selectRow",x),a(g).off("click"))},u=function(b){if("undefined"===typeof b||b)a(g).find("td").on("focusout",y);else a(g).find("td").off("focusout",y)},x=function(){var b=a(this).parent().data("rowObject");w(!1);"function"===typeof b.onSelected&&b.onSelected.call(b);b.readOnly?a(g).find("td:last div").focus():b.editMode();
u()},y=function(){var b=a(this).parent().data("rowObject");u(!1);b.editMode(!1,!1);w();"function"===typeof b.onRowDeselected&&b.onRowDeselected.call(b)},q=function(){a(this.getHTML()).find("td:last div").on("focus",function(){a(this.parentNode).trigger("selectRow")}).on("keydown",function(b){b.stopPropagation();13===b.keyCode&&a(this.parentNode).trigger("selectRow")})},m=function(){var b=a(g).find("td:last > *").val();switch(this.type){case "text":b="integer"===d.validate?parseInt(b,10):b;break;case "yesNo":switch(d.yesNoValueMode){case "int":b=
parseInt(b,10);break;case "boolean":b="true"===b?!0:!1}}return b},v=function(){if(!this.readOnly){var a=m.call(this),b=this.getValue();this.editMode(!1);"function"===typeof this.onChangeDiscarded&&a!==b&&this.onChangeDiscarded.call(this,{valueDiscarded:a,currentValue:b})}};e.onValueChanged=null;e.onSelected=null;e.onEditMode=null;e.onViewMode=null;e.onChangeDiscarded=null;e.onRowDeselected=null;e.getValue=function(){return f};e.updateValueText=function(){h=this.getValue();switch(this.type){case "text":h=
f.toString();break;case "yesNo":h=f?d.trueLabel:d.falseLabel;break;case "select":if(!d.options){h="";break}for(i=0;i<d.options.length;i++)if(d.options[i].value===h){h=d.options[i].label;break}}};e.getValueText=function(){return h};e.getHTML=function(){if(!g){var b=this.getValueText();g=document.createElement("tr");a(g).append('<td class="'+c+'-first-col"><div style="width:0px">'+this.label+'</div></td><td class="'+c+'-second-col"><div tabindex="0" style="width:0px">'+(b?b:"")+"</div></td>");a(g).data("rowObject",
this);w(!0);q.call(this)}return g};e.save=function(){if(!d.readOnly){var a=this.getValue(),b=m.call(this);"integer"===d.validate&&"text"===this.type&&(a=parseInt(a,10));if(b!==a&&(f=b,this.updateValueText(),"function"===typeof this.onValueChanged))this.onValueChanged({row:this,newValue:b,previousValue:a});this.editMode(!1)}};e.editMode=function(b,c){var e,h,k=this;h=a(g.parentNode).width();var r=parseInt(a(g).css("font-size"),10);h=h/2-1.82*r;if("undefined"===typeof b||b){switch(this.type){case "text":e=
...
e.append(a('<option label="'+name+'" value="'+this.options[i].value+'" '+(this.options[i].value===this.getValue()?'selected="selected"':"")+" "+(this.options[i].disabled?"disabled":"")+" >"+name+"</option>"));break;case "yesNo":"string"===typeof f?(h=f,h="true"===h?!0:!1):h=!!f,e=a("<select>").css({width:"100%"}),e.append(a('<option label="'+d.trueLabel+'" value="'+("int"===d.yesNoValueMode?1:"true")+'" '+(h?'selected="selected"':"")+">"+d.trueLabel+"</option>")),e.append(a('<option label="'+d.falseLabel+
'" value="'+("int"===d.yesNoValueMode?0:"false")+'" '+(!h?'selected="selected"':"")+">"+d.falseLabel+"</option>"))}e.on("focusout",function(){k.save()}).on("click",function(a){a.stopPropagation()}).on("keydown",function(a){a.stopPropagation();13===a.keyCode?k.save():27===a.keyCode&&v.call(k)});try{a(g).find("td:last").empty()}catch(m){}a(g).find("td:last").append(e);e.focus();"function"===typeof this.onEditMode&&this.onEditMode.call(this);e.select()}else{try{a(g).find("td:last").empty()}catch(t){}a(g).find("td:last").append(a('<div tabindex="0" style="width: '+
h+'px">'+this.getValueText()+"</div>"));("undefined"===typeof c||c)&&a(g).find("td:last div").focus();q.call(this);"function"===typeof this.onViewMode&&this.onViewMode.call(this)}};c=c||"progrid";"select"===e.type&&(e.options=b.options||[]);switch(e.type){case "text":f="undefined"!==typeof d.value&&null!==d.value&&("int"!==d.validate?d.value.toString():parseInt(d.value,10))||"";break;case "select":if(!d.options){f=null;break}for(i=0;i<d.options.length;i++)if("boolean"===typeof d.options[i].selected&&
d.options[i].selected||"boolean"!==typeof d.options[i].selected&&d.options[i].selected===d.options[i].value){f=d.options[i].value;break}null===f&&d.options[0]&&(f=d.options&&d.options[0].value||null);break;case "yesNo":switch("string"===typeof d.value?(f=d.value.toLowerCase(),f="true"===f?!0:!1):f=!!d.value,d.yesNoValueMode){case "int":f=f?1:0;break;case "literal":f=f?"true":"false"}}e.updateValueText();return e},e=function(b){if("undefined"!==typeof b){var c=parseInt(a(this).find("table.progrid-table").css("font-size"));
isNaN(c)&&(c=0);b=a(this).find("table").find("td div").css({width:"0px"}).end().css({width:b}).width();b=b/2-1.82*c;a(this).find("td div").css({width:b})}},g=function(b){var c,d=!1,e=this.find("tr"),g;for(c=0;c<e.length;c++){for(g=a(e[c]).data("rowObject").label;0<g.length;){if(""===b.label||b.label.charAt(0)<g.charAt(0))d=!0;break}if(d)break}e[c]?a(e[c]).before(b.getHTML()):this.append(b.getHTML())},h=function(b){var e=a(this),f=a(document.createElement("table")),h,n,l;f.css({width:b.width,"font-size":b.fontSize}).addClass("progrid-table").attr({id:b.prefix+
"-propTable-"+c,cellpadding:0,cellspacing:0,border:0});f.append(a("<thead>").append(a("<tr>").append("<th>Name</th>").append("<th>Value</th>")));l=a("<tbody>");for(h=0;h<b.rows.length;h++)n=d(b.rows[h]),n.onSelected=function(){a(this.getHTML()).addClass("row_selected");"function"===typeof b.onRowSelected&&b.onRowSelected.call(e.get(0),{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,value:this.getValue()})},n.onViewMode=function(){"function"===typeof b.onViewMode&&b.onViewMode.call(e.get(0),
{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,value:this.getValue()})},n.onEditMode=function(){"function"===typeof b.onEditMode&&b.onEditMode.call(e.get(0),{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,value:this.getValue()})},n.onRowDeselected=function(){a(this.getHTML()).removeClass("row_selected");"function"===typeof b.onRowDeselected&&b.onRowDeselected.call(e.get(0),{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,value:this.getValue()})},
n.onChangeDiscarded=function(a){"function"===typeof b.onChangeDiscarded&&b.onChangeDiscarded.call(e.get(0),{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,currentValue:a.currentValue,discardedValue:a.valueDiscarded})},n.onValueChanged=function(a){"function"===typeof b.onValueChanged&&b.onValueChanged.call(e.get(0),{id:b.id,fieldName:this.name,fieldLabel:this.label,fieldType:this.type,value:a.newValue,previousValue:a.previousValue})},a(n.getHTML()).addClass(0===h%2?"odd":"even"),
g.call(l,n);f.append(l);"function"===typeof b.onRowsInitialized&&b.onRowsInitialized.call(e.get(0),{rows:b.rows});e.append(f)},f={init:function(d){d=a.extend({},b,d);return this.each(function(){c++;a(this).empty();h.call(this,d);e.call(this,d.width);a(this).trigger("gridready");"function"===typeof d.onGridReady&&d.onGridReady.call(this)})},setWidth:function(a){e.call(this,a)}};a.fn.progrid=function(a){if(f[a])return f[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof a||
!a)return f.init.apply(this,arguments)}})(jQuery);var ErrorMessageItem=function(a){Element.call(this,jQuery.extend(!0,a,{position:"relative"}));this.parent=this.messageContainer=this.messageId=this.message=null;ErrorMessageItem.prototype.initObject.call(this,a)};ErrorMessageItem.prototype=new Element;ErrorMessageItem.prototype.type="ErrorMessageItem";ErrorMessageItem.prototype.family="Element";
ErrorMessageItem.prototype.initObject=function(a){var b={message:"[no message]",messageId:"",parent:null};jQuery.extend(!0,b,a);this.setMessage(b.message);this.setMessageId(b.messageId);this.setParent(b.parent)};ErrorMessageItem.prototype.setParent=function(a){this.parent=a;return this};ErrorMessageItem.prototype.getParent=function(a){return this.parent};
ErrorMessageItem.prototype.setMessageId=function(a){if("string"!==typeof a)throw Error("ErrorMessageItem.setMessageId(): not valid, should be a string value");this.messageId=a;return this};ErrorMessageItem.prototype.getMessageId=function(){return this.messageId};ErrorMessageItem.prototype.setMessage=function(a){if("string"!==typeof a)throw Error("ErrorMessageItem.setMessage(): not valid, should be a string value");this.message=a;this.html&&(this.messageContainer.textContent=this.message);return this};
ErrorMessageItem.prototype.getMessage=function(){return this.message};
ErrorMessageItem.prototype.createHTML=function(){var a;this.html||(this.html=this.createHTMLElement("li"),this.html.id=this.id,this.style.applyStyle(),this.style.addProperties({position:"relative",left:this.x,top:this.y,width:this.width,height:this.height,zIndex:this.zOrder}),a=this.createHTMLElement("span"),a.className="messageContainer",this.html.appendChild(a),this.messageContainer=a,this.setMessage(this.message),this.html.style.height="auto",this.html.style.width="auto",this.html.className="comment",
this.html.style.padding="3px 3px 3px 0px");return this.html};var ListContainer=function(a){Container.call(this,a);ListContainer.prototype.initObject.call(this,a)};ListContainer.prototype=new Container;ListContainer.prototype.type="ListContainer";ListContainer.prototype.family="ListContainer";ListContainer.prototype.initObject=function(a){};
ListContainer.prototype.setItems=function(a){var b;this.clearItems();if(!jQuery.isArray(a))throw Error("ListContainer.setItems(): the value is invalid, should be a type array");for(b=0;b<a.length;b+=1)this.addItem(a[b]);return this};
ListContainer.prototype.addItem=function(a){if(!(a instanceof ErrorMessageItem))if("object"===typeof a)a=new ErrorMessageItem(a);else throw Error("ListContainer.addItem(): the value is invalid");this.items.push(a);this.html&&this.messagecontainer.appendChild(a.getHTML());return this};ListContainer.prototype.clearItems=function(){var a,b=this.items.length;for(a=0;a<b;a+=1)this.removeItem(0);return this};
ListContainer.prototype.removeItem=function(a){a=this.items.splice(a,1)[0];a.html&&jQuery(a.getHTML()).remove();return this};ListContainer.prototype.paintItems=function(){var a;if(this.messagecontainer)for(a=0;a<this.items.length;a+=1)this.body.appendChild(this.items[a].getHTML());return this};ListContainer.prototype.createHTML=function(){this.html||(Container.prototype.createHTML.call(this),this.html.style.position="relative");return this.html};ListContainer.prototype.getItems=function(){return this.items};
ListContainer.prototype.getItem=function(a){if(0<=a&&a<this.items.length)return this.items[a];throw Error("ListContainer.getItem():the index does not exist");};
var ErrorListItem=function(a){ListContainer.call(this,a);this.parent=this.onClick=this.title=this.errorId=this.errorType=this.titleContainer=this.iconContainer=this.messagecontainer=null;this.listOfTypes={AdamGatewayEVENTBASED:"adam-tree-icon-gateway-exclusive",AdamGatewayINCLUSIVE:"adam-tree-icon-gateway-exclusive",AdamEventSTARTLeads:"adam-tree-icon-start-leads",AdamActivityUSERTASK:"adam-tree-icon-user-task",AdamEventSTARTOpportunities:"adam-tree-icon-start-opportunities",AdamEventSTARTDocuments:"adam-tree-icon-start-documents",
AdamEventSTART:"adam-tree-icon-start",AdamGatewayEXCLUSIVE:"adam-tree-icon-gateway-exclusive",AdamGatewayPARALLEL:"adam-tree-icon-gateway-parallel",AdamEventINTERMEDIATETIMER:"adam-tree-icon-intermediate-timer",AdamEventENDEMPTY:"adam-tree-icon-end",AdamEventINTERMEDIATEMESSAGE:"adam-tree-icon-intermediate-message",textannotation:"adam-tree-icon-textannotation ",AdamEventSTARTMESSAGE:"adam-tree-icon-start",AdamActivitySCRIPTTASK:"adam-tree-icon-user-task"};ErrorListItem.prototype.initObject.call(this,
a)};ErrorListItem.prototype=new ListContainer;ErrorListItem.prototype.type="ErrorListItem";ErrorListItem.prototype.family="ErrorListItem";ErrorListItem.prototype.initObject=function(a){var b={errorType:"",errorId:"",title:"[untitle]",onClick:null,parent:null};jQuery.extend(!0,b,a);this.setErrorType(b.errorType);this.setErrorId(b.errorId);this.setTitle(b.title);this.setOnClick(b.onClick);this.setParent(b.parent)};ErrorListItem.prototype.setParent=function(a){this.parent=a;return this};
ErrorListItem.prototype.getParent=function(){return this.parent};ErrorListItem.prototype.setOnClick=function(a){if(!("function"===typeof a||null===a))throw Error("ErrorListItem.setInconHandler(): the value is invalid");this.onClick=a;return this};ErrorListItem.prototype.attachListeners=function(){var a=this;jQuery(this.html).click(function(b){if("function"===typeof a.onClick){if(a.parent)a.onClick(a.parent,a,a.errorType,a.errorId);else a.onClick(a,a.errorType,a.errorId);a.select()}});return this};
ErrorListItem.prototype.setSelect=function(a){if("boolean"!==typeof a)throw Error("ErrorListItem.select(): error in parameter");this.selected=a;this.html&&(this.selected?this.select():this.deselect());return this};ErrorListItem.prototype.select=function(){this.html&&(this.parent&&((item=this.parent.getSelectedItem())&&item.deselect(),this.parent.setSelectedItem(this)),jQuery(this.getHTML()).css("background","#f3f8fe"));return this};
ErrorListItem.prototype.deselect=function(){this.html&&jQuery(this.getHTML()).css("background","inherit");return this};ErrorListItem.prototype.setTitle=function(a){if("string"!==typeof a)throw Error("ErrorListItem.setTitle(): the value is invalid");this.title=a;this.html&&(this.titleContainer.textContent=this.title,this.resizeWidthTitle());return this};
ErrorListItem.prototype.resizeWidthTitle=function(){var a,b;this.html&&(a=jQuery(this.titleContainer).outerWidth(),this.titleContainer.style.width="auto",b=jQuery(this.titleContainer).outerWidth(),this.titleContainer.title=b>a?this.title:"",this.titleContainer.style.width="80%");return this};ErrorListItem.prototype.getTitle=function(){return this.title};
ErrorListItem.prototype.setErrorId=function(a){if("string"!==typeof a)throw Error("ErrorListItem.addItem(): the value is invalid");this.errorId=a;return this};ErrorListItem.prototype.getErrorId=function(){return this.errorId};
ErrorListItem.prototype.createHTML=function(){var a,b,c;this.html||(ListContainer.prototype.createHTML.call(this),a=this.createHTMLElement("ul"),a.className="messagecontainer comments ",a.style.margin="0 0 9px 25px",b=this.createHTMLElement("i"),b.className="iconContainer",c=this.createHTMLElement("span"),c.className="titleContainer adam-error-color",this.body.appendChild(b),this.body.appendChild(c),this.body.appendChild(a),this.messagecontainer=a,this.iconContainer=b,this.titleContainer=c,this.paintItems(),
this.setErrorType(this.errorType),this.setTitle(this.title),this.html.style.height="auto",this.attachListeners(),$(this.html).addClass("activitystream-posts-comments-container"),this.html.style.padding="8px",this.html.style.width="auto",this.html.style.height="auto",this.titleContainer.style.paddingLeft="10px",this.fixedStyles());return this.html};
ErrorListItem.prototype.fixedStyles=function(){this.html&&jQuery(this.titleContainer).css({width:"80%","text-overflow":"ellipsis","white-space":"nowrap",overflow:"hidden",display:"inline-block",cursor:"pointer"});return this};ErrorListItem.prototype.paintItems=function(){var a;if(this.messagecontainer)for(a=0;a<this.items.length;a+=1)this.messagecontainer.appendChild(this.items[a].getHTML());return this};
ErrorListItem.prototype.setErrorType=function(a){if("string"!==typeof a)throw Error("ErrorListItem.setErrorType(): not valid, should be a string value");this.errorType=a;this.html&&(jQuery(this.html).removeClass(),jQuery(this.html).addClass("error-"+a),this.iconContainer.className=this.listOfTypes[a]);return this};
ErrorListItem.prototype.addItem=function(a){if(!(a instanceof ErrorMessageItem))if("object"===typeof a)a=new ErrorMessageItem(a);else throw Error("ErrorListItem.addItem(): the value is invalid");a.setParent(this);this.items.push(a);this.html&&this.messagecontainer.appendChild(a.getHTML());return this};ErrorListItem.prototype.getItemByMessageId=function(a){var b,c;for(b=0;b<this.items.length;b+=1)this.items[b].getMessageId()===a&&(c=this.items[b]);if(c)return c;null};
var ErrorListPanel=function(a){ListContainer.call(this,a);this.classItemSelected=this.selectedItem=this.titleContainer=this.parent=this.title=this.onClickItem=null;ErrorListPanel.prototype.initObject.call(this,a)};ErrorListPanel.prototype=new ListContainer;ErrorListPanel.prototype.type="ErrorListPanel";ErrorListPanel.prototype.family="ErrorListPanel";
ErrorListPanel.prototype.initObject=function(a){var b={onClickItem:null,title:"[Untitle]",parent:null,classItemSelected:"selected"};jQuery.extend(!0,b,a);this.setOnClickItem(b.onClickItem);this.setTitle(b.title);this.setParent(b.parent);this.setClassItemSelected(b.classItemSelected)};ErrorListPanel.prototype.setClassItemSelected=function(a){if("string"!==typeof a)throw Error("ErrorListPanel.setClassItemSelected:the value is invalid ");this.classItemSelected=a;return this};
ErrorListPanel.prototype.getClassItemSelected=function(){return this.classItemSelected};ErrorListPanel.prototype.setParent=function(a){this.parent=a;return this};ErrorListPanel.prototype.getParent=function(){return this.parent};ErrorListPanel.prototype.setTitle=function(a){if("string"!==typeof a)throw Error("ErrorListPanel.setTitle():the value is invalid ");this.title=a;this.html&&(this.titleContainer.textContent=a);return this};ErrorListPanel.prototype.getTitle=function(){return this.title};
ErrorListPanel.prototype.setOnClickItem=function(a){if(!("function"===typeof a||null===a))throw Error("ErrorListPanel.setInconHandler(): the value is invalid");this.onClickItem=a;if(this.items.length)for(a=0;a<this.items.length;a+=1)this.items[a].onClick=this.onClickItem;return this};
ErrorListPanel.prototype.createHTML=function(){var a;this.html||(ListContainer.prototype.createHTML.call(this),a=this.createHTMLElement("h4"),a.className="dashlet-title adam-error-color",this.html.appendChild(a),this.titleContainer=a,jQuery(this.body).remove(),body=this.createHTMLElement("div"),body.className="j-container",this.html.appendChild(body),this.body=body,this.setBodyHeight(this.bodyHeight),this.paintItems(),this.setTitle(this.title),this.customStyles());return this.html};
ErrorListPanel.prototype.customStyles=function(){this.html&&(this.body.style.listStyle="none",this.titleContainer.style.margin="0px",this.titleContainer.style.padding="6px 5px 6px 10px",this.titleContainer.style.fontWeight=500,this.titleContainer.style.background="#f6f6f6",this.titleContainer.style.borderBottom="1px solid #ddd",this.html.style.width="auto",this.html.style.background="white",this.html.style.height="auto",this.html.style.border="1px solid #ddd",jQuery(this.html).css("borderRadius",
"3px"),jQuery(this.titleContainer).css("borderRadius","3px 3px 0px 0px"));return this};ErrorListPanel.prototype.paintItems=function(){var a;if(this.html)for(a=0;a<this.items.length;a+=1)this.body.appendChild(this.items[a].getHTML());return this};
ErrorListPanel.prototype.addItem=function(a){if(!(a instanceof ErrorListItem))if("object"===typeof a)a=new ErrorListItem(a);else throw Error("ErrorListPanel.addItem(): the value is invalid");a.setParent(this);a.onClick=this.onClickItem;this.items.push(a);this.html&&this.body.appendChild(a.getHTML());return this};ErrorListPanel.prototype.getContainerMessageById=function(a){var b,c;for(c=0;c<this.items.length;c+=1)this.items[c].getErrorId()===a&&(b=this.items[c]);if(b)return b;null};
ErrorListPanel.prototype.addNewMessage=function(a,b,c){(a=this.getContainerMessageById(a))&&a.addItem({message:b,messageId:c});return this};ErrorListPanel.prototype.removeMessage=function(a,b){var c,d;if(c=this.getContainerMessageById(a))if(d=c.getItemByMessageId(b))d=c.items.indexOf(d),c.removeItem(d);return this};
ErrorListPanel.prototype.removeItemById=function(a){var b=this.getItems(),c,d;if("string"!==typeof a)throw Error("ErrorListPanel.removeItemById(): the value is invalid");for(c=0;c<b.length;c+=1)b[c].getErrorId()===a&&(d=c);return void 0!==d?(item=this.getItem(d),this.removeItem(d),item):null};ErrorListPanel.prototype.appendTo=function(a){a=a||"";jQuery(a).length&&jQuery(a).append(this.getHTML());return this};
ErrorListPanel.prototype.getItemById=function(a){var b=this.getItems(),c,d;if("string"!==typeof a)throw Error("ErrorListPanel.removeItemById(): the value is invalid");for(c=0;c<b.length;c+=1)b[c].getErrorId()===a&&(d=c);return void 0!==d?item=this.getItem(d):null};ErrorListPanel.prototype.setSelectedItem=function(a){a instanceof ErrorListItem&&(this.selectedItem=a);return this};ErrorListPanel.prototype.getSelectedItem=function(){return this.selectedItem};
ErrorListPanel.prototype.getAllErros=function(){var a=0;for(i=0;i<this.items.length;i+=1)a+=this.items[i].getItems().length;return a};ErrorListPanel.prototype.resizeWidthTitleItems=function(){var a;if(this.html)for(a=0;a<this.items.length;a+=1)this.getItem(a).resizeWidthTitle();return this};
