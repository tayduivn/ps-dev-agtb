...
UpdaterField.prototype.openPanelOnItem=function(a){var b=this;project.getMetadata("targetModuleFieldsDataSource");var c,d,e;a.getFieldType();if(a instanceof DateUpdaterItem||a instanceof NumberUpdaterItem){this._datePanel||(this._datePanel=new ExpressionControl({className:"updateritem-panel",onChange:this._onValueGenerationHandler(PROJECT_MODULE),appendTo:this.parent&&this.parent.parent&&this.parent.parent.html||null,decimalSeparator:this._decimalSeparator,numberGroupingSeparator:this._numberGroupingSeparator,
...
var ListPanel=function(a){CollapsiblePanel.call(this,a);this._showingLoadingMessage=this._htmlMessage=this._dataRoot=this._autoload=this._dataURL=this._proxy=this._data=this._itemsContent=null;this._filter=[];this.onLoad=this.onItemClick=null;ListPanel.prototype.init.call(this,a)};ListPanel.prototype=new CollapsiblePanel;ListPanel.prototype.constructor=ListPanel;ListPanel.prototype.type="ListPanel";
ListPanel.prototype.init=function(a){var b={items:[],itemsContent:"[list item]",data:null,onItemClick:null,dataURL:null,autoload:!1,dataRoot:null,onLoad:null,filter:[],fieldToFilter:null};jQuery.extend(!0,b,a);this._proxy=new SugarProxy;this._autoload=b.autoload;this.setItemsContent(b.itemsContent).setOnItemClickHandler(b.onItemClick).setDataURL(b.dataURL).setDataRoot(b.dataRoot).setOnLoadHandler(b.onLoad);"string"===typeof this._dataURL&&this._autoload?this.load():jQuery.isArray(b.data)?this.setDataItems(b.data,
b.fieldToFilter,b.filter):this.setItems(b.items)};ListPanel.prototype.setOnLoadHandler=function(a){if(!(null===a||"function"===typeof a))throw Error("onLoadHandler(): The parameter must be a functoin or null.");this.onLoad=a;return this};ListPanel.prototype._checkItemsNum=function(){0===this._items.getSize()?this.showMessage("[0 items]"):this.removeMessage();return this};
ListPanel.prototype.setDataRoot=function(a){if(!(null===a||"string"===typeof a))throw Error("setDataRoot(): The parameter must be a string or null.");this._dataRoot=a;return this};ListPanel.prototype._createMessageBox=function(){var a;this._htmlMessage?a=this._htmlMessage:(a=this.createHTMLElement("div"),a.className="adam list-panel-message",this._htmlMessage=a);return a};
ListPanel.prototype.showMessage=function(a){var b=this._createMessageBox();this._showingLoadingMessage=!1;jQuery(b).empty();isHTMLElement(a)?b.appendChild(a):"string"===typeof a&&(b.textContent=a);$(this._htmlBody).prepend(this._htmlMessage);return this};ListPanel.prototype.removeMessage=function(){jQuery(this._htmlMessage).remove();this._showingLoadingMessage=!1;return this};
ListPanel.prototype._onLoadDataError=function(){var a=this;return function(b){b=a.createHTMLElement("strong");b.appendChild(document.createTextNode("An error occurred, please try again."));a.showMessage(b)}};ListPanel.prototype._onLoadDataSuccess=function(){var a=this;return function(b){var c=a._dataRoot?b[a._dataRoot]:b;a.removeMessage().setDataItems(c)._checkItemsNum();if("function"===typeof a.onLoad)a.onLoad(a,b)}};
...
ListPanel.prototype.addDataItem=function(a){if("object"!==typeof a)throw Error("addDataItem(): The parameter must be an object.");this.addItem({data:a});return this};ListPanel.prototype._filterData=function(a,b,c){var d=[],e,f=!1;jQuery.isArray(c)&&c.length?f=function(a){return 0<=c.indexOf(a[b])}:"string"===typeof c?f=function(a){return c.toLowerCase()===a[b].toLowerCase()}:"function"===typeof c&&(f=c);if("string"===typeof b&&f){for(e=0;e<a.length;e+=1)f(a[e])&&d.push(a[e]);return d}return a};
ListPanel.prototype.getFilter=function(){return this._filter.slice(0)};ListPanel.prototype.setDataItems=function(a,b,c){if(jQuery.isArray(a)){this._massiveAction=!0;a=this._filterData(a,b,c);this.clearItems();for(b=0;b<a.length;b+=1)this.addDataItem(a[b]);this._filter=c||[];this._paintItems();this._massiveAction=!1}return this};
ListPanel.prototype.setItemsContent=function(a){if(!("string"===typeof a||"function"===typeof a))throw Error("setItemsContent(): The parameter must be a string or a function.");this._itemsContent=a;return this};ListPanel.prototype.setItems=function(a){this._itemsContent&&CollapsiblePanel.prototype.setItems.call(this,a);return this};
ListPanel.prototype.addItem=function(a){a instanceof ListItem||(a.text||(a.text=this._itemsContent),a=new ListItem(a));a.setOnClickHandler(this._onItemClickHandler());CollapsiblePanel.prototype.addItem.call(this,a);return this};ListPanel.prototype._createBody=function(){var a=this.createHTMLElement("ul");a.className="list-panel";return a};ListPanel.prototype.getValueObject=function(a){return a.getData()};
...
ExpressionControl.prototype.addVariablesList=function(a,b){var c,d;d={fieldToFilter:"type",filter:b.typeFilter,title:b.moduleText,data:[],itemsContent:function(a,b){var c="[item]",d,l,c=b.text;l=this.createHTMLElement("div");d=this.createHTMLElement("span");d.className="adam expressionbuilder-variableitem-text";d.textContent=c;c=this.createHTMLElement("span");c.className="adam expressionbuilder-variableitem-datatype";c.textContent=b.type;l.appendChild(d);l.appendChild(c);return l}};for(c=0;c<a.length;c+=
1)d.data.push({value:a[c][b.valueField],text:a[c][b.textField],type:a[c][b.typeField],module:b.moduleValue});newList=new ListPanel(d);newList.getItems().length&&this._variablePanel.addItem(newList);return this};
ExpressionControl.prototype._onLoadVariableDataSuccess=function(){var a=this;return function(b){var c=a._variableSettings,d,e={},f;c.dataRoot&&(b=b[c.dataRoot]);if("hierarchical"===c.dataFormat)for(d=0;d<b.length;d+=1)a.addVariablesList(b[d][c.dataChildRoot],{textField:c.textField,valueField:c.valueField,typeField:c.typeField,typeFilter:c.typeFilter,moduleText:b[d][c.moduleTextField],moduleValue:b[d][c.moduleValueField]});else{f="string"===typeof c.typeFilter?function(a){return c.typeFilter===a}:
jQuery.isArray(c.typeFilter)?function(a){return 0<=c.typeFilter.indexOf(a)}:function(){return!0};for(d=0;d<b.length;d+=1)f(b[d][c.typeField])&&(e[b[d][c.moduleValueField]]||(e[b[d][c.moduleValueField]]={fields:[]}),e[b[d][c.moduleValueField]].fields.push(b[d]));for(d in e)e.hasOwnProperty(d)&&a.addVariablesList(e[d].fields,{textField:c.textField,valueField:c.valueField,typeField:c.typeField,typeFilter:c.typeFilter,moduleText:e[d].fields[0][c.moduleTextField],moduleValue:e[d].fields[0][c.moduleValueField]})}}};
