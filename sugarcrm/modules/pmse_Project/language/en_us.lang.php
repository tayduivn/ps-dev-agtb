...
$mod_strings = array (
  ...
  'LBL_PMSE_BUTTON_OK' => 'Ok',
    ...
    'LBL_PMSE_IMPORT_CONFIRMATION' => 'When developing processes in another instance of Sugar, we strongly recommend that the instance is an exact clone of your production system. Processes built in an independent instance of Sugar may not function as desired after importing completes. Processes may rely on specific Studio or application-level changes including but not limited to custom field names, dropdown values, database IDs, etc. If these values are not identical from the instance where the process was built, you may need to manually rebuild the process in your target instance.
Would you still like to proceed with this import?',
