				...
				<tr>
					...
					<td class='listViewPaginationTdS1' align='right' nowrap='nowrap'>
						{if $pageData.urls.startPage}
							<a href='{$pageData.urls.startPage}' {if $prerow}onclick="javascript:return sListView.save_checks(0, '{$moduleString}')"{/if} class='listViewPaginationLinkS1'><<!--ALTFIXED-->img src='{$imagePath}start.gif' alt="{$app_strings.LNK_LIST_START}" align='absmiddle' border='0' height='11' width='13'>&nbsp;Start</a>&nbsp;
						{else}
							<<!--ALTFIXED-->img src='{$imagePath}start_off.gif' alt="{$app_strings.LNK_LIST_START}" align='absmiddle' border='0' height='11' width='13'>&nbsp;Start&nbsp;&nbsp;
						{/if}
						{if $pageData.urls.prevPage}
							<a href='{$pageData.urls.prevPage}' {if $prerow}onclick="javascript:return sListView.save_checks({$pageData.offsets.prev}, '{$moduleString}')"{/if} class='listViewPaginationLinkS1'><<!--ALTFIXED-->img src='{$imagePath}previous.gif' alt="{$app_strings.LNK_LIST_PREVIOUS}" align='absmiddle' border='0' height='11' width='8'>&nbsp;Previous</a>&nbsp;
						{else}
							<<!--ALTFIXED-->img src='{$imagePath}previous_off.gif' alt="{$app_strings.LNK_LIST_PREVIOUS}" align='absmiddle' border='0' height='11' width='8'>&nbsp;Previous&nbsp;
						{/if}
						...
						{if $pageData.urls.nextPage}
							&nbsp;<a href='{$pageData.urls.nextPage}' {if $prerow}onclick="javascript:return sListView.save_checks({$pageData.offsets.next}, '{$moduleString}')"{/if} class='listViewPaginationLinkS1'>Next&nbsp;<<!--ALTFIXED-->img src='{$imagePath}next.gif' alt="{$app_strings.LNK_LIST_NEXT}" align='absmiddle' border='0' height='11' width='8'></a>&nbsp;
						{else}
							&nbsp;Next&nbsp;<<!--ALTFIXED-->img src='{$imagePath}next_off.gif' alt="{$app_strings.LNK_LIST_NEXT}" align='absmiddle' border='0' height='11' width='8'>
						{/if}
					</td>
				</tr>
			</table>
                ...
                {if $params.sortable|default:true}
					...
					{if $params.orderBy|default:$colHeader|lower == $pageData.ordering.orderBy}
						{if $pageData.ordering.sortOrder == 'ASC'}
							<<!--ALTFIXED-->img border='0' src='{$imagePath}arrow_down.{$arrowExt}' width='{$arrowWidth}' height='{$arrowHeight}' align='absmiddle' alt='{$arrowAlt}'>
						{else}
							<<!--ALTFIXED-->img border='0' src='{$imagePath}arrow_up.{$arrowExt}' width='{$arrowWidth}' height='{$arrowHeight}' align='absmiddle' alt='{$arrowAlt}'>
						{/if}
					{else}
						<<!--ALTFIXED-->img border='0' src='{$imagePath}arrow.{$arrowExt}' width='{$arrowWidth}' height='{$arrowHeight}' align='absmiddle' alt='{$arrowAlt}'>
					{/if}
					</a>
				{else}
					{$params.label}
