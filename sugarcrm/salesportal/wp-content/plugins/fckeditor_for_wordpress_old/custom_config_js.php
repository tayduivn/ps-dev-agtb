...
$fck_browser_url = $deans_fckeditor->plugin_path .'filemanager/browser/default/browser.html?Connector=../../connectors/php/connector.php';
$fck_upload_url = $deans_fckeditor->plugin_path .'filemanager/connectors/php/upload.php';
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','Smiley','-','wpmore','-','About']
] ;
