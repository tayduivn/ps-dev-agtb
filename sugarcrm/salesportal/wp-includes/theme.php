...
function get_locale_stylesheet_uri() {
	global $wp_locale;
	global $wp_locale_object;

	$stylesheet_dir_uri = get_stylesheet_directory_uri();
	$dir = get_stylesheet_directory();
	$wp_locale = get_locale();
	if ( file_exists("$dir/$wp_locale.css") )
		$stylesheet_uri = "$stylesheet_dir_uri/$wp_locale.css";
	elseif ( !empty($wp_locale_object->text_direction) && file_exists("$dir/{$wp_locale_object->text_direction}.css") )
		$stylesheet_uri = "$stylesheet_dir_uri/{$wp_locale_object->text_direction}.css";
	else
		$stylesheet_uri = '';
