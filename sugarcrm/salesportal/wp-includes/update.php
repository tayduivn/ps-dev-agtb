...
function wp_version_check() {
	...
	$wp_locale = apply_filters( 'core_version_check_locale', get_locale() );
	...
	$url = "http://api.wordpress.org/core/version-check/1.3/?version=$wp_version&php=$php_version&locale=$wp_locale&mysql=$mysql_version&local_package=$local_package";
