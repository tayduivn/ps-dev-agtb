...
/**
 * Factory class for Meetings Data and CustomProperties adapters.
 *
 * Class Factory
...
class Factory implements FactoryInterface
{
    ...
    {
        $adapterClass = \SugarAutoLoader::customClass('Sugarcrm\Sugarcrm\Dav\Cal\Adapter\MeetingsAdapter\DataAdapter');
