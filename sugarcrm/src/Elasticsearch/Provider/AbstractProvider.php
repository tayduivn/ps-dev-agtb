...
abstract class AbstractProvider implements ProviderInterface
{
    ...
    /**
     * Get mapping property for given sugar field type
     * @param string $sugarType
     * @return array|false
     * @throws \Sugarcrm\Sugarcrm\Elasticsearch\Exception\InvalidMappingException
     */
    protected function getMappingForSugarType($sugarType)
    {
        ...
        // multiple mappings can be defined at once
        if (!is_array($mappingDefs)) {
            $mappingDefs = array($mappingDefs);
        }

        $properties = array();
        foreach ($mappingDefs as $mappingDef) {
     ...
     * @return boolean
     */
    protected function isSupportedSugarType($type)
    {
