	...
	var methods =
	{
		...
		show: function(e)
		{
			...
			if (!list || list.length == 0) {
				...
				list.wrapInner('<ul class="scroll"></ul>');
			}
			...
			/* Do not reposition drop down above input field to be consistent with daytime picker */
			/*
		...
		hide: function(e)
		{
			$('.ui-timepicker-list:visible').each(function() {
				var list = $(this);
				var list_corner = $('.ui-timepicker-list-ext');
