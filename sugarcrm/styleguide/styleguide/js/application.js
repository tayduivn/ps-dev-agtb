...
!function ($) {
  ...
  $(function (){
    ...
    ich.addTemplate('dashletControls', '<div class="btn-toolbar pull-right"><a href="#" data-toggle="widget" class="btn btn-invisible" rel="tooltip" data-original-title="Collapse" data-placement="top"><i class="icon-chevron-down"></i></a><a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-invisible" rel="tooltip" data-original-title="Settings" data-placement="top"><i class="icon-cog"></i></a><ul class="dropdown-menu left carettop"><li><a href="#settings">Settings</a></li><li><a href="#expand">Expand</a></li><li><a href="#refresh">Refresh</a></li><li><a href="#move">Move</a></li><li><a href="#dashboard">Add to dashboard</a></li><li><a href="#remove" class="widget-remove">Close</a></li></ul></div>');
