var pages = {
    "scaffolding":{
      ...
      , "sections":[
          {"label":"Grid system", "description":"12 columns with a responsive twist."}
        , {"label":"Layouts", "description":"Basic templates to create webpages."}
        , {"label":"Responsive design", "description":"Media queries for various devices and resolutions."}
      ]
    }
  , "base-css":{
        "title":"Base CSS"
  ...
  , "components":{
      ...
      , "sections":[
          {"label":"Buttons", "description":"Join buttons for more toolbar-like functionality and contextual dropdown menus built on button groups.", "items":['Button groups','Button dropdowns']}
        , {"label":"Navigation", "description":"Highly customizable list-style navigation.", "items":['Nav, tabs, pills','Navbar','Breadcrumbs','Pagination']}
        , {"label":"Labels", "description":"Label and annotate text."}
        , {"label":"Thumbnails", "description":"Grids of images, videos, text, and more."}
        , {"label":"Alerts", "description":"Styles for success, warning, and error messages."}
        , {"label":"Progress bars", "description":"For loading, redirecting, or action status."}
      ]
    }
  , "widgets":{
      ...
      , "sections":[
        ...
        , {"label":"Tooltips", "description":"A new take on the jQuery Tipsy plugin, Tooltips don't rely on images, uss CSS3 for animations, and data-attributes for local title storage."}
        , {"label":"Popovers", "description":"Add small overlays of content, like those on the iPad, to any element for housing secondary information."}
        , {"label":"Alert messages", "description":"The alert plugin is a tiny class for adding close functionality to alerts."}
        , {"label":"Buttons", "description":"Do more with buttons. Control button states or create groups of buttons for more components like toolbars."}

        , {"label":"Collapse", "description":"Get base styles and flexible support for collapsible components like accordions and navigation."}
  ...
  , "charting":{
      ...
      , "sections":[
        ...
        , {"label":"Vertical Bar", "description":"Used for comparing multiple series with a few values."}
