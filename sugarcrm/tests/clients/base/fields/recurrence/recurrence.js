describe('View.Fields.Base.RecurrenceField', function() {
    ...
    describe('Reset Fields', function() {
        it('should reset fields to defaults when repeat type changes', function() {
            var expected = {
                repeat_type: 'Weekly',
                repeat_interval: 1,
                repeat_until: '',
    ...
    using('variations of repeat count and repeat until values',[
        {
            expectation: 'should error when repeat count and repeat until are blank',
            repeatCount: '',
            repeatUntil: '',
