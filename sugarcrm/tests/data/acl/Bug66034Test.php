...
class Bug66034Test extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function aclAccessData() 
    {
        return array(
                ...
                array('Manufacturers', 'Products', 'edit', 'Developer', false, 'Developer should not be able to edit Manufacturers'),
                array('Manufacturers', 'Products', 'edit', 'Admin', false, 'Admin should not be able to edit Manufacturers'),
