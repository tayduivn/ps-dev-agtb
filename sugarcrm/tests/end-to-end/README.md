...
```
docker run --rm -p 5900:5900 -v ${PWD}:/sugarcrm registry.sugarcrm.net/seedbed/seedbed:0_8_8 -u http://your.sugar/instance
```
...
```
docker run -it --env DEV=true --rm -p 5900:5900 -v ${PWD}:/sugarcrm registry.sugarcrm.net/seedbed/seedbed:0_8_8
```
