  ...
  Background:
    ...
    @Add_CommentLog_when_one_is_already_there @pr
      Scenario: CommentLog existed in a record > add another CommentLog
        ...
        | *        | name                     | commentlog                                                   | date_start                | assigned_user_id |
      ...
      When I choose Meetings in modules menu
        ...
        Then I verify fields on #meeting1Record.RecordView
          | fieldName     | value                                                                                                |
          | commentlog   | It must be ike's, why are we having this meeting anyways?,Objection! That's why we need this meeting |
    ...
    @CommentLog_across_records @pr
      Scenario: Add CommentLog to multiple different existing records
        ...
        Then I verify fields on #meeting4Record.RecordView
          | fieldName     | value                                                                                                   |
          | commentlog   | Tacos will be ordered for meeting, amount TBD -BatMan,Since we got Flash, I'll just order 850 -- Batman |
