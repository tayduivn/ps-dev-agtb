...
Feature: Data Privacy module verification
  ...
  Scenario: Data Privacy > Erase And Complete > Part 1 (Contacts, Leads)
  ...
  @DataPrivacy_EraseAndComplete @pr
  Scenario: Data Privacy > Erase And Complete > Part 2 (Prospects, Accounts)
    Given DataPrivacy records exist:
      | *name | type                         | priority | source     | date_due                  |
      | DP_1  | Request to Erase Information | Medium   | Phone Call | 2020-10-19T19:20:22+00:00 |
    Given Prospects records exist:
      | *      | first_name | last_name | account_name    | title             | email                        | department  | phone_mobile   | phone_work     | assigned_user_id |
      | Travis | Travis     | Hubbard   | Travis's Acount | Software Engineer | travis@example.com (primary) | Engineering | (746) 079-5068 | (408) 536-6313 | 1                |
    Given Accounts records exist:
      | *name | billing_address_city | billing_address_street | billing_address_postalcode | billing_address_state | billing_address_country | email                      | assigned_user_id |
      | Drew  | City 1               | Street address here    | 220051                     | WA                    | USA                     | drew@example.org (primary) | 1                |
