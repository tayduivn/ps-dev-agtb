...
@modules_forecasts @job7 @pro-only
Feature: Forecasts module - Sugar PRO

  Background:
    Given I use default account
    Given I launch App

  @forecasts_workflow_automation
  Scenario: Forecasts sales manager to sales rep workflow automation
    ...
    # Configure Forecast module - Forecasts module must be configured before creating Opportuity records
    ...
    When I provide input for #OpportunitiesDrawer.RecordView view
      | *     | account_name | date_closed | best_case | sales_stage        | amount |
      | Opp_1 | Acc_1        | 10/01/2020  | 150       | Negotiation/Review | 100    |
    When I click Save button on #OpportunitiesDrawer header
    When I close alert

    # Create new opportunity 'Opp_2'
    When I click Create button on #OpportunitiesList header
    When I provide input for #OpportunitiesDrawer.HeaderView view
      | *     | name  |
      | Opp_2 | Opp_2 |
    When I provide input for #OpportunitiesDrawer.RecordView view
      | *     | account_name |date_closed | best_case | sales_stage        | amount |
      | Opp_2 | Acc_1        | 11/01/2020  | 250       | Negotiation/Review | 200    |
    When I click Save button on #OpportunitiesDrawer header
    When I close alert

    # Create new opportunity 'Opp_3'
    When I click Create button on #OpportunitiesList header
    When I provide input for #OpportunitiesDrawer.HeaderView view
      | *     | name  |
      | Opp_3 | Opp_3 |
    When I provide input for #OpportunitiesDrawer.RecordView view
      | * | account_name |date_closed | best_case | sales_stage       | amount |
      | Opp_3 | Acc_1    |12/01/2020  | 350       | Value Proposition | 300    |
    When I click Save button on #OpportunitiesDrawer header
    When I close alert
    ...
    # Verify included Opportunities are present in sales rep the worksheet
    Then I should see *Opp_1 in #Forecasts.SalesRepWorksheet.ListView
    Then I should see *Opp_2 in #Forecasts.SalesRepWorksheet.ListView
    Then I should not see *Opp_3 in #Forecasts.SalesRepWorksheet.ListView
    ...
    # Verify Opp_3 is now present in the worksheet
    Then I should see *Opp_3 in #Forecasts.SalesRepWorksheet.ListView
    ...
    # Change commit_stage of Opp_3 to "Include" in sales rep worksheet
    When I set values for *Opp_3 in #Forecasts.SalesRepWorksheet.ListView
      | fieldName    | value   |
    ...
    # Change Likely and Best value of Opp_1
    When I set values for *Opp_1 in #Forecasts.SalesRepWorksheet.ListView
      | fieldName   | value |
      | likely_case | 200   |
      | best_case   | 250   |
    ...
    # Change sales stage of Opp_2 to 'Closed Won'
    When I set values for *Opp_2 in #Forecasts.SalesRepWorksheet.ListView
      | fieldName   | value      |
