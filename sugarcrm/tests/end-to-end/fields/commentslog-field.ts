...
export class Detail extends BaseField {
    ...
    /**
     * @return string The content and content only of the commentslog, if multiple commentslog message
     *         were present, there will be a "," between each commentslog message, in the order of
