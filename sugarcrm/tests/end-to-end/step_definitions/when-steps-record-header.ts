 ...
 */
When(/^I click (Create|Edit|Cancel|Close|Save|Reply|Add|Complete|MarkForErasure|Reject|CloseButton) button on (#[a-zA-Z](?:\w|\S)*) header$/,
 ...
 */
When(/^I choose (Copy|Delete|CreateOpportunity|GenerateQuote|Convert|CloseCall|CloseMeeting|CloseAndCreateNew|Edit|Cancel|Edit_Cancel|ViewPersonalInfo|AuditLog) from actions menu in (#[a-zA-Z]\w+)\s*$/,
