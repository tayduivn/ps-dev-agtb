 ...
 */
When(/^I click (Create|Edit|Cancel|Close|Save|Reply|Add|EraseAndComplete|MarkForErasure|Reject) button on (#[a-zA-Z](?:\w|\S)*) header$/,
 ...
 */
When(/^I choose (Copy|Delete|CreateOpportunity|GenerateQuote|Convert|CloseCall|CloseMeeting|CloseAndCreateNew|Edit|Cancel|Edit_Cancel) from actions menu in (#[a-zA-Z]\w+)\s*$/,
