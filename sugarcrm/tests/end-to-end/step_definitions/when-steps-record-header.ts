 ...
 */
When(/^I choose (Copy|Delete|CreateOpportunity|GenerateQuote|Convert|CloseCall|CloseMeeting|CloseAndCreateNew|Edit|Cancel|Edit_Cancel|ViewPersonalInfo|AuditLog|ExportCSV|Settings) from actions menu in (#[a-zA-Z]\w+)\s*$/,
