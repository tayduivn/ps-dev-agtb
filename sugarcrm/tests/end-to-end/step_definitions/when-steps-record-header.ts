 ...
 */
When(/^I click (Create|Edit|Cancel|Close|Save|Reply|Add|Complete|MarkForErasure|Reject|Add2Quote|CloseButton|EmailQuote|Commit|SaveDraft|ToggleSidePanel|CreateCategory|pipelineCreate|AddButton|oneColumnLayout|twoColumnLayout|threeColumnLayout|mergeDuplicates|Archive) button on (#[a-zA-Z](?:\w|\S)*) header$/,
