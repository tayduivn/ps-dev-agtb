...
/**
 * Returns wireless.subpaneldefs for mobile
 * @ticket 63486
 */
class Bug63486Test extends Sugar_PHPUnit_Framework_TestCase
{
    public function testMobileSubPanelDefinitions()
    {
        ...
        $this->assertNotEquals($mobileLayoutDefs, $subPanel->layout_defs);
    }
}
