...
END:VCALENDAR',
    ...
    public function prepareForImportProvider()
    {
        return array(
            ...
            array(
                'oldEvent' => $this->getEventTemplate('recurring-simple'),
                'currentEvent' => $this->getEventTemplate('recurring-simple-edit-parent'),
                'expectedBean' => array(
                    array(
                        null,
                        array(),
                        (new SugarDateTime('20160118T090000', new DateTimeZone('Europe/Minsk')))->asDb(),
                        0,
                        false,
                    ),
                    array(
                        null,
                        array(),
                        (new SugarDateTime('20160120T090000', new DateTimeZone('Europe/Minsk')))->asDb(),
                        2,
                        false,
                    )
                ),
                'changedFields' => array(
                    array(
                        'title' => array('test recurring parent', 'test recurring'),
                    ),
                    array(
                        'title' => array('test recurring 1', 'test recurring'),
                    ),
                ),
                ...
                'changedFields' => array(
                    array(
                        ...
                        'rrule' => array(
                            ...
                            'count' => array(null),
                            'until' => array(
                                (new SugarDateTime('20150813T080000Z', new DateTimeZone('UTC')))->asDbDate()
                            ),
                            'byday' => array(array()),
                            'action' => 'added',
                        ),
