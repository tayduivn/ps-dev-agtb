...
class Bug34993Test extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $GLOBALS['db']->query("DELETE FROM fields_meta_data WHERE id = 'Accountsbug34993_test_c'");
    }
    ...
    public function testCustomFieldDefaultValue()
    {
        ...
        $this->assertEquals($bean->bug34993_test_c, NULL, "Assert that the custom field has a default value set to NULL");
    }
}
