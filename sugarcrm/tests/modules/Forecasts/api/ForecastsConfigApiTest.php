 ...
 *
 */
class ForecastsConfigApiTest extends RestTestBase
{
     ...
     * @group forecasts
     */
    public function testForecastsConfigApi()
    {
     ...
     * @group forecasts
     */
    public function testForecastsConfigApiForForecastsModule()
    {
        $response = $this->_restCall("Forecasts/config?module=Forecasts");
