...
describe("forecasts_view_forecastsFilter", function () {
    ...
    beforeEach(function() {
        ...
        view = SugarTest.loadFile(
            "../modules/Forecasts/clients/base/views/forecastsFilter",
            "forecastsFilter",
            "js",
            function (d) {
                return eval(d);
    ...
    describe("when rendering", function() {
        ...
        afterEach(function() {
            view.toggleRangesFieldVisibility.restore();
        ...
        it("should toggle the visibility of the filters", function() {
            view._render();
            expect(view.toggleRangesFieldVisibility).toHaveBeenCalled();
        });
