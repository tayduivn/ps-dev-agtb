...
class CurrencyRateSchedulerJobTest extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function testCurrencyRateSchedulerJob()
    {
        ...
        */
        ...
        /*
        $this->assertEquals(1.234, $forecastBaseRate, 'forecasts.base_rate was not modified by BaseRateSchedulerJob');
        $this->assertEquals(1.234, $quotaBaseRate, 'quota.base_rate was not modified by BaseRateSchedulerJob');
        $this->assertEquals(1.234, $forecastScheduleBaseRate, 'forecast_schedule.base_rate was not modified by BaseRateSchedulerJob');
        */
    }
