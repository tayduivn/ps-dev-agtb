...
class SearchUtilsTest extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function createFtsSearchListQueryProvider()
    {
        return array
        (
            //Simulate a search with text = '*', kbolddocument_name = 'Draft' and 'status_id' = 'Draft'
            array(
     ...
     * @see modules/KBOLDDocuments/SearchUtils.php
     * 
     * @param $spec_SearchVars Array of special arguments for KBOLDDocuments module
     * @param $searchVars Array of arguments sent from search form to KBOLDDocuments module
