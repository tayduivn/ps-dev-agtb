...
require_once 'modules/KBSContents/clients/base/api/KBSContentsApi.php';

class KBSContentsApiTest extends Sugar_PHPUnit_Framework_TestCase
{
    /**
     * @var RestService
     */
