            ...
            [
                {
                    ...
                    emitters: {emitter1: {}},
                    carriers: {foo: {deliveryOptionsDisplayStyle: 'single', options: {0: 0}}},
                    result: {foo: ['0']}
                },
                {
                    'case': 'Empty emitter & and not selectable carrier',
                    emitters: {emitter1: {}},
                    carriers: {foo: {deliveryOptionsDisplayStyle: 'none'}},
                    result: {}
                },
                {
                ...
                },
                {
                    ...
                    carriers: {foo: {deliveryOptionsDisplayStyle: 'single', options: {0: 0, 1: 1}}},
                    result: {foo: ['0', '1']}
                },
                {
                ...
                },
                {
                    ...
                    carriers: {foo: {deliveryOptionsDisplayStyle: 'single', options: {0: 0}},
                        bar: {deliveryOptionsDisplayStyle: 'single', options: {0: 0}}
                    },
                    result: {foo: ['0'], bar: ['0']}
                },
                {
                ...
                },
                {
                    ...
                    carriers: {
                        foo: {deliveryOptionsDisplayStyle: 'single', options: {0: 0, 1: 1}},
                        bar: {deliveryOptionsDisplayStyle: 'single', options: {0: 0, 1: 1}}
                    },
                    result: {foo: ['1'], bar: ['0']}
                }
            ],
