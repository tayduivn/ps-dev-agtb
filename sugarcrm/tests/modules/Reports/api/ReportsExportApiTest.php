...
class ReportsExportApiTest extends RestTestBase
{
    ...
    {
        // TODO migrate this to new unit tests
        global $mod_strings;
        $mod_strings = return_module_language('en_us', 'Reports');

        $this->setExpectedException(
          'SugarApiExceptionNotAuthorized', $mod_strings['LBL_NO_ACCESS'] . "----Users"
        );
        // take away access
        $acldata['Accounts']['module']['list']['aclaccess'] = ACL_ALLOW_NONE;
        $acldata['Meetings']['module']['list']['aclaccess'] = ACL_ALLOW_NONE;
        $acldata['Users']['module']['list']['aclaccess'] = ACL_ALLOW_NONE;
        $acldata['Reports']['module']['view']['aclaccess'] = ACL_ALLOW_ALL;
        $acldata['Reports']['module']['admin']['aclaccess'] = ACL_ALLOW_ALL;
        $acldata['Reports']['module']['access']['aclaccess'] = ACL_ALLOW_ALL;
        ACLAction::setACLData($GLOBALS['current_user']->id, 'Accounts', $acldata['Accounts']);
        ACLAction::setACLData($GLOBALS['current_user']->id, 'Meetings', $acldata['Meetings']);
        ACLAction::setACLData($GLOBALS['current_user']->id, 'Users', $acldata['Users']);
        ACLAction::setACLData($GLOBALS['current_user']->id, 'Reports', $acldata['Reports']);
        // The summary report goes through a different file and was having issues
        ...
        $this->assertTrue(!empty($val), 'no file received');
    }

    /**
     * @group rest
     */
    public function testNoAccessReportView()
    {
        ...
        ACLAction::setACLData($GLOBALS['current_user']->id, 'Reports', $acldata);
        // The summary report goes through a different file and was having issues
