...
class ReportsExportApiTest extends RestTestBase
{
    ...
    public function testNoAccessReportExport()
    {
        ...
        $_SESSION['ACL'][$GLOBALS['current_user']->id]['Reports']['module']['view']['aclaccess'] = ACL_ALLOW_ALL;
        $_SESSION['ACL'][$GLOBALS['current_user']->id]['Reports']['module']['admin']['aclaccess'] = ACL_ALLOW_ALL;
        $_SESSION['ACL'][$GLOBALS['current_user']->id]['Reports']['module']['access']['aclaccess'] = ACL_ALLOW_ALL;
        // The summary report goes through a different file and was having issues
    ...
    public function testNoAccessReportView()
    {
        ...
        // take away access
        $_SESSION['ACL'][$GLOBALS['current_user']->id]['Reports']['module']['view']['aclaccess'] = ACL_ALLOW_NONE;
        // The summary report goes through a different file and was having issues
