...
class RevenueLineItemsTest extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->rli = SugarTestRevenueLineItemUtilities::createRevenueLineItem();
    }
    ...
    {
        $this->rli->date_closed = null;
        $this->rli->save();
        $this->assertEmpty($this->rli->date_closed);
    }
    ...
    public function testCreateNewListQuery()
    {
        ...
        $GLOBALS["log"]->fatal("end testCreateNewListQuery1");
        $GLOBALS["log"]->fatal("testCreateNewListQuery2");
        $query = $this->rli->create_new_list_query('', '', array(), array(), 0, '', false);
        $this->assertContains(
            "revenue_line_items.opportunity_id is not null OR revenue_line_items.opportunity_id <> ''",
            $query,
            "Did not find revenue_line_items.opportunity_id is not null OR revenue_line_items.opportunity_id <> '' clause"
        );
        $GLOBALS["log"]->fatal("end testCreateNewListQuery2");
    }
    ...
    public function testCreateExportQuery()
    {
        $orderBy = '';
        $where = '';
        $query = $this->rli->create_export_query($orderBy, $where);
        $this->assertContains(
            "revenue_line_items.opportunity_id is not null OR revenue_line_items.opportunity_id <> ''",
            $query,
            "Did not find revenue_line_items.opportunity_id is not null OR revenue_line_items.opportunity_id <> '' clause"
    ...
    public function testSetAccountForOpportunity()
    {
        ...
        $product = new MockRevenueLineItem();
        ...
        $product2 = new MockRevenueLineItem();
    ...
    public function testRevenueLineItemCreatedFromOpportunityContainsSalesStage()
    {
        ...
        /* @var $product RevenueLineItem */
        $product = array_shift($products);

        SugarTestRevenueLineItemUtilities::setCreatedRevenueLineItem(array($product->id));
    ...
    public function testSaveRevenueLineItemWorksheetReturnsFalseWhenForecastNotSetup()
    {
        ...
        /* @var $product RevenueLineItem */
        $product = BeanFactory::getBean('RevenueLineItems');
    ...
    public function testCreateRevenueLineItemCreatesForecastWorksheet()
    {
        ...
        $product = SugarTestRevenueLineItemUtilities::createRevenueLineItem();
     ...
     * @group opportunities
     */
    public function testRevenueLineItemSaveCallsHandleOppSalesStatus()
    {
        //create mock product to check that the save does what is expected
        $product = new MockRevenueLineItem();
        $product->name = "mockRevenueLineItemTest1";
     ...
     * @group products
     */
    public function testProductTemplateSetsRevenueLineItemFields()
    {
     ...
     * @group products
     */
    public function testProductTemplateSetsRevenueLineItemFieldsWithCurrencyConversion()
    {
