 ...
 */
describe('RevenueLineItems.Base.View.MassUpdate', function() {
    ...
    beforeEach(function () {
        ...
        layout = SugarTest.createLayout('base', 'RevenueLineItems', 'list', {});
    });
    ...
    describe('setMetadata', function(){
        it('should not remove commit_stage', function(){
            ...
            view = SugarTest.createView('base', 'RevenueLineItems', 'massupdate', options.meta, null, true, layout);
