...
class Quarter445TimePeriodTest extends Sugar_PHPUnit_Framework_TestCase
{
    protected static $tp;
    ...
    public static function setUpBeforeClass() {
        ...
        self::$tp = SugarTestTimePeriodUtilities::createITimePeriod("Quarter445", true);
    ...
    public function testCreateNextTimePeriod()
    {
        ...
        $nextTimePeriod->name = "SugarTestCreatedNextQuarter445TimePeriod";
        $nextTimePeriod->save();
    ...
    public function test2ndMonthCalendarLeafBounds()
    {
        ...
        $startDate = $timedate->fromDbDate($baseTimePeriod->start_date);
        $endDate = $timedate->fromDbDate($baseTimePeriod->start_date);
        $startDate = $startDate->modify("+4 week");
        $endDate = $endDate->modify("+8 week");
        $endDate = $endDate->modify("-1 day");
        $startDate->setTime(0,0,0);
        $endDate->setTime(23,59,59);
    ...
    public function test3rdMonthCalendarLeafBounds()
    {
        ...
        $startDate = $timedate->fromDbDate($baseTimePeriod->start_date);
        $endDate = $timedate->fromDbDate($baseTimePeriod->start_date);
        $startDate = $startDate->modify("+8 week");
