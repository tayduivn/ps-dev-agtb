...
class Quarter454TimePeriodTest extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function testCreateNextTimePeriod()
    {
        ...
        $nextTimePeriod->name = "SugarTestCreatedNextQuarter454TimePeriod";
        $nextTimePeriod->save();
        SugarTestTimePeriodUtilities::addTimePeriod($nextTimePeriod);
        $nextTimePeriod = BeanFactory::getBean('Quarter454TimePeriods', $nextTimePeriod->id);
    ...
    public function testCreatePreviousTimePeriod()
    {
        ...
        $previousTimePeriod->name = "SugarTestCreatedPriorQuarter454TimePeriods";
        $previousTimePeriod->save();
        SugarTestTimePeriodUtilities::addTimePeriod($previousTimePeriod);
        $previousTimePeriod = BeanFactory::getBean('Quarter454TimePeriods', $previousTimePeriod->id);
