...
class RestBug57887Test extends RestTestBase
{
    ...
    public function setUp()
    {
        ...
        if (file_exists($this->_metadataFile)) {
            rename($this->_metadataFile, $this->_metadataFile . '.backup');
            
            // Remove from the file map cache
            SugarAutoLoader::delFromMap($this->_metadataFile);
        }
    ...
    public function tearDown()
    {
        ...
        if (file_exists($this->_metadataFile . '.backup')) {
            rename($this->_metadataFile . '.backup', $this->_metadataFile);
            
            // Add back into the file map cache
            SugarAutoLoader::addToMap($this->_metadataFile);
        }
