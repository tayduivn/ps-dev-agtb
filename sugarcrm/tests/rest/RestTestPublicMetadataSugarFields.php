...
class RestTestPublicMetadataSugarFields extends RestTestBase {
    ...
    public function testMetadataSugarFieldsController() {
        $filesToCheck = array('clients/mobile/public/fields/address/address.js',
                              'clients/portal/public/fields/address/address.js',
                              'clients/base/public/fields/address/address.js',
                              'custom/clients/mobile/public/fields/address/address.js',
                              'custom/clients/portal/public/fields/address/address.js',
                              'custom/clients/base/public/fields/address/address.js',
        );
        ...
        $dirsToMake = array('clients/mobile/public/fields/address',
                            'clients/portal/public/fields/address',
                            'clients/base/public/fields/address',
                            'custom/clients/mobile/public/fields/address',
                            'custom/clients/portal/public/fields/address',
                            'custom/clients/base/public/fields/address',
        );
        ...
        file_put_contents('clients/mobile/public/fields/address/address.js','MOBILE CODE');
        ...
        file_put_contents('clients/base/public/fields/address/address.js','BASE CODE');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        unlink('clients/mobile/public/fields/address/address.js');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        file_put_contents('custom/clients/mobile/public/fields/address/address.js','CUSTOM MOBILE CODE');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        file_put_contents('custom/clients/portal/public/fields/address/address.js','CUSTOM PORTAL CODE');
    ...
    public function testMetadataSugarFieldsTemplates() {
        $filesToCheck = array(
            'clients/mobile/public/fields/address/editView.hbt',
            'clients/mobile/public/fields/address/detailView.hbt',
            'clients/portal/public/fields/address/editView.hbt',
            'clients/portal/public/fields/address/detailView.hbt',
            'clients/base/public/fields/address/editView.hbt',
            'clients/base/public/fields/address/detailView.hbt',
            'custom/clients/mobile/public/fields/address/editView.hbt',
            'custom/clients/mobile/public/fields/address/detailView.hbt',
            'custom/clients/portal/public/fields/address/editView.hbt',
            'custom/clients/portal/public/fields/address/detailView.hbt',
            'custom/clients/base/public/fields/address/editView.hbt',
            'custom/clients/base/public/fields/address/detailView.hbt',
        );
        ...
        // Make sure we get it when we ask for mobile
        file_put_contents('clients/mobile/public/fields/address/editView.hbt','MOBILE EDITVIEW');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        // Make sure we get it when we ask for mobile, even though there is base code there
        file_put_contents('clients/base/public/fields/address/editView.hbt','BASE EDITVIEW');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        // Delete the mobile address and make sure it falls back to base
        unlink('clients/mobile/public/fields/address/editView.hbt');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        // Make sure the mobile code is loaded before the non-custom base code
        file_put_contents('custom/clients/mobile/public/fields/address/editView.hbt','CUSTOM MOBILE EDITVIEW');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=mobile');
        ...
        file_put_contents('custom/clients/base/public/fields/address/editView.hbt','CUSTOM BASE EDITVIEW');
        $restReply = $this->_restCall('metadata/?typeFilter=fields&platform=base');
