...
class RestTestPublicMetadataViewTemplates extends RestTestBase {
    ...
    public function testMetadataViewTemplates() {
        $restReply = $this->_restCall('metdata/public?typeFilter=viewTemplates');
    ...
    public function testMetadataViewTemplatesHbt() {
        ...
        $restReply = $this->_restCall('metdata/public/?typeFilter=viewTemplates&platform=portal');
        ...
        $restReply = $this->_restCall('metdata/public/?typeFilter=viewTemplates&platform=base');
