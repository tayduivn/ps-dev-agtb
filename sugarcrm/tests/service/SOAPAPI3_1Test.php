 ...
 *
 */
class SOAPAPI3_1Test extends Sugar_PHPUnit_Framework_TestCase
{
	public $_user = null;
    ...
    {
        $this->_soapClient = new nusoapclient($GLOBALS['sugar_config']['site_url'].'/service/v3_1/soap.php',false,false,false,false,false,600,600);
        $this->_setupTestUser();
    }
