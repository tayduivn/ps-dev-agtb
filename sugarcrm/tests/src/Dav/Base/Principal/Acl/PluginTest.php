 ...
 */
namespace Sugarcrm\SugarcrmTests\Dav\Base\Principal\Acl;
...
class PluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFilterResults($searchResult, $expectedResult)
    {
        ...
        $result = SugarTestReflection::callProtectedMethod($aclPlugin, 'filterResults', array($searchResult));
    ...
    public function testPrincipalSearch()
    {
        ...
        SugarTestReflection::setProtectedValue($aclPlugin, 'principalCollectionSet', array());
