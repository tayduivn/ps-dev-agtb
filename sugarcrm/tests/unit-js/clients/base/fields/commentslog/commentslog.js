...
/**
 * Tests the basic behavior for commentslog field
 * */
describe('commentslog field', function() {
    var app;
    var field;
    var template;
    var module = 'Bugs';
    var fieldName = 'commentslog';

    beforeEach(function() {
        app = SugarTest.app;
        SugarTest.testMetadata.init();
        template = SugarTest.loadHandlebarsTemplate('commentslog', 'field', 'base', 'detail');
        SugarTest.testMetadata.set();
        field = SugarTest.createField('base', fieldName, 'commentslog', 'detail', {}, module);
    });
            ...
            [
                ...
                it('format() should correctly parse passed in function', function() {
                    ...
                    for (var i = 0; i < value.msgs.length; i++) {
                        // the entry should be exactly the same, since commentslog.js is not responsible
                        // for formatting
                ...
                it('showCommentslog() should handle data from showCommentslog Correctly', function() {
                    field.model.set(fieldName, value.msgs);
                    field.showCommentslog();
