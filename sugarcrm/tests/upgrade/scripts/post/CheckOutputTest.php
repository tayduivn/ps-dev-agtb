...
class CheckOutputTest extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    protected $testDir = 'custom/modules/CustomTest/';
    protected $testDirFail = 'custom/modules/Documents/';
    ...
    public function setUp()
    {
        ...
        sugar_mkdir($this->testDir);
        sugar_mkdir($this->testDirFail);
    }
    ...
    public function tearDown()
    {
        ...
        rmdir_recursive($this->testDirFail);
    }
    ...
    {
        $file = $this->testDirFail . 'test.php';

        SugarAutoLoader::ensureDir($this->testDirFail);
        SugarTestHelper::saveFile($file);
        sugar_file_put_contents($file, $content);
