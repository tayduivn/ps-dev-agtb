...
class ServiceDictionaryRestTest extends TestCase
{
    public function testRegisterEndpoints()
    {
        ...
        $sd->registerEndpoints([$fakeEndpoints[0]], 'fake/unittest1.php', 'unittest1', 'base', 0);
        ...
        $sd->registerEndpoints([$portalEndpoint], 'portal/unittest1.php', 'portaltest4', 'portal', 0);

        $portalEndpoint = $fakeEndpoints[2];
        $portalEndpoint['method'] = 'portaltest3';
        $portalEndpoint['path'][2] = 'portal';
        $sd->registerEndpoints([$portalEndpoint], 'portal/unittest1.php', 'portaltest3', 'portal', 0);
