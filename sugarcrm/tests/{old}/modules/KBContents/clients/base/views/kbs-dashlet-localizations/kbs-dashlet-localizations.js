describe('KBContents.Base.Views.KBSDashletLocalizations', function() {
    ...
    describe('initDashlet()', function() {
        ...
        it('should call _initSettings() and _initCollection() when initDashlet',
            function() {
    ...
    describe('bindDataChange()', function() {
        ...
        it('should add add/remove/reset event listener on collection only when collection defined',
            function() {
                view.meta.config = true;
                view.bindDataChange();
        ...
        it('should not add add/remove/reset event listener on collection when collection not defined',
            function() {
                view.meta.config = true;
