...
class GetEntriesCountTest extends SOAPTestCase
{
    ...
    public function testRetrieveUsersList() {
        ...
        $usersArr =   $this->_soapClient->call('get_entry_list',array('session'=>$this->_sessionId,'module_name'=>'Users','query'=>" users.status = 'Active' ", 'user_name','0'  ,'select_field'=>array('user_name'), array(), 10000,0));
