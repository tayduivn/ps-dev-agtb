...
namespace Sugarcrm\SugarcrmTestsUnit\Dav\Cal\Structures;
...
class EventTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetTitle(VEvent $VEvent, $newValue, $expectedResult)
    {
        ...
        $event = TestReflection::getProtectedValue($eventMock, 'event');
    ...
    public function testSetEndOfEvent(VEvent $VEvent, $dtEnd, $duration, $expectedMethods)
    {
        ...
        TestReflection::callProtectedMethod($eventMock, 'setEndOfEvent', array($duration, $dtEnd));
    }
    ...
    protected function getEventMock(VEvent $VEvent, $mockMethods = null, array $links = array())
    {
        ...
        TestReflection::setProtectedValue($eventMock, 'dateTimeHelper', $dateTimeHelper);
