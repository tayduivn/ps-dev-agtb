...
<div id="header">
    ...
    <<!--ALTFIXED-->img id="boarder" height="45" border="0" width="43" style="margin-left: 3em;" alt="{$app_strings.LBL_GETTINGAIR}" src="themes/Shred/images/boarder.png"/>
    <div class="clear"></div>
    <<!--ALTFIXED-->img id="icicle_left" src="themes/Shred/images/icicle_left.png"/>
    <<!--ALTFIXED-->img id="icicle_right" src="themes/Shred/images/icicle_right.png"/>
    <div class="clear"></div>
    {if !$AUTHENTICATED}
    <br /><br />
    {/if}
