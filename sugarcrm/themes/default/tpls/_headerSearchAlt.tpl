...
<div id="search">
    <form name='UnifiedSearch' onsubmit='return SUGAR.unifiedSearchAdvanced.checkUsaAdvanced()'>
       ...
       <span id="unified_search_advanced_img"> {$APP.LBL_SEARCH}</span>
		<img id="unified_search_advanced_img" src="{sugar_getimagepath file='MoreDetail.png'}" border="0" alt="{$APP.LBL_SEARCH}">&nbsp;
