    ...
    private function getStaleFilesBy7220()
    {
        if (version_compare($this->from_version, '7.2.2.0', '<')) {
            $files = array(
                ...
                'jssource/src_files/modules/KBOLDDocuments/clients/portal/views/subnav',
                ...
                'modules/KBOLDContents/clients',
                'modules/KBOLDDocumentKBOLDTags/clients',
                'modules/KBOLDDocumentRevisions/clients',
                'modules/KBOLDDocuments/clients/portal/layouts/detail',
                'modules/KBOLDDocuments/clients/portal/views/subnav',
                'modules/KBOLDTags/clients',
