 ...
 */
class SugarUpgrade717To7220FileCleanup extends UpgradeScript
{
    public $order = 8522;
    ...
    public function run()
    {
        // if the from version is 7.1.6 - 7.2.1, we should delete these files
        // as long as the to_version is 7.2.2.0 or newer.
        if ((version_compare($this->from_version, '7.1.5', '>') &&
                version_compare($this->from_version, '7.2.2.0', '<')) &&
            version_compare($this->to_version, '7.2.2.0', '>=')
        ) {
            $files = array(
                ...
                'include/javascript/yui3/assets',
                ...
                'modules/Notifications/clients/base/',
