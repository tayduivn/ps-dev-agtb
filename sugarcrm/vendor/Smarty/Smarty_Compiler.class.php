...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $ld = $this->_quote_replace($this->left_delimiter);
        $rd = $this->_quote_replace($this->right_delimiter);
        $source_content = preg_replace_callback($search, function($match) use ($ld, $rd) {
            return $ld . 'php' . str_repeat("\n", substr_count($match[0], "\n")) . $rd;
        }, $source_content);
