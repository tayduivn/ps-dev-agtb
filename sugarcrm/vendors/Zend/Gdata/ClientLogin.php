 ...
 */
require_once 'vendors/Zend/Gdata/HttpClient.php';
...
class Zend_Gdata_ClientLogin
{
    ...
    {
        if (! ($email && $password)) {
            require_once 'vendors/Zend/Gdata/App/AuthException.php';
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once 'vendors/Zend/Gdata/App/HttpException.php';
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once 'vendors/Zend/Gdata/App/CaptchaRequiredException.php';
