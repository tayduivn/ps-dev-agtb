 ...
 * @see Zend_Gdata
 */
require_once 'vendors/Zend/Gdata.php';

/**
 * @see Zend_Gdata_Gapps_UserFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/UserFeed.php';

/**
 * @see Zend_Gdata_Gapps_NicknameFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/NicknameFeed.php';

/**
 * @see Zend_Gdata_Gapps_GroupFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/GroupFeed.php';

/**
 * @see Zend_Gdata_Gapps_MemberFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/MemberFeed.php';

/**
 * @see Zend_Gdata_Gapps_OwnerFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/OwnerFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/EmailListFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListRecipientFeed
 */
require_once 'vendors/Zend/Gdata/Gapps/EmailListRecipientFeed.php';
...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    public static function throwServiceExceptionIfDetected($e) {
        ...
        if (!$response) {
          require_once('vendors/Zend/Gdata/App/IOException.php');
        ...
        try {
            ...
            require_once 'vendors/Zend/Gdata/Gapps/ServiceException.php';
     ...
     */
     public function getBaseUrl($domain = null)
     {
         if ($domain !== null) {
             ...
             require_once 'vendors/Zend/Gdata/App/InvalidArgumentException.php';
    ...
    public function __call($method, $args) {
        if (preg_match('/^new(\w+Query)/', $method, $matches)) {
            ...
            foreach ($this->_registeredPackages as $name) {
                 try {
                     ...
                     if (!class_exists($name . '_' . $class, false)) {
                        require_once 'vendors/Zend/Loader.php';
            ...
            if ($foundClassName != null) {
                ...
                require_once 'vendors/Zend/Gdata/App/Exception.php';
