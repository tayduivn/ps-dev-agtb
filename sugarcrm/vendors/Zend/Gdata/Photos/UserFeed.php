 ...
 */
require_once 'vendors/Zend/Gdata/Photos/UserEntry.php';
 ...
 */
require_once 'vendors/Zend/Gdata/Photos/TagEntry.php';

/**
 * @see Zend_Gdata_Photos_CommentEntry
 */
require_once 'vendors/Zend/Gdata/Photos/CommentEntry.php';
