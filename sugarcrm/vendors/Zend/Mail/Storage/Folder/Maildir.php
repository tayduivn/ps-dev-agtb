 ...
 */
require_once 'vendors/Zend/Mail/Storage/Folder.php';

/**
 * @see Zend_Mail_Storage_Folder_Interface
 */
require_once 'vendors/Zend/Mail/Storage/Folder/Interface.php';

/**
 * @see Zend_Mail_Storage_Maildir
 */
require_once 'vendors/Zend/Mail/Storage/Maildir.php';
...
class Zend_Mail_Storage_Folder_Maildir extends Zend_Mail_Storage_Maildir implements Zend_Mail_Storage_Folder_Interface
{
    ...
    public function __construct($params)
    {
        ...
        if (!isset($params->dirname) || !is_dir($params->dirname)) {
             ...
             */
            require_once 'vendors/Zend/Mail/Storage/Exception.php';
