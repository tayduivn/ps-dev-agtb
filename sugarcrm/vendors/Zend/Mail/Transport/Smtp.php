 ...
 * @see Zend_Mime
 */
require_once 'vendors/Zend/Mime.php';

/**
 * @see Zend_Mail_Protocol_Smtp
 */
require_once 'vendors/Zend/Mail/Protocol/Smtp.php';

/**
 * @see Zend_Mail_Transport_Abstract
 */
require_once 'vendors/Zend/Mail/Transport/Abstract.php';
...
class Zend_Mail_Transport_Smtp extends Zend_Mail_Transport_Abstract
{
    ...
    protected function _prepareHeaders($headers)
    {
        if (!$this->_mail) {
             ...
             */
            require_once 'vendors/Zend/Mail/Transport/Exception.php';
