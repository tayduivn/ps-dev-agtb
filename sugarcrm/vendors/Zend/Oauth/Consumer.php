 ...
 * @version    $Id: Consumer.php 22662 2010-07-24 17:37:36Z mabe $
 */

/** Zend_Oauth */
require_once 'vendors/Zend/Oauth.php';

/** Zend_Uri */
require_once 'vendors/Zend/Uri.php';

/** Zend_Oauth_Http_RequestToken */
require_once 'vendors/Zend/Oauth/Http/RequestToken.php';

/** Zend_Oauth_Http_UserAuthorization */
require_once 'vendors/Zend/Oauth/Http/UserAuthorization.php';

/** Zend_Oauth_Http_AccessToken */
require_once 'vendors/Zend/Oauth/Http/AccessToken.php';

/** Zend_Oauth_Token_AuthorizedRequest */
require_once 'vendors/Zend/Oauth/Token/AuthorizedRequest.php';

/** Zend_Oauth_Config */
require_once 'vendors/Zend/Oauth/Config.php';
...
class Zend_Oauth_Consumer extends Zend_Oauth
{
    ...
    public function getAccessToken(
        ...
        if (!$authorizedToken->isValid()) {
            require_once 'vendors/Zend/Oauth/Exception.php';
