 ...
 */
require_once 'vendors/Zend/Service/Amazon/Abstract.php';

/**
 * @see Zend_Crypt_Hmac
 */
require_once 'vendors/Zend/Crypt/Hmac.php';
...
class Zend_Service_Amazon_S3 extends Zend_Service_Amazon_Abstract
{
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if (!$endpoint->valid()) {
             ...
             */
            require_once 'vendors/Zend/Service/Amazon/S3/Exception.php';
