 ...
 */
require_once 'vendors/Zend/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/vendors/Zend/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/vendors/Zend/Validate/HostnameTestForm.php which is designed to be run via HTML
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'vendors/Zend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'vendors/Zend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'vendors/Zend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'vendors/Zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'vendors/Zend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'vendors/Zend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'vendors/Zend/Validate/Hostname/Cn.php',
        '公司' => 'vendors/Zend/Validate/Hostname/Cn.php',
        '网络' => 'vendors/Zend/Validate/Hostname/Cn.php'
    );
