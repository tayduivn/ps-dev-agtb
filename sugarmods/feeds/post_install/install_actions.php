...
} else if(isset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']) && !in_array('Feeds', $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules'])) {
  $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules'][] = 'Feeds';
} 
