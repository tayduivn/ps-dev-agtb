...
function getParentNode($tag_id){ 	 
 ...
 function get_admin_browse_articles($params){
    ...
    $colorclass = '';$bgColor=$even_bg;
        ...
        global $mod_strings,$app_strings, $odd_bg, $even_bg, $hilite_bg;
        $colorclass = '';
...
global $mod_strings,$odd_bg, $even_bg, $hilite_bg,$current_user,$app_strings;
    $colorclass = '';$bgColor=$even_bg;
 ...
 */
  function create_browse_node($id, $node_name,$tag_count=0,$doc_count=0) {
    global $sugar_config,$currentModule,$current_language, $mod_strings;
    ...
    if(!isset($mod_strings) || empty($mod_strings)){
        ...
        $mod_strings = return_module_language($current_language,"KBTags");
    }
