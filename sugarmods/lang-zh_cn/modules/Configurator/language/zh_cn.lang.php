...
$mod_strings = array (
	...
	'DISABLE_EXPORT' => '禁止导出',
	'DISPLAY_LOGIN_NAV' => '在登录界面显示标签',
	'DISPLAY_RESPONSE_TIME' => '显示服务器反应时间',
	'EXPORT' => '导出',
	'EXPORT_CHARSET' => '默认导出字符集',
    ...
    'LOCK_HOMEPAGE_HELP'=>'此设置用来阻止<BR> 1) 在首页模块中添加新的图表 <BR>2) 通过拖拉来定制栏目在首页中的位置.',
    ...
    'ERR_ALERT_FILE_UPLOAD' => '上传图片发生错误。',//080729	

	'CAPTCHA' => '认证',
	'CAPTCHA_PRIVATE_KEY' => '私钥认证',
	'CAPTCHA_PUBLIC_KEY' => '公钥认证',
	'ENABLE_CAPTCHA' => '启用认证以防止自动提交?',
...
// BEGIN SUGARCRM flav=dce ONLY 
	'DCE_TEMPLATES_DIR' => 'DCE中的模板目录',
	'DCE_PRIMARY_IT_EMAIL' => '主要IT电子邮件',
	'DCE_SUPPORT_USER_TIME_LIMIT' => '用户支持时限(小时)',
	'DCE_UNIQUE_KEY' => '应用程序ID',
	'DCE_LICENSING_USER' => 'Sugar许可用户',
	'DCE_LICENSING_PASSWORD' => 'Sugar许可证密码',
	'DEFAULT_DCE_SETTINGS' => 'DCE',
	'LBL_DCEMODULE_NAME' => 'DCE设定',
	'DCE_MESSAGING' => 'DCE信息发送中',
	'CREATE_EVAL_SUCCESS_MSG' => '新增Eval实例',
	'CREATE_INSTANCE_SUCCESS_MSG' => '新增实例',
	'ARCHIVE_INSTANCE_MSG' => '存档实例',
	'SUPPORT_USER_MSG' => '新建支持用户',
	'UPGRADE_LIVE_MSG' => '升级',
	'UPGRADE_TEST_MSG' => '测试升级',
	'ERROR_MESSAGE_MSG' => 'DCE客户端错误',
