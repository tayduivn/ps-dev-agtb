...
<td>
	...
	{if $PROJECT}
	<tr>
	<td valign="top" class="dataLabel"><slot>{$MOD.LBL_RESOURCE} <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></slot></td>
...
{literal}
Calendar.setup ({
	inputField : "holiday_date", ifFormat : "{/literal}{$CALENDAR_DATEFORMAT}{literal}", showsTime : false, button : "jscal_trigger", singleClick : true, step : 1
});
{/literal}
{$additionalScripts}
</script>
