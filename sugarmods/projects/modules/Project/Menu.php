...
// $Id: Menu.php 16705 2006-09-12 23:59:52 +0000 (Tue, 12 Sep 2006) jenny $
...
if(ACLController::checkAccess('Project', 'edit', true))$module_menu[] = array('index.php?module=Project&action=ProjectTemplatesEditView',
	$mod_strings['LNK_NEW_PROJECT_TEMPLATES'], 'CreateProjectTemplate');
...
// Project Templates
if(ACLController::checkAccess('Project', 'list', true))$module_menu[] = array('index.php?module=Project&action=ProjectTemplatesListView',
	$mod_strings['LNK_PROJECT_TEMPLATES_LIST'], 'ProjectTemplate');
...
if(ACLController::checkAccess('Project', 'list', true))$module_menu[] = array("index.php?module=Project&action=Dashboard&return_module=Project&return_action=DetailView",
    $mod_strings['LNK_PROJECT_DASHBOARD'], 'Project');
