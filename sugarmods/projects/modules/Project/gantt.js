...
SUGAR.gantt = function() {
	return {
		...
		createTable: function(view_type, calendar_start, bgcolor){
	        ...
	        ganttDateEmptyFirstCell.innerHTML = "<a href='#' onclick='SUGAR.gantt.moveChart(\"backward\", document.getElementById(\"gantt_chart_start_date\").value, \""+bgcolor+"\");'><img width='8' height='11' border='0' align='absmiddle' alt='Previous' src='themes/Sugar/images/previous.gif'/></a>";
	        ...
	        ganttDateEmptyLastCell.innerHTML = "<a href='#' onclick='SUGAR.gantt.moveChart(\"forward\", document.getElementById(\"gantt_chart_start_date\").value, \""+bgcolor+"\");'><img width='8' height='11' border='0' align='absmiddle' alt='Next' src='themes/Sugar/images/next.gif'/></a>";
		...
		taskOverLib: function(info, description){
			return overlib(info, CAPTION, description, CAPTIONSIZE, '2', TEXTSIZE, '2', CGCOLOR, '#DDDDDD', CAPCOLOR, '#000000', FGCOLOR, '#EEEEEE', TEXTCOLOR, '#000000', WRAP);
		},
		...
		setupCalendar: function(dateformat, bgcolor) {
			...
			Calendar.setup ({
					inputField : "calendar_start", ifFormat : calendar_dateformat, showsTime : false, button : "calendar_start", singleClick : true, step : 1
			});
		}	
		/* end Calendar */
