...
class SugarFieldMultienum extends SugarFieldBase {
    ...
    function getEditViewSmarty($parentFieldArray, $vardef, $displayParams) {
        ...
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldMultienum/SugarFieldMultienumEditViewSmarty.tpl');
    }

    function getDetailViewSmarty($parentFieldArray, $vardef, $displayParams) {
        $this->setup($parentFieldArray, $vardef, $displayParams);
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldMultienum/SugarFieldMultienumDetailViewSmarty.tpl');
    }
}
?>