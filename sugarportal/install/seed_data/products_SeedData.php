...
grow_product_catalog($depth_flag, $tree_depth, $tree_branches, $branch_leafs);


function grow_product_catalog($depth_flag, &$tree_depth, &$tree_branches, &$branch_leafs){
...
//require_once('modules/ProductCategories/ProductCategory.php');
	...
	$seed_object = new ProductCategory();
	$TreeView = new TreeView($seed_object);
	$TreeView->regrow_tree("Y");

//end function grow_product_catalog
}
